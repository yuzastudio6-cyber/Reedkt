...
import { privateInternalAttemptCostEvidenceResultSchema } from '../tool-cost-metering/private-internal-attempt-cost-evidence'
...
export const canonicalPrivateDeepFilterNetVoiceCleanupResponseSchema = z.object({
  ...
  attemptCost: privateInternalAttemptCostEvidenceResultSchema,
