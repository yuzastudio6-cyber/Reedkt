# WORKER_RUNTIME_JOBS SOUND CPU Phase162 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase162-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase162-blocked-execution-register",
  "blockedToday": {
