...
export const PRODUCTION_TOOL_QA_POLICIES: Record<ProductionToolId, ProductionQAProfile> = {
  ...
  torch_torchvision: { ...empty, gateTypes: ['render_asset_integrity', 'mask_edge_quality', 'enhancement_artifacts'], requiredBeforePreview: [] },
  transformers: { ...empty, gateTypes: ['render_asset_integrity'], requiredBeforePreview: [] },
  ...
  satori: { ...empty, gateTypes: ['caption_safe_zone', 'render_asset_integrity'] },
  svgdotjs_svg_js: { ...empty, gateTypes: ['caption_safe_zone', 'render_asset_integrity'] },
  viz_js: { ...empty, gateTypes: ['caption_safe_zone', 'render_asset_integrity'] },
  animejs: { ...empty, gateTypes: ['caption_safe_zone', 'render_asset_integrity'] },
