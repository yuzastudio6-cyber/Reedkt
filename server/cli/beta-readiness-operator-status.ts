...
function buildNextActions(
  ...
  actions.push('After the local accepted evidence bundle passes, deploy or verify the staging API service, then run npm run beta:readiness:api-deployment-preflight to prove the API URL, deployed source SHA, image, service account, and secret bindings are coherent before any deployed evidence call.')
