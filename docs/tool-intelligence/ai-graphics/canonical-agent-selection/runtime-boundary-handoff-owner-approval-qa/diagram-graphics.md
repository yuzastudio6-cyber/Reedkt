# Diagram Graphics Runtime Boundary Handoff Owner Approval QA
...
QA accepts PR #724 owner approval, PR #722 owner review, PR #719 QA, and PR #718 handoff review with warnings for this capability.

## Planning Tools

- Preferred planning tools: `viz_js`
- Fallback planning tools: `svgdotjs_svg_js`, `d3`
- Conditional planning tools: `vega_lite`
