...
- Sanitized monitoring shape is recorded as metadata only.
- Raw prompts, provider prompts, signed URLs, public URLs, secrets, and private payloads are excluded.
