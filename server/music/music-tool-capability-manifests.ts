...
function operation(seed: OperationSeed): ToolOperationCapability {
  ...
  return {
    ...
    acceptedArtifactTypes: seed.accepted ?? ['music_assignment_v1'],
    ...
    qualificationEvidenceRefs: [`music.evidence.${seed.key}.v1`],
    timeEstimatorKey: `music.tool.time.${seed.key}.v1`,
    creditEstimatorKey: `music.tool.credit.${seed.key}.v1`,
    attemptPolicyKey: seed.paid ? 'music.attempt.provider_reconciled.v1' : 'music.attempt.local_idempotent.v1',
...
function manifest(input: {
  ...
  return publishToolCapabilityManifest({
    ...
    toolManifestId: `tool.manifest.${input.toolKey}.v1`,
    ...
    qualificationEvidenceRefs: input.operations.map((item) => `music.evidence.${item.key}.v1`),
    operations: input.operations.map(operation),
    privacyPolicy: {
      policyKey: input.provider ? 'music.privacy.lyria3_preview.v1' : 'music.privacy.private_local.v1',
    ...
    securityPolicy: {
      policyKey: input.provider ? 'music.security.lyria3_preview.v1' : 'music.security.private_local.v1',
    ...
    licensePolicyRef: input.provider ? 'music.license.lyria3_preview_external_evidence_pending.v1' : 'music.license.project_private_media.v1',
    rateCardRef: input.provider ? 'music.rate.lyria3.official_2026_08_04.v1' : 'music.rate.local_infrastructure.v1',
    runtimeProbeKey: `music.runtime.${input.toolKey}.v1`,
...
const planningOperations: OperationSeed[] = planningJobs.map((job) => ({
  ...
  jobs: [job],
  preset: 'planning',
  produced: [`music_${job}_artifact_v1`],
}))

export const MUSIC_TOOL_CAPABILITY_MANIFESTS = Object.freeze([
  manifest({
    toolKey: 'music_supervision_engine', toolVersion: '1.0.0', toolClass: 'decision_route',
  ...
  manifest({
    toolKey: 'music_private_audio_analysis', toolVersion: '1.0.0', toolClass: 'internal_service',
    boundary: 'private_cpu_worker', status: 'internal_execution_qualified', operations: [
      {
        ...
        produced: ['music_candidate_analysis_v1', 'music_technical_qa_v1'], mutation: 'read_only_analysis',
      ...
      },
      {
        ...
        accepted: ['music_candidate_analysis_v1'], produced: ['music_candidate_selection_decision_v1'],
        mutation: 'coordination_record_only', determinism: 'deterministic',
      },
    ],
  }),
  manifest({
    toolKey: 'music_sync_engine', toolVersion: '1.0.0', toolClass: 'internal_service',
    boundary: 'private_cpu_worker', status: 'internal_execution_qualified', operations: [{
      key: 'compile_frame_accurate_music_placement', jobs: ['fit_music_to_edit', 'sync_music_to_picture'],
      preset: 'private', accepted: ['music_candidate_analysis_v1', 'music_cue_sheet_v1'],
      produced: ['music_beat_phrase_map_v1', 'music_editorial_plan_v1', 'music_placement_manifest_v1'],
      mutation: 'coordination_record_only', determinism: 'deterministic',
    }],
  }),
  manifest({
    toolKey: 'music_qa_engine', toolVersion: '1.0.0', toolClass: 'internal_service',
    boundary: 'private_coordination_service', status: 'internal_execution_qualified', operations: [{
      ...
      accepted: ['music_candidate_analysis_v1', 'music_placement_manifest_v1', 'music_sound_support_receipt_v1'],
      produced: ['music_qa_report_v1', 'music_continuity_report_v1'],
      mutation: 'coordination_record_only', determinism: 'deterministic',
      limitations: ['Subjective narrative, cultural, originality, and legal findings remain confidence-scored or review-required.'],
    }],
  }),
  manifest({
    toolKey: 'music_private_asset_service', toolVersion: '1.0.0', toolClass: 'internal_service',
    boundary: 'private_artifact_service', status: 'internal_execution_qualified', operations: [
      {
        ...
        accepted: ['approved_private_music_audio'], produced: ['approved_music_selection_v1'],
  ...
  manifest({
    ...
    boundary: 'private_coordination_service', status: 'internal_execution_qualified', operations: [{
      ...
      preset: 'private', accepted: ['music_editorial_plan_v1', 'approved_private_music_audio'],
      produced: ['processed_music_audio_v1', 'music_stem_audio_v1', 'music_sound_support_receipt_v1'],
    ...
    boundary: 'server_provider_adapter', status: 'planning_qualified', provider: true, operations: [
      {
        ...
        accepted: ['music_composition_brief_v1'], produced: ['untrusted_music_candidate'],
      ...
      },
      {
        ...
        accepted: ['music_composition_brief_v1', 'approved_private_music_audio'], produced: ['untrusted_music_candidate'],
        mutation: 'private_provider_ingest', determinism: 'bounded_nondeterministic', paid: true, license: true,
  ...
  manifest({
    toolKey: 'music_handoff_service', toolVersion: '1.0.0', toolClass: 'internal_service',
    boundary: 'private_artifact_service', status: 'internal_execution_qualified', operations: [
      {
        key: 'create_final_music_handoff', jobs: ['handoff_music_to_final_composition'], preset: 'private',
        accepted: ['music_placement_manifest_v1', 'music_qa_report_v1'],
        produced: ['music_final_composition_handoff_v1'], mutation: 'coordination_record_only', determinism: 'deterministic',
      },
      {
        ...
        ], preset: 'private', accepted: ['music_assignment_v1'],
        produced: ['intentional_no_music_handoff_v1'], mutation: 'no_mutation', determinism: 'deterministic',
      },
      {
        ...
        produced: ['music_ambience_only_handoff_v1'], mutation: 'coordination_record_only', determinism: 'deterministic',
