...
const rpData02Files = [
  'docs/internal-beta/rp-data-02-supabase-migration-safety-packet/source-audit.md',
  'docs/internal-beta/rp-data-02-supabase-migration-safety-packet/migration-file-map.md',
  'docs/internal-beta/rp-data-02-supabase-migration-safety-packet/target-environment-guardrails.md',
  'docs/internal-beta/rp-data-02-supabase-migration-safety-packet/rls-storage-advisor-plan.md',
  'docs/internal-beta/rp-data-02-supabase-migration-safety-packet/rollback-and-recovery-plan.md',
  'docs/internal-beta/rp-data-02-supabase-migration-safety-packet/execution-gate.md',
  'docs/internal-beta/rp-data-02-supabase-migration-safety-packet/safety-record.json',
...
for (const file of [...changedFiles, ...stagedFiles]) {
  ...
  if (
    (!isRpData04File && !isRpData03StaticMigration && forbiddenExactFiles.has(file)) ||
    (!isRpData04File && !isRpData03StaticMigration && !isRpData03SupabaseSupportFile && forbiddenPrefixes.some((prefix) => file.startsWith(prefix))) ||
    (!isRpData04File && !isRpData03StaticMigration && file.endsWith('.sql')) ||
    file.endsWith('.mp4') ||
    file.endsWith('.mov') ||
    file.endsWith('.mkv') ||
    file.endsWith('.webm') ||
