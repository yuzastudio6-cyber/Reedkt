# Route Worker Dispatch Proof Plan
...
```json
{
  ...
  "routeHarnessRequired": true,
  "workerDispatchRequired": true,
  "directScriptProofInsufficient": true,
  "negativePathChecksRequired": [
