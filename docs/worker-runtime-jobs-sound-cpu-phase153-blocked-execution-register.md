# WORKER_RUNTIME_JOBS SOUND CPU Phase153 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase153-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase153-blocked-execution-register",
  "blockedToday": {
