...
- `allowedForwardProgressScopes`, which names bounded source review, local proof, diagnostics, QA, deployment preflight, owner approval, rollback, monitoring, and support planning lanes that can continue while beta/production execution remains closed.
