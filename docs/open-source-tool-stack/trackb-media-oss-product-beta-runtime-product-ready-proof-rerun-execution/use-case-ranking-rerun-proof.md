...
The proof preserves the intended deterministic ranking by use case while keeping dispatch disabled.
...
```json
{
  ...
  "report": "use-case-ranking-rerun-proof",
  ...
  "allToolsCoveredByRankingOrFallbackPolicy": true,
  "productRouteCanDispatchSelectedCandidate": false,
  "rankedForToolCallUseCases": true
}
```
