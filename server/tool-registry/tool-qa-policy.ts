...
export const PRODUCTION_TOOL_QA_POLICIES: Record<ProductionToolId, ProductionQAProfile> = {
  ...
  pydub: { ...empty, gateTypes: ['audio_naturalness', 'audio_loudness'], requiredBeforePreview: ['audio_naturalness'] },
  scipy: { ...empty, gateTypes: ['audio_sync', 'render_asset_integrity'], requiredBeforePreview: ['audio_sync'] },
  ...
  music21: { ...empty, gateTypes: ['audio_sync', 'music_over_voice'], requiredBeforePreview: [] },
  pretty_midi: { ...empty, gateTypes: ['audio_sync'], requiredBeforePreview: [] },
  mido: { ...empty, gateTypes: ['audio_sync'], requiredBeforePreview: [] },
  noisereduce: { ...empty, gateTypes: ['audio_naturalness', 'audio_loudness'], requiredBeforePreview: ['audio_naturalness'] },
  pedalboard: { ...empty, gateTypes: ['audio_naturalness', 'audio_loudness'], requiredBeforePreview: ['audio_naturalness'] },
  mir_eval: { ...empty, gateTypes: ['audio_sync', 'music_over_voice'], requiredBeforePreview: [] },
  pydub_effects: { ...empty, gateTypes: ['audio_naturalness', 'audio_loudness'], requiredBeforePreview: ['audio_naturalness'] },
