# Svg Graphics Canonicalization Review
...
- `preferredPlanningToolsCanonicalized`: `svgdotjs_svg_js`, `satori`
- `conditionalPlanningToolsCanonicalized`: `d3`
- `fallbackPlanningToolsCanonicalized`: `viz_js`
- `eliminatedToolsCanonicalized`: `sam2`, `real_esrgan`
- `missingProofRulesCanonicalized`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsCanonicalized`: public SVG artifact creation not approved; model/GPU tools are capability mismatches
- `nextProofMilestoneCanonicalized`: future static SVG contract or artifact-boundary proof
