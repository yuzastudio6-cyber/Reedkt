...
- `eliminatedToolsOwnerApprovalQaAccepted`: `vega_lite`
- `missingProofRulesOwnerApprovalQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApprovalQaAccepted`: diagram execution and public artifact output not approved; vega_lite only applies when request is chart-like
- `nextProofMilestoneOwnerApprovalQaAccepted`: future DOT/SVG diagram execution boundary proof
