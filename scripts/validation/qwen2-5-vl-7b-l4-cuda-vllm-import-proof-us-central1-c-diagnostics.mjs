...
const DECISION = "qwen2_5_vl_7b_l4_cuda_vllm_import_proof_us_central1_c_blocked_by_g2_l4_zonal_stockout";
const NEXT_PROMPT =
...
const REQUIRED_RESULT_PHRASES = [
  DECISION,
  "`us-central1-b`, `us-central1-a`, and `us-central1-c` have now all returned zonal stockout",
...
const TRUE_FLAGS = [
  ...
  "allSameRegionRetryZonesAttempted"
];
...
check(
  packageJson.scripts?.["qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-c:diagnostics"] ===
    "node scripts/validation/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-c-diagnostics.mjs",
  "package.json must expose qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-c:diagnostics"
);

const result = read("docs/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-c-result.md");
const prompt = read("docs/implementation-prompts/prompt-qwen2-5-vl-7b-l4-capacity-review.md");
const changeLog = parseBlock(
  "docs/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-c-change-log.md",
  "qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-c-change-log"
);

includesAll(result, REQUIRED_RESULT_PHRASES, "us-central1-c result");
includesAll(prompt, [
  NEXT_PROMPT,
...
check(changeLog.preflight?.targetZone === "us-central1-c", "Target zone mismatch");
