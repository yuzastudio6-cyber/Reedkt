  ...
  toolRows: [
    ...
    },
    {
      ...
      requiredBeforeExecution: [
        ...
        'controlled GPU proof must use a future approved stockout fix before another lifecycle execution attempt',
        'controlled L4 proof must be no-idle: no public IP, prompt-scoped VM only, delete VM and verify cleanup before completion',
      ],
      currentBlocker: 'us_central1_b_l4_resource_pool_exhausted_before_lifecycle_proof',
      safeNextCommand: 'npm run smoke:ai-video-broll-gen-9l-no-idle-l4-lifecycle-proof-result',
