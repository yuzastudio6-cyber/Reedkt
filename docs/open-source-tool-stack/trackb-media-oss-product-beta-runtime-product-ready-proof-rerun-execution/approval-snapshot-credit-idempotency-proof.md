# Approval Snapshot Credit Idempotency Proof
...
The rerun proof records that product tool-call eligibility remains gated by approved snapshot, edit plan, credit reservation, private artifact metadata, QA, fallback policy, and idempotency.
...
```json
{
  ...
  "report": "approval-snapshot-credit-idempotency-proof",
  "approvedSnapshotGatePassed": true,
  "editPlanGatePassed": true,
  "creditReservationGatePassed": true,
  "idempotencyGatePassed": true,
  "privateArtifactMetadataGatePassed": true,
  "qaGatePassed": true,
  "fallbackPolicyGatePassed": true,
  "noToolCallBeforeApproval": true,
  "noCreditBypass": true,
  "duplicateSafeDryRunReceipt": true
}
```
