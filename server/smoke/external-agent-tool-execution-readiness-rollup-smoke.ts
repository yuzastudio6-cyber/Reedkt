...
for (const required of [
  ...
  '`broll_no_idle_l4_iap_wheelhouse_transfer_us_east4_a_selected_future_prompt_required_before_vm_create`',
...
assert.equal(rollup.recommendedNextPrompt, BROLL_9W_US_EAST4_A_TRANSFER_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_9W_US_EAST4_A_TRANSFER_PROMPT)
...
assert.equal(broll?.noIdleLifecycleGate?.targetZone, 'us-east4-a')
