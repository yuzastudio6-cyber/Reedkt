...
active release, and the L4 heavy fallback unreleased. The source contracts and
owner mounts are therefore current, but no exact terminal Caption scene has
consumed a persisted Track All result plus separately funded L4 measurement,
complete-range private scene review, and final Caption evidence record. The
0/41 terminal count remains unchanged.
