...
const blockedAuditRecord = await runProductionOpsObservabilityEvidenceCollectorFromEnv({
  ...opsObservabilityEnv(),
  ...
  REEDITPRO_PRODUCTION_READINESS_IDEMPOTENCY_KEY: 'production-ops-observability-blocked-audit-smoke',
