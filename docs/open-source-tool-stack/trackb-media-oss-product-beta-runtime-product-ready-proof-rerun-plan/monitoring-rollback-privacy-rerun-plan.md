# Monitoring Rollback Privacy Rerun Plan
...
```json
{
  ...
  "report": "monitoring-rollback-privacy-rerun-plan",
  "sanitizedMonitoringRequired": true,
  "rollbackDisableRequired": true,
  "perToolDisableRequired": true,
  "globalTrackBDisableRequired": true,
  "proofMustShowDisabledToolsDoNotDispatch": true,
  "monitoringMustNotIncludePrivatePayloads": true,
  "userMediaByDefaultBlocked": true,
  "syntheticPrivateTempFixturesOnly": true,
  "publicArtifactsBlocked": true,
  "signedUrlsBlocked": true,
  "supabaseGcsWritesBlocked": true,
  "sqlMigrationsBlocked": true,
  "secretPrintingBlocked": true
}
```
