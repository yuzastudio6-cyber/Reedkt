...
const packetDir = 'docs/track-a/native-container-render-tools/package-source-resolution-batch-1'
const requiredFiles = [
  `${packetDir}/package-source-resolution-batch-1.md`,
  `${packetDir}/package-source-resolution-batch-1.json`,
...
const requiredText = [
  ...
  'completed_docs_only_package_source_resolution_no_install_changes',
  ...
  'TRACKA-NATIVE-CONTAINER-RENDER-TOOLS-INSTALL-PROOF-4 readiness: blocked_pending_owner_or_environment_package_source_review',
...
function fail(message) {
  console.error(`TRACKA-NATIVE-CONTAINER-PACKAGE-SOURCE-RESOLUTION-BATCH-1 diagnostics failed: ${message}`)
  process.exit(1)
}
...
const script = packageJson.scripts?.['tracka:native-container-package-source-resolution-batch-1:diagnostics']
if (script !== 'node scripts/validation/tracka-native-container-package-source-resolution-batch-1-diagnostics.mjs') {
...
console.log('TRACKA-NATIVE-CONTAINER-PACKAGE-SOURCE-RESOLUTION-BATCH-1 diagnostics passed')
console.log('Decision: blocked_no_safe_package_source_resolution_available')
console.log('Execution: completed_docs_only_package_source_resolution_no_install_changes')
