...
} from '../tool-registry/ai-graphics-internal-beta-dry-run-readiness'
import type {
...
const readiness = buildAiGraphicsInternalBetaDryRunReadiness({
  evidenceBundleInput,
...
if (
  hasFlag('--require-owner-approved-metadata-dry-run-ready') &&
  !readiness.internalBetaMetadataDryRunReadyWithProvidedEvidence
) {
  process.exitCode = 2
}
