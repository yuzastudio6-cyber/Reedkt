...
function buildNextActions(
  ...
  actions.push('After the local accepted evidence bundle passes, run npm run beta:readiness:deployed-evidence-input-manifest to verify exact source SHA, 14-tool bundle inputs, libass container image, platform approvals, and launch approvals before any deployed evidence call.')
