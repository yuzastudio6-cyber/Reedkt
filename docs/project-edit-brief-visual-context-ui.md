...
Marker Chat shows whether visual context is available or fallback-used. This is display-only; it does not yet send visual summaries into Qwen 3.7 prompts.
