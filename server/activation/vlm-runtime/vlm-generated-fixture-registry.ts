import type { VlmGeneratedFixtureSpec } from './vlm-runtime-types'

export function buildVlmGeneratedFixtureManifest(runId: string, createdAt = new Date().toISOString()) {
  const specs: VlmGeneratedFixtureSpec[] = [
    {
