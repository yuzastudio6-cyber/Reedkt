...
const baseRef = 'origin/codex/rp-tool-route-ai-graphics-metadata-integration-approval'
const expectedDecision = 'tool_route_ai_graphics_metadata_integration_qa_passed_with_warnings'
const allowedDecisions = new Set([
  'tool_route_ai_graphics_metadata_integration_qa_passed',
  expectedDecision,
  'blocked_pending_ai_graphics_metadata_qa_fixes',
  'blocked_pending_scoped_manifest_intake_fixes',
  'blocked_pending_worker_handoff_review',
  'blocked_pending_tracka_handoff_review',
])

const requiredDocs = [
  'docs/tool-route-execution/ai-graphics-metadata-integration-qa-review.md',
  'docs/tool-route-execution/ai-graphics-route-intake-qa-matrix.md',
  'docs/tool-route-execution/ai-graphics-scoped-tool-call-manifest-intake-qa.md',
  'docs/tool-route-execution/ai-graphics-artifact-scope-mapping-qa.md',
  'docs/tool-route-execution/ai-graphics-fail-closed-route-selection-qa.md',
  'docs/tool-route-execution/ai-graphics-worker-handoff-qa.md',
  'docs/tool-route-execution/ai-graphics-blocked-use-qa.md',
  'docs/tool-route-execution/ai-graphics-warning-blocker-register.md',
  'docs/tool-route-execution/ai-graphics-metadata-integration-qa-decision.md',
  'docs/tool-route-execution/ai-graphics-next-lane-qa-recommendation.md',
  'docs/prompt-tool-route-ai-graphics-metadata-integration-qa-validation-results.md',
  'docs/implementation-prompts/prompt-tool-route-ai-graphics-metadata-integration-qa-review.md',
]
...
const requiredTrueBooleans = [
  'metadataIntegrationAccepted',
  'metadataIntegrationAcceptedWithWarnings',
  'readyForToolRouteLocalFixturePlanning',
...
const decisionDoc = read('docs/tool-route-execution/ai-graphics-metadata-integration-qa-decision.md')
const matrixDoc = read('docs/tool-route-execution/ai-graphics-route-intake-qa-matrix.md')
...
for (const tool of requiredTools) {
  ...
  if (!row) failures.push(`matrix_missing_tool:${tool}`)
    ...
    if (!/Private|private/i.test(row)) failures.push(`matrix_tool_missing_artifact_scope:${tool}`)
  }
}
...
if (
  packageJson?.scripts?.['tool-route:ai-graphics-metadata-integration-qa:diagnostics'] !==
  'node scripts/validation/tool-route-ai-graphics-metadata-integration-qa-diagnostics.mjs'
) {
  failures.push('missing_package_script:tool-route:ai-graphics-metadata-integration-qa:diagnostics')
}
...
const result = {
  ...
  sourcePr: '#456',
  sourceHead: '36efdcd678fc6bd69fe7569268af9bb4a81a6aa8',
  aiGraphicsRouteQaPr: '#454',
  toolRouteContextPrs: ['#404', '#398'],
  trackBContextPr: '#164',
