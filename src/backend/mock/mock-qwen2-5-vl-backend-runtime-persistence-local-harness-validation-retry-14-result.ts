...
export const QWEN2_5_VL_BACKEND_RUNTIME_PERSISTENCE_LOCAL_HARNESS_VALIDATION_RETRY_14_RESULT = {
  workstream: 'AI_VIDEO_BROLL_GENERATION',
  toolId: 'qwen2_5_vl_7b_instruct',
  registryToolId: 'qwen_vl',
  mode: 'qwen2_5_vl_backend_runtime_persistence_local_harness_validation_retry_14_result',
  decision:
  ...
  validationOutcome: {
    status: 'blocked_storage_upload_pipeline_policy_comment_ownership',
    localHarnessValidationRetry14Attempted: true,
    localHarnessValidationRetry14Passed: false,
    baselineLoadStatus: 'blocked_active_migration_202605200001_policy_comment',
    storageObjectsPolicyCommentFixVerified: true,
    draftMigrationStatus: 'not_attempted',
    draftTestsStatus: 'not_attempted',
    storageUploadPipelinePolicyCommentBaselineFixRequired: true,
...
export type Qwen25VlBackendRuntimePersistenceLocalHarnessValidationRetry14Result =
  typeof QWEN2_5_VL_BACKEND_RUNTIME_PERSISTENCE_LOCAL_HARNESS_VALIDATION_RETRY_14_RESULT
