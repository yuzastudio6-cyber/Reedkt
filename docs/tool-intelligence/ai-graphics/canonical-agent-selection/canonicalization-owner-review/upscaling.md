# Upscaling Canonicalization Owner Review
...
- `eliminatedToolsOwnerAccepted`: `d3`, `satori`
- `missingProofRulesOwnerAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerAccepted`: model/GPU/provenance proof missing,GPU runtime not approved
- `nextProofMilestoneOwnerAccepted`: upscaling model/GPU/provenance proof lane
