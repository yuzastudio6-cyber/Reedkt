...
const baseScenarios: MockEditLevelSourceUnderstandingScenario[] = [
  ...
  scenario({ id: 'normal-qwen25-targeted', title: 'Normal targets Visual Intelligence only when needed.', level: 'normal', layerId: 'visual_intelligence_segments', expectedRequiredness: 'targeted', expectedStatus: 'provider_required' }),
  ...
  scenario({ id: 'premium-key-moments-recommended', title: 'Premium recommends Visual Intelligence key moments.', level: 'premium', layerId: 'visual_intelligence_segments', expectedRequiredness: 'recommended', expectedStatus: 'provider_required' }),
  scenario({ id: 'premium-marker-windows-recommended', title: 'Premium recommends marker windows.', level: 'premium', layerId: 'visual_intelligence_marker_windows', expectedRequiredness: 'recommended', expectedStatus: 'provider_required' }),
  ...
  scenario({ id: 'ultra-scene-visual-required', title: 'Ultra uses scene-level visual context.', level: 'ultra_premium', layerId: 'visual_intelligence_segments', expectedRequiredness: 'required', expectedStatus: 'provider_required' }),
  ...
  scenario({ id: 'fallback-qwen25-unavailable', title: 'Fallback policy exists for Visual Intelligence unavailable.', level: 'premium', layerId: 'visual_intelligence_segments' }),
  ...
  scenario({ id: 'no-qwen25-call', title: 'No Visual Intelligence call made.', level: 'premium' }),
