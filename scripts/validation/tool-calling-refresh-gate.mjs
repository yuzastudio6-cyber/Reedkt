...
console.log(JSON.stringify({
  ...
  unmergedOwnerEvidenceOverlayRequired: true,
  unmergedOwnerEvidenceDiagnostic: 'npm run tool-calling:unmerged-owner-evidence',
  openPrEvidenceTreatedAsCandidateOnly: true,
  continueAllowed,
  blockingReasons,
  warnings,
}, null, 2))
