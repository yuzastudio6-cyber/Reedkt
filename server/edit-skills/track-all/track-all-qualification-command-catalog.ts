...
export const TRACK_ALL_QUALIFICATION_SCRIPTS = [
  ...
  'test:track-all-evidence-route-coherence',
...
export const TRACK_ALL_ROUTE_COMMANDS = {
  ...
  existing_track_repair_route: [
    'npm.test:track-all-independent-qa-repair',
    'npm.test:track-all-canonical-private-public-e2e',
  ],
  privacy_redaction_route: [
    'npm.test:track-all-privacy-redaction',
    'npm.test:track-all-canonical-private-public-e2e',
  ],
  focus_route: [
    'npm.test:track-all-focus-reframe',
    'npm.test:track-all-canonical-private-public-e2e',
  ],
  reframe_route: [
    'npm.test:track-all-focus-reframe',
  ...
  public_plugin_lifecycle_route: [
    ...
    'npm.test:track-all-canonical-private-runtime',
    'npm.test:track-all-canonical-private-public-e2e',
    'npm.test:track-all-producer-consumer-acceptance',
  ],
