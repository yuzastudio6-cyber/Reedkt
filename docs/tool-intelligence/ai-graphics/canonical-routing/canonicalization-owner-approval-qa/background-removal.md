# Background Removal Canonicalization Owner Approval QA
...
- Preferred planning tools accepted: `sam2`, `birefnet`
- Conditional planning tools accepted: `rembg`, `transparent_background`
- Fallback planning tools accepted: `manual mask planning after model proof`
...
Next milestone: `CPU import, model provenance, model-weight, and GPU policy proof before execution.`.
