# Chart Overlay Canonicalization QA
...
- `preferredPlanningToolsQaAccepted`: `vega_lite`, `d3`
- `conditionalPlanningToolsQaAccepted`: `echarts`
- `fallbackPlanningToolsQaAccepted`: `vega`
- `eliminatedToolsQaAccepted`: `three_js`, `sam2`, `real_esrgan`
- `missingProofRulesQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsQaAccepted`: browser chart runtime not approved,model/GPU proof not approved for eliminated ML tools,3D chart request required before three_js planning
- `nextProofMilestoneQaAccepted`: future chart/browser runtime or CPU/static chart metadata proof before execution
