...
The Phase 39C report must include no-runtime-auto-download evidence, dependency/runtime version pins, GPU/memory/cost limits, hallucination/coordinate/safety QA, and a decision on whether Phase 39D may plan exactly one controlled private real-frame/sample.
