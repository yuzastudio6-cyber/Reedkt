...
function scanUnsafeLines(relativePath, text) {
  const unsafePatterns = [
    ...
    /production capability enabled:\s*`?(?!none; AI Tools creative graphics generated\/local fixture candidate pack only|none; AI Tools creative graphics dry-run fixture pack only|none; AI Tools creative graphics manifest contract only|none; AI Tools creative graphics repo audit only)/i,
    /postgres(?:ql)?:\/\/[^@\s]+@/i,
