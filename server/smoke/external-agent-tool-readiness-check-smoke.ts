...
assert.equal(summary.noIdleLifecycleGates[0].gate.targetRegion, 'northamerica-northeast1')
assert.equal(summary.noIdleLifecycleGates[0].gate.targetZone, 'northamerica-northeast1-b')
