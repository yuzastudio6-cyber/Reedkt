# WORKER_RUNTIME_JOBS SOUND CPU Phase168 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase168-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase168-blocked-execution-register",
  "blockedToday": {
