...
Evidence revision `2026-07-12.22` records:
...
- 15 exact tool identities verified through the server-derived canonical job adapter.
...
The 15 server-derived job-adapter verified tool identities are:

```text
echarts, vega_lite, vega, satori, svg_js, viz_js, lottie, animejs, three_js, pixijs,
konva, babylon_js, playwright, ffprobe, remotion
```
