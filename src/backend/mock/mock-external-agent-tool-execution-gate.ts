  ...
  toolRows: [
    ...
    },
    {
      ...
      requiredBeforeExecution: [
        ...
        'controlled GPU proof must use the future approved us-west1-b transfer proof prompt before another VM attempt, dependency install, or inference',
      ...
      safeNextCommand:
        'npm run smoke:ai-video-broll-gen-9r-iap-wheelhouse-transfer-stockout-fix-result',
