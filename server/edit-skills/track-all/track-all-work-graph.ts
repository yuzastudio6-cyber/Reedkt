...
function atomicTemplatesForPlan(plan: TrackAllPlan): AtomicTemplate[] {
  ...
  const tracking: AtomicTemplate[] = [
    ...
    stage('execute_sam_masklet_session', graphJob, 'tool.sam3_1.track_masklets.v2', 'track_all_private_gpu_worker', ['track_all_plan_v1', 'track_all_target_specification_v1', 'track_all_sam3_1_approved_session_plan_set_v1'], 'track_all_sam3_1_masklet_manifest_set_v1', ['choose_initialization_frame', 'prepare_tracking_chunks', 'allocate_multiplex_buckets'], false, true, plan.maximumAttempts),
    stage('normalize_masklets', graphJob, 'track_all.normalize_masklets.v1', 'track_all_private_geometry_worker', ['track_all_sam3_1_masklet_manifest_set_v1'], 'track_all_normalized_masklet_observation_set_v1', ['execute_sam_masklet_session']),
    stage('stitch_chunks', graphJob, 'tool.opencv.analyze_approved_visual_artifacts.v1', 'track_all_geometry_worker', ['track_all_normalized_masklet_observation_set_v1', 'track_all_plan_v1'], 'track_all_chunk_seam_qa_report_v1', ['normalize_masklets', 'prepare_tracking_chunks']),
    stage('associate_identities', graphJob, 'track_all.associate_anonymous_identities.v1', 'track_all_identity_worker', ['track_all_normalized_masklet_observation_set_v1', 'track_all_chunk_seam_qa_report_v1'], 'track_identity_lineage_v1', ['stitch_chunks']),
    ...
    stage('run_mask_qa', 'track_all.validate_track_graph', 'track_all.validate_mask.v1', 'track_all_qa_worker', ['track_all_normalized_masklet_observation_set_v1'], 'track_all_mask_qa_report_v1', ['normalize_masklets']),
