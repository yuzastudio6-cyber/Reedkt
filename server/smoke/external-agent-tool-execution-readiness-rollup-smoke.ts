...
for (const required of [
  ...
  '`broll_no_idle_l4_iap_wheelhouse_transfer_us_west1_c_stockout_capacity_strategy_required`',
...
assert.equal(rollup.recommendedNextPrompt, BROLL_9V_STOCKOUT_FIX_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_9V_STOCKOUT_FIX_PROMPT)
