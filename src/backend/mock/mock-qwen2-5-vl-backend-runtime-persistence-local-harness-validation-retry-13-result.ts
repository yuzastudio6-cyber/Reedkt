...
export const QWEN2_5_VL_BACKEND_RUNTIME_PERSISTENCE_LOCAL_HARNESS_VALIDATION_RETRY_13_RESULT = {
  workstream: 'AI_VIDEO_BROLL_GENERATION',
  toolId: 'qwen2_5_vl_7b_instruct',
  registryToolId: 'qwen_vl',
  mode: 'qwen2_5_vl_backend_runtime_persistence_local_harness_validation_retry_13_result',
  decision:
  ...
  attempt: {
    ...
    previouslyFailedBaselineStatementPassed: 'comment on table storage.buckets',
    previouslyFailedBaselineGuardObserved: 'insufficient_privilege',
    lastSuccessfulBaselineStatement: 'comment on table storage.buckets',
    failedBaselineMigration:
      '202605180008_reeditpro_storage_buckets_policies.sql',
    failedStatementCategory: 'storage_objects_policy_comment_ownership',
    failedStatementSummary:
  ...
  validationOutcome: {
    status: 'blocked_storage_objects_policy_comment_ownership',
    localHarnessValidationRetry13Attempted: true,
    localHarnessValidationRetry13Passed: false,
    baselineLoadStatus: 'blocked_active_migration_202605180008_policy_comment',
    storageBucketsCommentFixVerified: true,
    draftMigrationStatus: 'not_attempted',
    draftTestsStatus: 'not_attempted',
    storageObjectsPolicyCommentBaselineFixRequired: true,
...
export type Qwen25VlBackendRuntimePersistenceLocalHarnessValidationRetry13Result =
  typeof QWEN2_5_VL_BACKEND_RUNTIME_PERSISTENCE_LOCAL_HARNESS_VALIDATION_RETRY_13_RESULT
