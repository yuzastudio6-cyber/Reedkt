export const TRACKA_CAPTION_BURNIN_PHASE = 'TRACKA-CAPTION-QUALITY-5'
export const TRACKA_CAPTION_BURNIN_BRANCH = 'codex/rp-tracka-caption-quality-5-layout-fix-and-revalidation'
export const TRACKA_CAPTION_BURNIN_BASE_BRANCH = 'codex/rp-model-orchestration-qwen-schema-timeout-target-calibration'
export const TRACKA_CAPTION_BURNIN_PR_TITLE = '[track-a] Caption layout fix and revalidation'
export const TRACKA_CAPTION_LAYOUT_FIX_CONFIRM_ENV = 'REEDITPRO_CONFIRM_TRACKA_CAPTION_LAYOUT_FIX_REVALIDATION'
...
export const TRACKA_CAPTION_BURNIN_LOCAL_ROOT = '/tmp/reeditpro-tracka-caption-quality-5'
export const TRACKA_CAPTION_LAYOUT_FIX_PROFILE_ID = 'tracka_caption_layout_fix_v1'
...
export const TRACKA_CAPTION_LAYOUT_FIXED_LINES = [
  'Hey everyone — welcome to this\\NReEditPro visual review.',
  'Today we are testing captions,\\Noverlays, and private render quality.',
  'The goal is a clean, professional edit\\Nwith readable text.',
  'Review this sample for timing,\\Npolish, and visual clarity.',
] as const

export const TRACKA_CAPTION_LAYOUT_FIX_ASS_PROFILE = {
  playResX: 2160,
  playResY: 3840,
  alignment: 2,
  marginL: 190,
...
export const TRACKA_CAPTION_BURNIN_SOURCE_CHAIN = [
  ...
  { pr: 475, sha: '374e1795d0a7a74d88517591349984ff1727429d', summary: 'completed corrected-caption burn-in execution' },
  { pr: 484, sha: 'cb974c7fe8c8350cfa7522ec7e736140af58583a', summary: 'fail_caption_layout_quality; caption style/layout fix required' },
] as const

export const TRACKA_CAPTION_BURNIN_DOC_PATHS = {
  execution: 'docs/track-a/track-a-caption-quality-5-layout-fix-and-revalidation.md',
  layoutStyleContract: 'docs/track-a/track-a-caption-quality-5-layout-style-contract.md',
  approvedSource: 'docs/track-a/track-a-caption-quality-5-approved-source-input.md',
  sidecar: 'docs/track-a/track-a-caption-quality-5-corrected-ass-sidecar.md',
  artifactManifest: 'docs/track-a/track-a-caption-quality-5-private-artifact-manifest.md',
  qaReport: 'docs/track-a/track-a-caption-quality-5-qa-report.md',
  ffprobe: 'docs/track-a/track-a-caption-quality-5-ffprobe-validation.md',
  localBundle: 'docs/track-a/track-a-caption-quality-5-local-review-bundle.md',
  uploadInstructions: 'docs/track-a/track-a-caption-quality-5-upload-to-chat-instructions.md',
  nextPhase: 'docs/track-a/track-a-caption-quality-5-next-phase-plan.md',
  activationResults: 'docs/activation-phase-tracka-caption-quality-5-results.md',
  nextPrompt: 'docs/implementation-prompts/prompt-tracka-caption-quality-6-record-layout-review-outcome.md',
} as const
...
export function getTrackaCaptionBurninRunId(): string {
  return process.env[TRACKA_CAPTION_BURNIN_RUN_ID_ENV] || `tracka-caption-quality-5-layout-fix-${timestampRunId()}`
}

export function isTrackaCaptionLayoutFixConfirmed(): boolean {
  return process.env[TRACKA_CAPTION_LAYOUT_FIX_CONFIRM_ENV] === 'true'
}
