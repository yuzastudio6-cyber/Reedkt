# WORKER_RUNTIME_JOBS SOUND CPU Phase 37G Caption Render Runtime Hook Source Owner Claim Policy

```json worker-runtime-jobs-sound-cpu-phase37g-caption-render-runtime-hook-source-owner-claim-policy
{
  ...
  "allowedClaims": {
    "phase37GSourceOwnerReviewCompleted": true,
    "futureActualSourceCreationMayProceed": true,
    "plannedHookPathAccepted": true,
    "sourcePlanAcceptedForFailClosedSourceCreation": true
  },
  "blockedClaims": {
