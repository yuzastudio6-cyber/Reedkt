...
```json
{
  ...
  "report": "route-harness-implementation",
  ...
  "realRoutesRemainDisabled": true,
  "realRoutesRemainBackendRequired": true,
  "registeredLiveHttpRoutesChanged": false,
  "workerDispatchEnabled": false,
  "realToolExecutionEnabled": false,
  "productReadyApproved": false,
  "publicRuntimeApiEnabled": false,
