...
- Readiness: blocked
- Selected strategy: blocked_credentials_unavailable
- Deploy performed: no
- Verification performed: no
- Track B backfill rows written: no
- Production affected: no
- Direct/manual SQL run: no
- Active blockers: secret_manager_metadata_discovery_unavailable, secret_manager_supabase_db_url_candidate_missing_staging_label, secure_secret_manager_env_injection_required, staging_supabase_db_url_secret_reference_missing, blocked_credentials_unavailable, staging_supabase_db_url_secret_payload_access_denied, staging_schema_deploy_not_run, staging_schema_verification_not_run, staging_rls_verification_failed
