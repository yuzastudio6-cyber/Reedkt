...
-- Validated locally by RP-EXTERNAL-BETA-QWEN-RUNTIME-PERSISTENCE-LOCAL-HARNESS-VALIDATION-RETRY-12.
-- Do not apply to remote staging or production without the next guarded validation/approval packet.
...
-- Qwen extension: Qwen needs a tool runtime check entry, but the active
