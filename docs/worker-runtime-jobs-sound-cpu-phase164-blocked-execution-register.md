# WORKER_RUNTIME_JOBS SOUND CPU Phase164 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase164-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase164-blocked-execution-register",
  "blockedToday": {
