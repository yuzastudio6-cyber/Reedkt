...
```json
{
  ...
  "sourceEvidence": [
    {
      ...
      "head": "14e791451e0b0a46e164daa440460eb606d29d7a",
  ...
  "duplicateCloseoutPrSearch": "no_open_duplicate_for_TRACKB_MEDIA_OSS_PRODUCT_BETA_RUNTIME_CONTROLLED_ACTIVATION_CLOSEOUT_before_branch_creation",
  "closeoutScope": "source_truth_metadata_only"
}
```
