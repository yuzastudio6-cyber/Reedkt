...
import { executeMotionStudioSpeechAccountModelCapabilityLiveOperator } from './account-model-capability-live-operator'

try {
  const result = await executeMotionStudioSpeechAccountModelCapabilityLiveOperator({
