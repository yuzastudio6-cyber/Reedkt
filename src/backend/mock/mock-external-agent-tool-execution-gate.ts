  ...
  toolRows: [
    ...
    },
    {
      ...
      requiredBeforeExecution: [
        ...
        'controlled GPU proof must use the future approved us-west1-a transfer proof prompt before another VM attempt, dependency install, or inference',
        'controlled L4 proof must be no-idle: no public IP, prompt-scoped VM only, delete VM and verify cleanup before completion',
      ],
      currentBlocker: 'bounded_no_idle_l4_iap_wheelhouse_transfer_us_west1_a_prompt_required_before_dependency_or_inference',
      safeNextCommand: 'npm run smoke:ai-video-broll-gen-9p-iap-wheelhouse-transfer-stockout-fix-result',
