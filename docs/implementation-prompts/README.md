...
| 02 | Supabase Schema Review and Migration Validation | `codex/rp-foundation-02-supabase-schema-review-validation` | Pending PR | Open / pending validation | No | Schema review plus validation docs/static audit only. No production migration, remote Supabase migration, backend service-role handler, provider call, rendering, Stripe, worker execution, or tool execution. |
