...
export const EXTERNAL_AGENT_TOOL_EXECUTION_GATE = {
  ...
  toolRows: [
    ...
    },
    {
      ...
      requiredBeforeExecution: [
        ...
        '11H bounded latent inference-proof runner must remain implemented and fail closed before confirmed Wan inference-proof execution',
        '11H failed execution result must remain recorded as pipeline load timeout with cleanup verified before any retry',
        '11H fix must remain recorded with g2-standard-8 same-L4 retry shape, early pipeline-load markers, and 90 minute canary timeout',
      ...
      currentBlocker: 'bounded_wan_inference_proof_retry_required_after_11h_fix',
      safeNextCommand: 'npm run smoke:ai-video-broll-gen-11h-fix-inference-proof',
  ...
  brollCompletedInferenceExecutePrompt: AI_VIDEO_BROLL_GEN_11H_INFERENCE_PROOF_EXECUTE_PROMPT,
  brollCompletedInferenceFixPrompt: AI_VIDEO_BROLL_GEN_11H_FIX_INFERENCE_PROOF_PROMPT,
  brollRecommendedNextPrompt: AI_VIDEO_BROLL_GEN_11H_RETRY_INFERENCE_PROOF_PROMPT,
} as const
