# WORKER_RUNTIME_JOBS SOUND CPU Runtime Execution Owner-Gate Map Claim Policy

```json worker-runtime-jobs-sound-cpu-runtime-execution-owner-gate-map-claim-policy
{
