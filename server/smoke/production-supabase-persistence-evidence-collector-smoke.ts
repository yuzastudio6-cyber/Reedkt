...
const blockedAuditRecord = await runProductionSupabasePersistenceEvidenceCollectorFromEnv({
  ...supabasePersistenceEnv(),
  ...
  REEDITPRO_PRODUCTION_READINESS_IDEMPOTENCY_KEY: 'production-supabase-persistence-blocked-audit-smoke',
