...
export type AiGraphicsReadinessStatus =
  ...
  | 'declared_locked_and_browser_runtime_proof_passed'
  | 'declared_locked_and_satori_font_runtime_proof_passed'
...
const browserRuntimeBlockers = [
  'Tool Route and Worker execution approval are still required before agent execution',
  'browser/canvas/WebGL runtime may only run in approved future sandbox or worker lanes',
...
export const aiGraphicsToolCallReadinessRecords = [
  record({
    ...
    productionToolId: 'torch_torchvision',
  ...
  record({
    ...
    installSurface: 'node_package_lock',
    installEvidence: ['package.json: echarts ^6.1.0', 'package-lock.json node_modules/echarts', 'browser-runtime-proof: browser_svg_chart_runtime_proof_passed'],
    installStatus: 'declared_locked_and_browser_runtime_proof_passed',
    runtimeTarget: 'browser_chart_runtime_later',
    proofStatus: 'browser_svg_chart_runtime_proof_passed',
    runtimeStatus: 'browser_chart_runtime_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: false,
  ...
  record({
    ...
    productionWorkerType: 'cpu_analysis_worker',
  ...
  record({
    ...
    runtimeTarget: 'node_cpu_static',
    proofStatus: 'phase0_proof_passed',
    runtimeStatus: 'cpu_static_parse_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: true,
    blockersBeforeExecution: ['Tool Route and Worker execution approval are still required before agent execution.'],
    nextProofMilestone: 'tool_route_worker_handoff_for_vega_cpu_static_validation',
  }),
  record({
    toolId: 'satori',
    displayName: 'Satori',
    packageName: 'satori',
    productionToolId: 'satori',
    productionWorkerType: 'render_worker',
    capabilities: ['svg_graphics', 'planning_metadata_only'],
    rankingTier: 'Tier A',
    rankingScore: score(23, 17, 13, 7, 8, 7, 9),
    installSurface: 'node_package_lock',
    installEvidence: ['package.json: satori ^0.26.0', 'package-lock.json node_modules/satori', 'satori-font-runtime-proof: satoriTextSvgLayoutProofPassed=true'],
    installStatus: 'declared_locked_and_satori_font_runtime_proof_passed',
    runtimeTarget: 'node_cpu_static',
    proofStatus: 'satori_font_runtime_text_svg_layout_proof_passed',
    runtimeStatus: 'satori_text_svg_layout_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: true,
    blockersBeforeExecution: ['Tool Route and Worker execution approval are still required before agent execution.'],
    nextProofMilestone: 'tool_route_worker_handoff_for_satori_text_svg_layout',
  }),
  record({
    toolId: 'svgdotjs_svg_js',
    displayName: '@svgdotjs/svg.js',
    packageName: '@svgdotjs/svg.js',
    productionToolId: 'svgdotjs_svg_js',
    productionWorkerType: 'render_worker',
    ...
    runtimeStatus: 'cpu_static_svg_construction_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: true,
    blockersBeforeExecution: ['Tool Route and Worker execution approval are still required before agent execution.'],
    nextProofMilestone: 'tool_route_worker_handoff_for_svgdotjs_cpu_static_svg_construction',
  }),
  record({
    toolId: 'viz_js',
    displayName: '@viz-js/viz',
    packageName: '@viz-js/viz',
    productionToolId: 'viz_js',
    productionWorkerType: 'render_worker',
    ...
    runtimeTarget: 'node_cpu_static',
    proofStatus: 'phase0_proof_passed',
    runtimeStatus: 'cpu_static_graphviz_wasm_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: true,
    blockersBeforeExecution: ['Tool Route and Worker execution approval are still required before agent execution.'],
    nextProofMilestone: 'tool_route_worker_handoff_for_viz_js_cpu_static_diagram_generation',
  }),
  record({
    toolId: 'lottie_web',
    ...
    installEvidence: ['package.json: lottie-web ^5.13.0', 'productionToolId alias: lottie', 'browser-runtime-proof: browser_svg_animation_runtime_proof_passed'],
    installStatus: 'declared_locked_and_browser_runtime_proof_passed',
    runtimeTarget: 'browser_animation_runtime_later',
    proofStatus: 'browser_svg_animation_runtime_proof_passed',
    runtimeStatus: 'browser_animation_runtime_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: false,
  ...
  record({
    ...
    packageName: 'animejs',
    productionToolId: 'animejs',
    productionWorkerType: 'render_worker',
    capabilities: ['animation_overlay', 'planning_metadata_only', 'blocked_or_deferred'],
    rankingTier: 'Tier B',
    rankingScore: score(19, 15, 10, 6, 8, 8, 7),
    installSurface: 'node_package_lock',
    installEvidence: ['package.json: animejs ^4.4.1', 'package-lock.json node_modules/animejs', 'browser-runtime-proof: browser_dom_animation_runtime_proof_passed'],
    installStatus: 'declared_locked_and_browser_runtime_proof_passed',
    runtimeTarget: 'browser_animation_runtime_later',
    proofStatus: 'browser_dom_animation_runtime_proof_passed',
    runtimeStatus: 'browser_animation_runtime_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: false,
    blockersBeforeExecution: ['Tool Route and Worker execution approval are still required before agent execution.'],
    nextProofMilestone: 'tool_route_worker_handoff_for_animejs_animation_metadata',
  }),
  record({
    toolId: 'three_js',
    ...
    installSurface: 'node_package_lock',
    installEvidence: ['package.json: three ^0.184.0', 'package-lock.json node_modules/three', 'browser-runtime-proof: browser_webgl_runtime_proof_passed'],
    installStatus: 'declared_locked_and_browser_runtime_proof_passed',
    runtimeTarget: 'browser_canvas_webgl_runtime_later',
    proofStatus: 'browser_webgl_runtime_proof_passed',
    runtimeStatus: 'browser_webgl_runtime_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: false,
    blockersBeforeExecution: browserRuntimeBlockers,
  ...
  record({
    ...
    installSurface: 'production_registry_alias',
    installEvidence: ['package.json: pixi.js ^8.19.0', 'productionToolId alias: pixijs', 'browser-runtime-proof: browser_canvas_webgl_runtime_proof_passed'],
    installStatus: 'declared_locked_and_browser_runtime_proof_passed',
    runtimeTarget: 'browser_canvas_webgl_runtime_later',
    proofStatus: 'browser_canvas_webgl_runtime_proof_passed',
    runtimeStatus: 'browser_canvas_webgl_runtime_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: false,
    blockersBeforeExecution: browserRuntimeBlockers,
  ...
  record({
    ...
    installSurface: 'node_package_lock',
    installEvidence: ['package.json: konva ^10.3.0', 'package-lock.json node_modules/konva', 'browser-runtime-proof: browser_canvas_runtime_proof_passed'],
    installStatus: 'declared_locked_and_browser_runtime_proof_passed',
    runtimeTarget: 'browser_canvas_webgl_runtime_later',
    proofStatus: 'browser_canvas_runtime_proof_passed',
    runtimeStatus: 'browser_canvas_runtime_proof_passed_but_agent_execution_blocked',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: false,
    blockersBeforeExecution: browserRuntimeBlockers,
  ...
  record({
    ...
    installSurface: 'production_registry_alias',
    installEvidence: ['package.json: babylonjs ^9.12.0', 'productionToolId alias: babylon_js', 'browser-runtime-proof: browser_webgl_runtime_proof_passed'],
    installStatus: 'declared_locked_and_browser_runtime_proof_passed',
    runtimeTarget: 'browser_canvas_webgl_runtime_later',
    proofStatus: 'browser_webgl_runtime_proof_passed',
    runtimeStatus: 'browser_webgl_runtime_proof_passed_but_agent_execution_blocked',
