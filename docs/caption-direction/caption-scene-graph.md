...
Head Intelligence may propose graph structures. Deterministic validation must reject invalid text lineage, unsupported layout, unsafe depth, missing glyphs, unresolvable timing, or unapproved renderer behavior before execution.
