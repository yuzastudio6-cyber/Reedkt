...
```json
{
  ...
  "report": "decision",
  "routeEnablementExecutionPassed": true,
  "readyForQaReview": true,
  "productReady": false,
  "blockedUntilQaAccepts": "product route enablement QA must accept this bounded local/staging harness before the next unlock lane"
}
```
