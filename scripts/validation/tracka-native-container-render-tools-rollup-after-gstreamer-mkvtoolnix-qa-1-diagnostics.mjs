...
const installProof3Files = [
  ...
  'docs/track-a/native-container-render-tools/install-proof-3/source-of-truth-audit.md',
  'docs/track-a/native-container-render-tools/install-proof-3/package-source-review.md',
  'docs/track-a/native-container-render-tools/install-proof-3/tool-status-matrix.md',
  'docs/track-a/native-container-render-tools/install-proof-3/blocked-scope-register.md',
  'docs/track-a/native-container-render-tools/install-proof-3/next-phase-plan.md',
  'docs/track-a/native-container-render-tools/install-proof-3/validation-results.md',
