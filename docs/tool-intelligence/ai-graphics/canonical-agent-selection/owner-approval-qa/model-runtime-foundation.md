# Model Runtime Foundation Owner Approval QA
...
- `preferredPlanningToolsOwnerApprovalQaAccepted`: `torch_torchvision`, `transformers`
- `conditionalPlanningToolsOwnerApprovalQaAccepted`: none
- `fallbackPlanningToolsOwnerApprovalQaAccepted`: `kornia`
- `eliminatedToolsOwnerApprovalQaAccepted`: `vega_lite`, `lottie_web`
- `missingProofRulesOwnerApprovalQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApprovalQaAccepted`: CPU/GPU/model-boundary proof missing; model downloads and provider/model runtime are not approved
- `nextProofMilestoneOwnerApprovalQaAccepted`: model runtime foundation proof lane
