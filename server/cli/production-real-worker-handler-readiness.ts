...
export function buildProductionRealWorkerHandlerReadinessReport(): ProductionRealWorkerHandlerReadinessReport {
  ...
  const routerConditionalNonMockOutputs = countOccurrences(sources.workerRouter, 'mockOnly: !realMediaHandler') +
    ...
    countOccurrences(sources.workerRouter, 'mockOnly: !realColorQaMetadataHandler') +
  ...
  const checks: HandlerReadinessCheck[] = [
    ...
    },
    {
      ...
      evidence: {
        ...
        colorQaMetadataAdapterPresent: sources.gatewaySchemas.includes('qa_worker_color_metadata'),
    ...
    },
    {
      ...
      passed: (
        ...
        sources.gatewaySmoke.includes('qa_worker_color_metadata') ||
      ...
      evidence: {
        ...
        realColorQaMetadataAdapterMentions: countOccurrences(sources.gatewaySmoke, 'qa_worker_color_metadata'),
