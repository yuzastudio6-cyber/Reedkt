...
- This milestone adds explicit study cards and planning-only adapter contracts for all remaining first-class registry tools: `animejs`, `audioflux`, `babylon_js`, `cesium_js`, `d3`, `deck_gl`, `demucs`, `duckdb`, `echarts`, `essentia`, `hyperframe`, `konva`, `kornia`, `librosa`, `lottie`, `maplibre`, `mediapipe`, `pixijs`, `playwright`, `polars`, `rembg`, `revideo`, `rnnoise`, `rubber_band`, `satori`, `signalsmith_stretch`, `soundtouch`, `svg_js`, `three_js`, `torch_torchvision`, `transformers`, `transparent_background`, `turf`, `vapoursynth`, `vega`, `vega_lite`, `viz_js`, `whisper_cpp`.
...
- Governance-sensitive tools such as `essentia`, `rubber_band`, `revideo`, `transparent_background`, `whisper_cpp`, `torch_torchvision`, `transformers`, and model-weight-dependent GPU tools remain planning-only and must not be treated as installed or executable.
