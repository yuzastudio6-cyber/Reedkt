# WORKER_RUNTIME_JOBS SOUND CPU Phase 58 Caption Render Runtime Hook Blocked-State Source Runtime Integration Controlled Factory Validation Report

```json worker-runtime-jobs-sound-cpu-phase58-caption-render-runtime-hook-blocked-state-source-runtime-integration-controlled-factory-validation-report
{
  "label": "worker-runtime-jobs-sound-cpu-phase58-caption-render-runtime-hook-blocked-state-source-runtime-integration-controlled-factory-validation-report",
  ...
  "controlledFactoryCommand": {
    "command": "node_modules/.bin/tsx --eval import-runtime-integration-and-call-blocked-result-factory-with-synthetic-ids",
    "result": "passed",
    "moduleImported": true,
    "factoryInvokedWithSyntheticIds": true,
...
Dependency hydration was used only to run the synthetic factory proof and validation commands. No hook, worker, media, provider, artifact, Supabase, beta, or production path was enabled.
