...
for (const required of [
  ...
  '`broll_no_idle_l4_iap_wheelhouse_transfer_us_east4_a_stocked_out_capacity_strategy_required`',
...
assert.equal(rollup.recommendedNextPrompt, BROLL_9X_STOCKOUT_FIX_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_9X_STOCKOUT_FIX_PROMPT)
