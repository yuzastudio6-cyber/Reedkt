...
```json worker-runtime-jobs-sound-cpu-phase52-caption-render-runtime-hook-blocked-state-source-runtime-integration-precondition-plan
{
  "owner": "WORKER_RUNTIME_JOBS",
  "requiredSourceDecision": "worker_runtime_jobs_sound_cpu_phase51_caption_render_runtime_hook_blocked_state_source_integration_readiness_closure_owner_review_passed_with_warnings_ready_for_runtime_integration_precondition_plan_no_media_no_artifacts",
  ...
  "sourceHeadAtPromptCreation": "5be5533395267eae4ef377bc6608c06ea0e4a35c",
...
Use this prompt only after the Phase 51 closure owner-review packet merges and duplicate checks confirm no same-purpose Phase 52 PR already exists.
