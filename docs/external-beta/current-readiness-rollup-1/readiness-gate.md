...
Current integration head: `4ff3b917b9544ba04af0a73dfec3ec0c961b0b98`
...
1. Add or remove external beta testers by Google Group membership in `external-beta-testers@reeditpro.com`.
...
Controlled external beta is enabled on the staging API only. The correct status is `ready_for_owner_managed_external_beta_tester_membership_addition` with `external beta enabled in this phase: true`. Access is routed through the owner-managed Google security group `external-beta-testers@reeditpro.com`; do not broaden IAM beyond that staging service group binding.
