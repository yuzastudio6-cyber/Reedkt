...
- Preferred planning tools accepted: `vega_lite`, `d3`
- Conditional planning tools accepted: `echarts`
- Fallback planning tools accepted: `vega`
...
Next milestone: `Future chart overlay spec/runtime approval before execution.`.
