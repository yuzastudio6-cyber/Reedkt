...
exception
  when insufficient_privilege then
    raise notice 'Skipping storage upload pipeline storage.objects policy comments because the local migration role does not own the Supabase platform table.';
end $$;
