...
The UI appears in `/projects/new`, the existing inline edit-level setup card, and planning context. The Edit Brief summary stays focused on optional user direction and should not become a nested estimate or capability surface.
