...
const allowedChangedFiles = new Set([
  ...requiredFiles,
  'docs/internal-beta/rp-provider-01-internal-beta-disabled-provider-adapter-scaffold/source-audit.md',
  'docs/internal-beta/rp-provider-01-internal-beta-disabled-provider-adapter-scaffold/provider-adapter-scaffold-matrix.md',
  'docs/internal-beta/rp-provider-01-internal-beta-disabled-provider-adapter-scaffold/provider-runtime-boundary.md',
  'docs/internal-beta/rp-provider-01-internal-beta-disabled-provider-adapter-scaffold/readiness-gate.md',
