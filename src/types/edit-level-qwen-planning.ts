...
export const REEDITPRO_EDIT_LEVEL_QWEN_PLANNING_RULE =
  'Edit Level planning profiles define how the main planning agent should reason by level, but they do not call a model or execute planners.'

export const REEDITPRO_EDIT_LEVEL_QWEN_PLANNING_NO_EXECUTION_RULE =
  'RP-EDITLEVEL-07 resolves local planning policy only; it must not call models, external services, planners, workers, render, or credits.'
