...
for (const required of [
  ...
  '`broll_payload_install_resource_availability_strategy_required_after_10n_northamerica_northeast1_c_failure`',
...
assert.equal(rollup.recommendedNextPrompt, BROLL_10O_PAYLOAD_INSTALL_RESOURCE_AVAILABILITY_FIX_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_10O_PAYLOAD_INSTALL_RESOURCE_AVAILABILITY_FIX_PROMPT)
