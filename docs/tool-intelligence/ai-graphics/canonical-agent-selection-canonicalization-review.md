...
This canonicalization review records the PR #671/#674/#677/#681/#683 chain as the current source of truth for AI graphics agent-selection planning/study metadata only. It canonicalizes all 21 AI graphics tools and all 12 product-facing capabilities without enabling execution, runtime, storage, public artifacts, beta, or production.
...
- Canonical agent-selection ledger: created.
- Canonical agent-selection matrix: created.
- Schema, capability map, ranking, elimination, fallback, missing-proof, planning-only, safety, and examples: canonicalized.
