# WORKER_RUNTIME_JOBS SOUND CPU Phase175 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase175-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase175-blocked-execution-register",
  "blockedToday": {
