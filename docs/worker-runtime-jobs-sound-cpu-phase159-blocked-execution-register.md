# WORKER_RUNTIME_JOBS SOUND CPU Phase159 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase159-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase159-blocked-execution-register",
  "blockedToday": {
