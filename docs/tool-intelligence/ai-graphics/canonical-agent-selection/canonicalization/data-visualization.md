# Data Visualization Canonicalization Review
...
- `preferredPlanningToolsCanonicalized`: `vega_lite`, `vega`, `d3`
- `conditionalPlanningToolsCanonicalized`: `echarts`
- `fallbackPlanningToolsCanonicalized`: `svgdotjs_svg_js`
- `eliminatedToolsCanonicalized`: `sam2`, `real_esrgan`, `lottie_web`
- `missingProofRulesCanonicalized`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsCanonicalized`: browser chart runtime not approved for echarts; model/GPU tools are capability mismatches
- `nextProofMilestoneCanonicalized`: future data visualization execution proof after runtime approval
