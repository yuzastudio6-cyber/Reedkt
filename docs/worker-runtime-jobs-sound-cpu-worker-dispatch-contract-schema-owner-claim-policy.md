# WORKER_RUNTIME_JOBS SOUND CPU Worker Dispatch Contract Schema Owner Claim Policy

```json worker-runtime-jobs-sound-cpu-worker-dispatch-contract-schema-owner-claim-policy
{
