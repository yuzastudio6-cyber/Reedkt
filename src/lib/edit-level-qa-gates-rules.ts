...
export const EDIT_LEVEL_QA_GATE_DEFINITIONS: EditLevelQAGateDefinition[] = [
  ...
  gate('qwen25vl_visual_confidence', 'Visual understanding confidence', 'visual', 'Checks future visual confidence policy without calling a model.', 'provider_required'),
...
const premiumGateSpecs: GateSpec[] = [
  ...
  route('qwen25vl_visual_confidence', 'warning_only', 'provider_required', 'Premium shows visual-confidence gaps as warnings.', 'Use source markers and key-moment fallback.'),
...
const ultraGateSpecs: GateSpec[] = [
  ...
  route('qwen25vl_visual_confidence', 'required', 'provider_required', 'Ultra Premium requires future visual confidence.', 'Degrade to Premium-safe visual context until visual understanding exists.', true),
