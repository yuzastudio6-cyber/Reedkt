...
import { requireBackendOrWorkerAuth } from '../middleware/auth'
...
export function createWorkerRoutes(): Router {
  ...
  router.post('/v1/jobs/:jobId/claim', requireBackendOrWorkerAuth, requireIdempotency, asyncRoute(async (request, response) => {
  ...
  router.post('/v1/jobs/:jobId/heartbeat', requireBackendOrWorkerAuth, asyncRoute(async (request, response) => {
  ...
  router.post('/v1/jobs/:jobId/release', requireBackendOrWorkerAuth, asyncRoute(async (request, response) => {
  ...
  router.post('/v1/tool-runtime-checks', requireBackendOrWorkerAuth, asyncRoute(async (request, response) => {
  ...
  router.post('/v1/workers/tool-readiness/check', requireBackendOrWorkerAuth, asyncRoute(async (request, response) => {
  ...
  router.post('/v1/workers/jobs/:jobId/run', requireBackendOrWorkerAuth, asyncRoute(async (request, response) => {
  ...
  router.post('/v1/workers/jobs/:jobId/probe-media', requireBackendOrWorkerAuth, asyncRoute(async (request, response) => {
