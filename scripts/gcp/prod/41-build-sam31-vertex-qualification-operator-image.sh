...
# Builds the source-bound metadata/control-only Vertex qualification operator.
# It does not stage bytes, start a Vertex job, or run a model.
...
readonly CONFIG='scripts/gcp/prod/cloudbuild-sam31-vertex-qualification-operator.yaml'
readonly CONFIRMATION='build-weeditpro-sam31-vertex-qualification-operator-v1'
...
[[ "${WEEDITPRO_CONFIRM_SAM31_VERTEX_QUALIFICATION_OPERATOR_IMAGE_BUILD:-}" \
...
printf '{"operation":"weeditpro_sam31_vertex_qualification_operator_image_build_v1",'
