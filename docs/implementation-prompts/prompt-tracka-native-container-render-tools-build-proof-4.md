...
Do not run Docker build, inspect images, execute tools, process media, mutate Supabase, run SQL, create signed/public artifacts, or unlock beta/production/final delivery until owner or environment package-source policy changes and a future install-source PR records safe package declarations.
