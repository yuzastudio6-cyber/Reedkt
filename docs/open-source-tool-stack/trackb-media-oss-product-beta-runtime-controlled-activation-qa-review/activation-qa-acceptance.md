...
```json
{
  ...
  "failClosedRouteRuntimeControlsAccepted": true,
  "perToolWorkerDispatchGuardsAccepted": true,
  "approvedSnapshotGateAccepted": true,
  "editPlanApprovalGateAccepted": true,
  "creditGateAccepted": true,
  "serviceRoleNoWriteBoundaryAccepted": true,
  "sanitizedMonitoringAccepted": true,
  "rollbackDisableControlsAccepted": true,
  "limitedExposureControlsAccepted": true,
  "readyForControlledActivationCloseout": true,
  "readyForLiveProductCalls": false,
  "readyForDirectRouteDispatch": false,
  "readyForWorkerDispatchToRealTools": false,
