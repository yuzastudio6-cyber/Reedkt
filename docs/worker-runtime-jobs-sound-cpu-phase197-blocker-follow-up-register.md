# WORKER_RUNTIME_JOBS SOUND CPU Phase197 Blocker Follow-up Register

```json worker-runtime-jobs-sound-cpu-phase197-blocker-follow-up-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase197-blocker-follow-up-register",
  "failedChecks": [],
  "blockedDecisionUsed": "none",
  "mustStopFuturePreflightIf": [
    "preflight_plan_shape_invalid",
    "runtime_flag_true",
