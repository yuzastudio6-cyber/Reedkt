...
export type ExternalAgentToolNoIdleLifecycleGate = {
  ...
  targetRegion: 'us-central1' | 'us-west1' | 'us-east4'
  targetZone:
    | 'us-central1-a'
    | 'us-central1-b'
    | 'us-central1-c'
...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  decision:
    'external_agent_tool_execution_readiness_qwen_ready_for_explicit_gate_broll_9v_us_east4_a_transfer_proof_selected',
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_iap_wheelhouse_transfer_us_east4_a_selected_by_9v_no_vm_strategy',
      ...
      primaryBlocker:
        'bounded_no_idle_l4_iap_wheelhouse_transfer_us_east4_a_selected_future_prompt_required_before_vm_create',
      evidence: [
      ...
      nextAction: AI_VIDEO_BROLL_GEN_9W_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_EAST4_A_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
  ...
  recommendedNextPrompt: AI_VIDEO_BROLL_GEN_9W_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_EAST4_A_PROMPT,
} as const
