# Product Ready Candidate Matrix
...
All 16 Track B tools are accepted as product-ready candidates, but registry product-ready count remains 0 until closeout.
...
```json
{
  ...
  "report": "product-ready-candidate-matrix",
  "productReadyCandidatesAcceptedForCloseout": true,
  "productReadyCountBeforeCloseout": 0,
  "productReadyCountAfterThisQa": 0,
  "tools": [
    {
      "toolId": "ffprobe",
      "candidateForProductReadyCloseout": true,
      "productReadyInThisPhase": false
    },
    {
      "toolId": "mediainfo",
      "candidateForProductReadyCloseout": true,
  ...
  "closeoutRequiredBeforeRegistryCountMoves": true
}
```
