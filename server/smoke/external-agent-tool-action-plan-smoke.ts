...
assert.equal(qwen.externalManualBlocker.includes('exact bounded 58DW prompt'), true)
assert.equal(qwen.externalManualBlocker.includes('live auth/service/job preflight rechecks'), true)
