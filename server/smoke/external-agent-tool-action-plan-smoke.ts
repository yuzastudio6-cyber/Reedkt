...
assert.equal(qwen.externalManualBlocker.includes('bounded approved-fixture private inference retry attempt approval'), true)
assert.equal(qwen.externalManualBlocker.includes('after the retry gate'), true)
