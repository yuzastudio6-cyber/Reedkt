...
assert.equal(report.sourceTruth.sourceSha, '184f8b225d01d5bb38c7d3a09d8461bcf8e325dc')
assert.equal(report.sourceTruth.deployedEvidenceSourceSha, '184f8b225d01d5bb38c7d3a09d8461bcf8e325dc')
...
assert.equal(report.sourceTruth.currentSourceApiDeployPacket, 'docs/beta-readiness/api-staging-deploy-current-source/2026-06-29-184f-api-staging-deploy.json')
assert.equal(report.sourceTruth.deployedEvidenceInputManifest, 'docs/beta-readiness/deployed-evidence-input-manifest/2026-06-29-184f-deployed-evidence-input-manifest.json')
assert.equal(report.sourceTruth.normalApiRevision, 'reeditpro-api-staging-00014-xdj')
...
assert.equal(report.sourceTruth.normalApiDeployRunId, '28388776429')
...
assert.ok(report.postApprovalCommands.includes('npm run beta:readiness:external-beta-operator-value-progress'))
...
assert.ok(markdownDoc.includes('reeditpro-api-staging-00014-xdj'))
assert.ok(markdownDoc.includes('api-staging-184f8b225d01-20260629T1655Z'))
