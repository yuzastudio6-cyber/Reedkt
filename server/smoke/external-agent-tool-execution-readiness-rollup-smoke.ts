...
assert.equal(rollup.recommendedNextPrompt, BROLL_10C_US_EAST1_C_TRANSFER_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_10C_US_EAST1_C_TRANSFER_PROMPT)
...
assert.equal(broll?.noIdleLifecycleGate?.targetZone, 'us-east1-c')
