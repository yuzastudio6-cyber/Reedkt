...
Commands to validate this packet:
...
- `npm run --silent rp-external-beta-gstreamer-mkvtoolnix-external-agent-controlled-generated-fixture-execution-1:diagnostics`
