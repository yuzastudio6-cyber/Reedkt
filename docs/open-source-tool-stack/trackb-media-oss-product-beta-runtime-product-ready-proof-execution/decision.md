...
```json
{
  ...
  "boundedProofExecutionCompleted": true,
  "failClosedRouteProofPassed": true,
  ...
  "blockedReason": "Track B tool-call routes are still disabled/backend_required, so product-ready proof cannot pass yet."
}
```
