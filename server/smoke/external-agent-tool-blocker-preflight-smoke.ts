...
assert.equal(
  spec.broll.nextActionIfCleared.includes('AI-VIDEO-BROLL-GEN-10X-NO-IDLE-L4-PAYLOAD-INSTALL-RETRY-WITH-IAP-LOOKUP-READINESS'),
  true,
)
...
assert.equal(
  renderedCommands.includes('gcloud compute regions describe northamerica-northeast2 --project reeditpro --format=json'),
  true,
)
