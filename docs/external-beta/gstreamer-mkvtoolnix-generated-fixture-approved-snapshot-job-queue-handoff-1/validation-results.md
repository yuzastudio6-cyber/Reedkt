...
- `npm run smoke:rp-external-beta-gstreamer-mkvtoolnix-generated-fixture-approved-snapshot-job-queue-handoff-1`
- `npm run --silent rp-external-beta-gstreamer-mkvtoolnix-generated-fixture-approved-snapshot-job-queue-handoff-1:diagnostics`
- `npm run build`
- `npm run build:server`
- `git diff --cached --check`

Safety scans are non-executing file-content checks only. They must reject package-lock mutation, generated artifacts, Docker/tool/media execution claims, FFmpeg/FFprobe execution, private/user media processing, Supabase/SQL, signed/public artifacts, worker/provider/model execution, and beta/production/final-delivery unlock claims.
