...
The Captions Specialist may propose phrase groups and emphasis inside its
bounded job. Deterministic validation checks lineage, coverage, language
rules, timing, width, claims, and renderer feasibility.
