...
assert.deepEqual(model.versionAliases, ['occlusion-continuity-candidate'])
...
assert.equal(deployedModel.id, '3101000014')
...
console.log(JSON.stringify({
  ...
  candidateAlias: 'occlusion-continuity-candidate',
