...
```json
{
  ...
  "sanitizedReceiptProducedForBlockedHarness": true,
  "rawPayloadLoggingAllowed": false,
  "privatePayloadPrinted": false,
  "productMonitoringForSuccessfulDispatchProven": false,
  "blockedReason": "successful product dispatch monitoring cannot be proven while product routes are disabled/backend_required"
}
```
