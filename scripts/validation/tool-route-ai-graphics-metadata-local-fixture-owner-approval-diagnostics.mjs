...
const baseRef = 'origin/codex/rp-tool-route-ai-graphics-metadata-local-fixture-validation-qa-review'
const expectedDecision = 'tool_route_ai_graphics_metadata_local_fixture_owner_approved_with_warnings'
const allowedDecisions = new Set([
  'tool_route_ai_graphics_metadata_local_fixture_owner_approved_with_warnings',
  'tool_route_ai_graphics_metadata_local_fixture_owner_approved',
  'blocked_pending_ai_graphics_owner_approval_fixes',
  'blocked_pending_worker_handoff_review',
  'blocked_pending_route_fixture_gate_scope_review',
  'blocked_pending_artifact_scope_owner_review',
])

const requiredDocs = [
  'docs/tool-route-execution/ai-graphics-metadata-local-fixture-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-local-fixture-owner-approval-source-lockfile.md',
  'docs/tool-route-execution/ai-graphics-local-fixture-owner-approval-matrix.md',
  'docs/tool-route-execution/ai-graphics-valid-case-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-invalid-case-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-blocked-case-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-scoped-manifest-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-private-artifact-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-fail-closed-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-no-execution-proof-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-worker-handoff-owner-approval.md',
  'docs/tool-route-execution/ai-graphics-local-fixture-owner-approval-blocked-use-register.md',
  'docs/tool-route-execution/ai-graphics-local-fixture-owner-approval-decision.md',
  'docs/tool-route-execution/ai-graphics-local-fixture-owner-approval-next-lane-recommendation.md',
  'docs/prompt-tool-route-ai-graphics-metadata-local-fixture-owner-approval-results.md',
  'docs/implementation-prompts/prompt-tool-route-ai-graphics-metadata-local-fixture-owner-approval.md',
]
...
const requiredTrueBooleans = ['ownerApprovedFutureLocalFixtureGateStatusPacket']
...
const requiredTokens = [
  ...
  'PR #398',
  'PR #164',
  'TOOL_ROUTE_AI_GRAPHICS_METADATA_LOCAL_FIXTURE_GATE_STATUS_PACKET',
  'no write',
  'docs_only',
...
const forbiddenPatterns = [
  ...
  ['webgl_runtime_claim', /\bWebGL(?:\/canvas)? runtime\b[^.\n]*(?:performed|executed|enabled|approved now|approved with|true|passed)\b/i],
...
const decisionDoc = read('docs/tool-route-execution/ai-graphics-local-fixture-owner-approval-decision.md')
const matrixDoc = read('docs/tool-route-execution/ai-graphics-local-fixture-owner-approval-matrix.md')
...
const unsafeClaimText = docsText
  ...
  .filter(
    (line) =>
      !/\b(?:No|no|not|blocked|unapproved|does not approve|do not approve|must not|remains|remain|stays|false|future gate-status|future lane|metadata-only|static|owner approval|approval only|policy context|context only|planning|handoff|separately gated|without|warning|warnings|defer|deferred|none|placeholder|accepted with warnings|accepted_with_warnings|source evidence|source chain|required follow-up|before output)\b/i.test(
        line,
      ),
  )
  .join('\n')
...
const expectedScript =
  'node scripts/validation/tool-route-ai-graphics-metadata-local-fixture-owner-approval-diagnostics.mjs'
if (packageJson?.scripts?.['tool-route:ai-graphics-metadata-local-fixture-owner-approval:diagnostics'] !== expectedScript) {
  failures.push('missing_package_script:tool-route:ai-graphics-metadata-local-fixture-owner-approval:diagnostics')
}
...
if (failures.length > 0) {
  console.error('TOOL_ROUTE_AI_GRAPHICS_METADATA_LOCAL_FIXTURE_OWNER_APPROVAL diagnostics failed:')
  for (const failure of failures) console.error(`- ${failure}`)
  process.exit(1)
}

console.log('TOOL_ROUTE_AI_GRAPHICS_METADATA_LOCAL_FIXTURE_OWNER_APPROVAL diagnostics passed')
console.log(`decision=${expectedDecision}`)
console.log(`tools=${requiredTools.length}`)
console.log('ownerApprovedFutureLocalFixtureGateStatusPacket=true')
console.log('ownerApprovedFutureLocalFixtureValidationExecution=false')
console.log('ownerApprovedFutureLocalFixtureExecution=false')
console.log('ownerApprovedFutureRouteExecution=false')
console.log('ownerApprovedFutureActualToolExecution=false')
console.log('ownerApprovedFutureWorkerExecution=false')
console.log('ownerApprovedFutureProviderRuntime=false')
console.log('ownerApprovedFutureBrowserRuntime=false')
console.log('ownerApprovedFutureWebglRuntime=false')
console.log('ownerApprovedFutureCanvasRuntime=false')
console.log('ownerApprovedFutureResvgRasterization=false')
console.log('ownerApprovedFutureRemotionRenderExport=false')
