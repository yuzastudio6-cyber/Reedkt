...
```json
{
  ...
  "approvedSnapshotIdRequired": true,
  "editPlanIdRequired": true,
  "creditReservationIdRequired": true,
  "idempotencyKeyRequired": true,
  "privateArtifactReferenceRequired": true,
  "qualityGateIdsRequired": true,
  "realCreditMutationRun": false,
  "realBillingRun": false,
  "positiveCreditReservedDispatchProven": false,
  "blockedReason": "route remains disabled/backend_required, so an approved local dispatch path cannot be proven yet"
}
```
