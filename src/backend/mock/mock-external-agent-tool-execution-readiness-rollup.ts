...
export type ExternalAgentToolNoIdleLifecycleGate = {
  ...
  targetZone: 'us-central1-a' | 'us-central1-b' | 'us-central1-c' | 'us-west1-a' | 'us-west1-b'
...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_iap_wheelhouse_transfer_stockout_fix_ready_for_us_west1_b_transfer_proof',
      ...
      nextAction: AI_VIDEO_BROLL_GEN_9S_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_WEST1_B_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
        ...
        cacheReadinessCommand: 'npm run ai-video-broll-wan-fast-cache-readiness:check',
        quotaVerificationCommand: 'npm run ai-video-broll-wan-gpu-global-quota:verify',
        nextActionAfterQuotaClears: AI_VIDEO_BROLL_GEN_9S_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_WEST1_B_PROMPT,
      },
    },
    {
  ...
  recommendedNextPrompt: AI_VIDEO_BROLL_GEN_9S_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_WEST1_B_PROMPT,
} as const
