# Model Runtime Foundation Canonicalization Owner Approval
...
- `preferredPlanningToolsOwnerApproved`: `torch_torchvision`, `transformers`
- `conditionalPlanningToolsOwnerApproved`: none
- `fallbackPlanningToolsOwnerApproved`: `kornia`
- `eliminatedToolsOwnerApproved`: `vega_lite`, `lottie_web`
- `missingProofRulesOwnerApproved`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApproved`: CPU/GPU/model-boundary proof missing, model downloads and provider/model runtime are not approved
- `nextProofMilestoneOwnerApproved`: model runtime foundation proof lane
