# Diagram Graphics Canonicalization Owner Approval
...
- `eliminatedToolsOwnerApproved`: `vega_lite`
- `missingProofRulesOwnerApproved`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApproved`: diagram execution and public artifact output not approved, vega_lite only applies when request is chart-like
- `nextProofMilestoneOwnerApproved`: future DOT/SVG diagram execution boundary proof
