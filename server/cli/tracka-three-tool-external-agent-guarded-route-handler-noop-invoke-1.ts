...
} from '../services/tracka-three-tool-external-agent-guarded-route-handler-noop-invoke-1'

const reportRoot = '/tmp/reeditpro-tracka-three-tool-external-agent-guarded-route-handler-noop-invoke-1'
const reportFileName = 'three-tool-external-agent-guarded-route-handler-noop-invoke-report.json'
const manifestFileName = 'three-tool-external-agent-guarded-route-handler-noop-invoke-manifest.json'
...
async function main(): Promise<void> {
  ...
  const result = invokeThreeToolExternalAgentGuardedRouteHandlerNoop()
