# WORKER_RUNTIME_JOBS SOUND CPU Phase157 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase157-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase157-blocked-execution-register",
  "blockedToday": {
