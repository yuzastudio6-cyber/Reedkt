...
assert(reports.branchCliHelpReport.rawHelpStored === false, 'Branch help report must not store raw help output.')
assert(reports.branchCliHelpReport.dataCloneAllowed === false, 'Branch help report must keep data clone disabled.')
assert(reports.branchCreateRetryStrategyReport.dataCloneAllowed === false, 'Branch retry strategy must keep data clone disabled.')
