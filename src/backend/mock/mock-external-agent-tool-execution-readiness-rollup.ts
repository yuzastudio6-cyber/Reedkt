...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  decision:
    'external_agent_tool_execution_readiness_qwen_ready_for_explicit_gate_broll_9u_us_west1_c_stockout_capacity_strategy_required',
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_iap_wheelhouse_transfer_us_west1_c_stockout_capacity_strategy_required',
      ...
      nextAction: AI_VIDEO_BROLL_GEN_9V_IAP_WHEELHOUSE_TRANSFER_STOCKOUT_FIX_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
  ...
  recommendedNextPrompt: AI_VIDEO_BROLL_GEN_9V_IAP_WHEELHOUSE_TRANSFER_STOCKOUT_FIX_PROMPT,
} as const
