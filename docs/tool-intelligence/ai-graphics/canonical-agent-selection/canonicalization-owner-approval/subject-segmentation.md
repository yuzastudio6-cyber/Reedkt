# Subject Segmentation Canonicalization Owner Approval
...
- `conditionalPlanningToolsOwnerApproved`: `kornia`
- `fallbackPlanningToolsOwnerApproved`: `rembg`
- `eliminatedToolsOwnerApproved`: `echarts`, `vega`
...
- `nextProofMilestoneOwnerApproved`: segmentation model-boundary proof lane
