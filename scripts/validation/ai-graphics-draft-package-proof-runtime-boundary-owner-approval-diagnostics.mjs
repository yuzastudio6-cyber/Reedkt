...
const baseRef = 'origin/codex/rp-ai-graphics-draft-package-proof-runtime-boundary-qa-review'
const expectedDecision = 'ai_graphics_draft_package_proof_runtime_boundary_owner_approved_with_warnings'
const allowedDecisions = new Set([
  expectedDecision,
  'ai_graphics_draft_package_proof_runtime_boundary_owner_approved',
  'blocked_pending_ai_graphics_runtime_boundary_owner_matrix',
  'blocked_pending_ai_graphics_browser_webgl_owner_boundary',
  'blocked_pending_ai_graphics_tool_route_owner_boundary',
  'blocked_pending_ai_graphics_worker_owner_boundary',
])

const requiredDocs = [
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-approval-source-lockfile.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-approval-matrix.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-cpu-static-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-browser-chart-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-animation-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-webgl-canvas-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-tool-route-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-worker-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-blocked-use-register-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-approval-decision.md',
  'docs/prompt-ai-graphics-draft-package-proof-runtime-boundary-owner-approval-results.md',
  'docs/implementation-prompts/prompt-ai-graphics-draft-package-proof-runtime-boundary-owner-approval.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-approval-matrix.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-approval-source-lockfile.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-owner-approval.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones-owner-approval.json',
]

const expectedSources = ['PR #598', 'PR #594', 'PR #589', 'PR #585', 'PR #582', 'PR #425', 'PR #433', 'PR #441', 'PR #543', 'PR #536', 'PR #416', 'PR #542', 'PR #544']
...
const requiredTrueBooleans = [
  'runtimeBoundaryOwnerApprovalCompleted',
  'runtimeBoundaryQaAccepted',
  'all13PackageProofToolsOwnerReviewed',
  'canonicalPackageProofAccepted',
  'agentSelectionMetadataOwnerAccepted',
]
...
let nextMilestones = {}
try {
  sourceLockfile = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-approval-source-lockfile.json')
  matrix = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-approval-matrix.json')
  agentSelection = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-owner-approval.json')
  nextMilestones = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones-owner-approval.json')
} catch (error) {
...
for (const source of ['pr598', 'pr594', 'pr589', 'pr585', 'pr582', 'pr543', 'pr536']) {
...
if (agentSelection.agentSelectionMetadataOwnerAccepted !== true) failures.push('agent_selection_metadata_not_true')
...
if (nextMilestones.agentSelectionMetadataOwnerAccepted !== true) failures.push('milestone_agent_selection_not_true')
...
try {
  ...
  const expectedScript = 'node scripts/validation/ai-graphics-draft-package-proof-runtime-boundary-owner-approval-diagnostics.mjs'
  if (packageAfter.scripts?.['ai-graphics:draft-package-proof-runtime-boundary-owner-approval:diagnostics'] !== expectedScript) {
...
if (failures.length > 0) {
  console.error('AI graphics runtime boundary owner approval diagnostics failed:')
  for (const failure of failures) console.error(`- ${failure}`)
  process.exit(1)
}

console.log('AI graphics runtime boundary owner approval diagnostics passed.')
