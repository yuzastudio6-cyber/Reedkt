...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `torch_torchvision` | `model_runtime_foundation` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `none` | `outputDirectory` | `foundation_runtime_output_directory_missing` | `nativeCudaRuntime` | `none` | false | false | false |
| `transformers` | `model_runtime_foundation` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `none` | `outputDirectory` | `foundation_runtime_output_directory_missing` | `nativeCudaRuntime` | `none` | false | false | false |
