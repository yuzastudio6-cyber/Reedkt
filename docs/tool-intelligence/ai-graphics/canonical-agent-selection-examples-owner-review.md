# Canonical Agent Selection Examples Owner Review

Owner accepted PR #674's QA of the canonical selection examples. Each example may recommend planning/study metadata candidates only and must keep execution false.
