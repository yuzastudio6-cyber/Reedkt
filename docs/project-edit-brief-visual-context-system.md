...
Qwen2.5-VL is the visual/video specialist. Qwen 3.7 remains the Marker Chat reasoning brain and only sees visual availability in this milestone. RP-VIDEOCTX-04 owns full context-aware Marker Chat prompt integration.
