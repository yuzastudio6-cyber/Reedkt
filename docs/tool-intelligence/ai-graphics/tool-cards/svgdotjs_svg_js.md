...
- `bestFor`: explicit SVG construction planning; static overlay metadata contracts
- `notFor`: DOM adapter runtime now; model tasks
- `inputTypes`: `static_svg_construction_manifest`
- `outputTypes`: `svg_manifest_contract_metadata_json`
...
- `latencyClass`: `low`
- `qualityClass`: `high`
- `integrationComplexity`: `low_medium`
- `safetyLimitations`: DOM adapter/runtime not approved; public artifact blocked
- `fallbacks`: `satori`, `d3`
- `tier`: `Tier A`
- `totalScore`: `91`
