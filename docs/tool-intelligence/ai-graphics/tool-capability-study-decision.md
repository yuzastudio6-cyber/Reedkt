...
The capability study and ranking matrix completed with warnings. Agents may select AI graphics tools for planning/study metadata only. Tool execution, runtime readiness, internal beta, external beta, and production remain blocked.
