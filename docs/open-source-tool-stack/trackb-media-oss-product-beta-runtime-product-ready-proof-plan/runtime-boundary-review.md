...
```json
{
  ...
  "runtimeBoundary": {
    "currentPhaseLiveProductCallsApproved": false,
    "currentPhaseRouteDispatchApproved": false,
    "currentPhaseWorkerDispatchApproved": false,
    "currentPhaseRealToolExecutionApproved": false,
    "currentPhaseDockerOrInstallApproved": false,
    "currentPhaseMediaProcessingApproved": false,
    "currentPhaseSupabaseGcsWriteApproved": false,
    "currentPhaseExternalBetaApproved": false,
    "currentPhaseProductionApproved": false,
    "currentPhaseProductReadyApproved": false,
    "nextGateBoundedProofExecutionPlanned": true
  },
  "productReadyLocalOssCount": 0,
  "boundaryDecision": "plan_only_current_phase_no_runtime_unlock_next_gate_may_authorize_bounded_proof_execution"
}
```
