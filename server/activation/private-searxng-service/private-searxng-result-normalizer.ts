...
export function normalizePrivateSearxngResults(input: {
  response?: PrivateSearxngQueryResponse
  retrievedAt?: string
}): { sources: PrivateSearxngSourceRecord[]; blockers: string[]; warnings: string[] } {
