...
const environment = z.object({
  WEEDITPRO_SAM31_PRODUCTION_CAPSULE_CONFIRMATION: z.literal(CONFIRMATION),
  ...
  WEEDITPRO_SAM31_PRODUCTION_CAPSULE_CONFIRMATION:
    process.env.WEEDITPRO_SAM31_PRODUCTION_CAPSULE_CONFIRMATION,
...
const result = await createCanonicalSam31GcpProductionCapsulePublisher()
  .publish({
