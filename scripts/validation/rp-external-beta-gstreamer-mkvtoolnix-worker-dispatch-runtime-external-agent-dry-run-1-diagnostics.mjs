...
for (const file of [
  'docs/external-beta/gstreamer-mkvtoolnix-worker-dispatch-runtime-external-agent-execution-packet-1/source-audit.md',
  'docs/external-beta/gstreamer-mkvtoolnix-worker-dispatch-runtime-external-agent-execution-packet-1/execution-packet.md',
  'docs/external-beta/gstreamer-mkvtoolnix-worker-dispatch-runtime-external-agent-execution-packet-1/artifact-manifest-summary.md',
  'docs/external-beta/gstreamer-mkvtoolnix-worker-dispatch-runtime-external-agent-execution-packet-1/readiness.md',
  'docs/external-beta/gstreamer-mkvtoolnix-worker-dispatch-runtime-external-agent-execution-packet-1/safety-boundary.md',
  'docs/external-beta/gstreamer-mkvtoolnix-worker-dispatch-runtime-external-agent-execution-packet-1/validation-results.md',
