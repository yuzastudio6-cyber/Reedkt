# Data Visualization Canonicalization QA
...
- `preferredPlanningToolsQaAccepted`: `vega_lite`, `vega`, `d3`
- `conditionalPlanningToolsQaAccepted`: `echarts`
- `fallbackPlanningToolsQaAccepted`: `svgdotjs_svg_js`
- `eliminatedToolsQaAccepted`: `sam2`, `real_esrgan`, `lottie_web`
- `missingProofRulesQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsQaAccepted`: browser chart runtime not approved for echarts,model/GPU tools are capability mismatches
- `nextProofMilestoneQaAccepted`: future data visualization execution proof after runtime approval
