...
const reports = {
  sourceOfTruthOwnershipAudit: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'source_of_truth_ownership_audit.json')),
  contractPlan: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_contract_plan.json')),
  providerEvidenceReconciliation: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'provider_dry_run_evidence_reconciliation.json')),
  evidenceInventory: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_evidence_inventory.json')),
  agentFindingsSchema: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'agent_findings_v1_schema.json')),
  editIntentsSchema: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'edit_intents_v1_schema.json')),
  planSnapshotCandidateSchema: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_candidate_v1_schema.json')),
  approvedPlanSnapshotSchema: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'approved_plan_snapshot_v1_schema.json')),
  approvalHandoffPolicy: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'approval_gate_and_worker_handoff_policy.json')),
  fixtures: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_contract_fixtures.json')),
  validationReport: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_contract_validation_report.json')),
  decision: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_contract_decision.json')),
  blockerReport: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_contract_blocker_report.json')),
  readinessReport: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_contract_readiness_report.json')),
  privateArtifactManifest: readJson(path.join(MODEL_ORCHESTRATION_PLAN_SNAPSHOT_CONTRACT_REPORT_DIR, 'plan_snapshot_contract_private_artifact_manifest.json')),
}
