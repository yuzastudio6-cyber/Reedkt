...
for (const required of [
  ...
  '`broll_no_idle_l4_iap_wheelhouse_transfer_us_east1_d_stockout_fix_future_prompt_required`',
...
assert.equal(rollup.recommendedNextPrompt, BROLL_10F_STOCKOUT_FIX_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_10F_STOCKOUT_FIX_PROMPT)
