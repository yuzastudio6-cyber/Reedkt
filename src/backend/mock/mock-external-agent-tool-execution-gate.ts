  ...
  toolRows: [
    ...
    },
    {
      ...
      requiredBeforeExecution: [
        ...
        'controlled GPU proof must use the future 10G bounded transfer proof prompt before another VM attempt, dependency install, or inference',
      ...
      safeNextCommand:
        'npm run smoke:ai-video-broll-gen-10f-iap-wheelhouse-transfer-stockout-fix-result',
