  ...
  return [
    ...
    },
    {
      ...
      nextCommands: [
        ...
        'npm run beta:tools:local-accepted-evidence-bundle -- --local-defaults',
      ],
      blockedUntil: [
