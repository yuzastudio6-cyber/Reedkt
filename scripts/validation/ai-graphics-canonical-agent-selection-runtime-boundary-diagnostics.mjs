...
for (const key of scriptDrift) if (key !== expectedScript && key !== "ai-graphics:canonical-agent-selection:runtime-boundary-qa-diagnostics") fail("Unexpected script drift: " + key);
