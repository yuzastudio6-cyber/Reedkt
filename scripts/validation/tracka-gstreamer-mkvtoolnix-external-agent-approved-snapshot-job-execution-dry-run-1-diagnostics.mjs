...
const routeDryRunDir =
  'docs/external-beta/tracka-gstreamer-mkvtoolnix-external-agent-approved-snapshot-job-route-dry-run-1'
...
const followUpFiles = [
  `${routeDryRunDir}/source-audit.md`,
  `${routeDryRunDir}/route-dry-run-result.md`,
  `${routeDryRunDir}/route-contract.md`,
  `${routeDryRunDir}/artifact-manifest-summary.md`,
  `${routeDryRunDir}/safety-boundary.md`,
  `${routeDryRunDir}/validation-results.md`,
  `${routeDryRunDir}/tracka-gstreamer-mkvtoolnix-external-agent-approved-snapshot-job-route-dry-run-1-record.json`,
