...
- Next prompt recommendation: Prompt 15 - Provider Gateway Foundation if Prompt 14 validation and CI pass; otherwise Prompt 14A - Worker Execution Contract Validation Hardening.
