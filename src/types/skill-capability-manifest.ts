...
/**
 * Additive manifest shape used by skills that expose the future Orchestra seam.
 * V1 remains a frozen, readable public contract for already-published skills.
 */
export const SKILL_CAPABILITY_MANIFEST_SCHEMA_VERSION_V2 =
  'skill-capability-manifest-v2' as const
...
export interface SkillInvocationPolicyV2 {
  acceptedCallContractVersions: string[]
  hqMediated: true
...
export interface SkillResultContractV2 {
  jobResultSchemaVersion: string
  supportRequestSchemaVersion: string
...
export interface SkillFailureSemanticsV2 {
...
export interface SkillSecurityPolicyRefV2 {
  policyId: string
  policyVersion: string
  contentHash: string
}

export interface SkillCapabilityManifestV2 extends Omit<
  SkillCapabilityManifest,
  'manifestSchemaVersion'
> {
  manifestSchemaVersion: typeof SKILL_CAPABILITY_MANIFEST_SCHEMA_VERSION_V2
  canOwnPrimaryAnalysis: boolean
  invocationPolicy: SkillInvocationPolicyV2
  resultContract: SkillResultContractV2
  failureSemantics: SkillFailureSemanticsV2
  securityPolicyRef: SkillSecurityPolicyRefV2
}

export type AnySkillCapabilityManifest =
  | SkillCapabilityManifest
  | SkillCapabilityManifestV2

export type UnpublishedSkillCapabilityManifestV2 = Omit<
  SkillCapabilityManifestV2,
  'manifestHash'
>
