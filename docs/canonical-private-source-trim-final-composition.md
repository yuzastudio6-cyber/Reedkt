...
4. The final job requires one source, one cleanup decision, and exactly two lease-selected artifacts: the source-trim JSON and one QA-passed libass caption PNG.
