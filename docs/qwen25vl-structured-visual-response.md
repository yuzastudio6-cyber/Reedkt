...
Only structured visual summary metadata may be stored on a marker. The summary can be displayed in Marker Chat as available or fallback-used, but full Qwen 3.7 context-aware prompt integration remains a future milestone.
