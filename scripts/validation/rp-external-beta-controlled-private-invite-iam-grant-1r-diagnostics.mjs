...
if (rollup.mainSupabaseTarget?.ownerMemberSmokeReadback !== 'completed_owner_member_group_access_smoke_readback_external_tester_membership_still_pending') fail('rollup owner-member smoke status mismatch')
...
if (rollup.safety?.ownerMemberSmokeReadback !== 'completed_readonly_group_membership_readback_and_owner_member_authenticated_smoke') fail('rollup owner-member smoke safety mismatch')
