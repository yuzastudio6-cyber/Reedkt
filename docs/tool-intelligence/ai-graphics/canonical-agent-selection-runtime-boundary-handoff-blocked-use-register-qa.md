# Runtime Boundary Handoff Blocked-Use Register QA

Decision: `ai_graphics_canonical_agent_selection_runtime_boundary_handoff_qa_passed_with_warnings`

The blocked-use register is QA-accepted. It keeps tool, route, worker, provider/model, browser/WebGL/canvas, GPU/model, Supabase, SQL, GCS, signed URL, public artifact, beta, and production actions false.
