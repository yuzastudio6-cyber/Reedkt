# WORKER_RUNTIME_JOBS SOUND CPU Phase171 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase171-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase171-blocked-execution-register",
  "blockedToday": {
