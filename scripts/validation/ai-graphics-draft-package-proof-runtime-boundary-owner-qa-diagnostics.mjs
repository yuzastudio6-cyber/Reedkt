...
const baseRef = 'origin/codex/rp-ai-graphics-draft-package-proof-runtime-boundary-owner-approval'
const expectedDecision = 'ai_graphics_draft_package_proof_runtime_boundary_owner_qa_passed_with_warnings'
const allowedDecisions = new Set([
  expectedDecision,
  'ai_graphics_draft_package_proof_runtime_boundary_owner_qa_passed',
  'blocked_pending_ai_graphics_runtime_boundary_owner_qa_matrix',
  'blocked_pending_ai_graphics_browser_webgl_owner_boundary_qa',
  'blocked_pending_ai_graphics_tool_route_owner_boundary_qa',
  'blocked_pending_ai_graphics_worker_owner_boundary_qa',
])

const requiredDocs = [
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-review.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-source-lockfile.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-matrix.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-cpu-static-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-browser-chart-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-animation-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-webgl-canvas-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-tool-route-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-worker-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-blocked-use-register-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones-owner-qa.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-decision.md',
  'docs/prompt-ai-graphics-draft-package-proof-runtime-boundary-owner-qa-review-results.md',
  'docs/implementation-prompts/prompt-ai-graphics-draft-package-proof-runtime-boundary-owner-qa-review.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-matrix.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-source-lockfile.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-owner-qa.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones-owner-qa.json',
]

const expectedSources = ['PR #602', 'PR #598', 'PR #594', 'PR #589', 'PR #585', 'PR #582', 'PR #425', 'PR #433', 'PR #441', 'PR #543', 'PR #536', 'PR #416', 'PR #542', 'PR #544']
...
const expectedNextPrompt = 'AI_GRAPHICS_DRAFT_PACKAGE_PROOF_CPU_STATIC_SPEC_VALIDATION_APPROVAL'
const expectedLanes = {
...
const requiredTrueBooleans = [
  'runtimeBoundaryOwnerQaCompleted',
  'runtimeBoundaryOwnerApprovalAccepted',
  'runtimeBoundaryQaAccepted',
  'all13PackageProofToolsOwnerQaReviewed',
  'canonicalPackageProofAccepted',
  'agentSelectionMetadataOwnerQaAccepted',
]
...
let nextMilestones = {}
try {
  sourceLockfile = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-source-lockfile.json')
  matrix = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-matrix.json')
  agentSelection = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-owner-qa.json')
  nextMilestones = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones-owner-qa.json')
} catch (error) {
...
for (const expectedTool of expectedTools) {
  ...
  if (row.runtimeBoundaryOwnerApprovalAccepted !== true) failures.push(`owner_approval_not_accepted:${expectedTool}`)
  if (row.runtimeBoundaryQaAccepted !== true) failures.push(`runtime_qa_not_accepted:${expectedTool}`)
  if (row.ownerAcceptedPlanningSelection !== true) failures.push(`owner_planning_not_accepted:${expectedTool}`)
  if (row.ownerAcceptedExecutionBlocked !== true) failures.push(`owner_blocked_not_accepted:${expectedTool}`)
  if (row.runtimeBoundaryStatus !== expectedRuntimeStatus) failures.push(`unexpected_runtime_boundary_status:${expectedTool}`)
  if (row.agentCanSelectForPlanning !== true) failures.push(`agent_select_not_true:${expectedTool}`)
...
for (const source of ['pr602', 'pr598', 'pr594', 'pr589', 'pr585', 'pr582', 'pr543', 'pr536']) {
...
if (agentSelection.agentSelectionMetadataOwnerQaAccepted !== true) failures.push('agent_selection_metadata_not_true')
...
if (nextMilestones.agentSelectionMetadataOwnerQaAccepted !== true) failures.push('milestone_agent_selection_not_true')
if (nextMilestones.nextPromptRecommendation !== expectedNextPrompt) failures.push('unexpected_next_prompt')
...
try {
  ...
  const expectedScript = 'node scripts/validation/ai-graphics-draft-package-proof-runtime-boundary-owner-qa-diagnostics.mjs'
  if (packageAfter.scripts?.['ai-graphics:draft-package-proof-runtime-boundary-owner-qa:diagnostics'] !== expectedScript) {
...
if (failures.length > 0) {
  console.error('AI graphics runtime boundary owner QA diagnostics failed:')
  for (const failure of failures) console.error(`- ${failure}`)
  process.exit(1)
}

console.log('AI graphics runtime boundary owner QA diagnostics passed.')
