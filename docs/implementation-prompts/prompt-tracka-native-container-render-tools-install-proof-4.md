...
Readiness: `TRACKA-NATIVE-CONTAINER-RENDER-TOOLS-INSTALL-PROOF-4 readiness: blocked_pending_owner_approved_package_source`
...
- GPAC/MP4Box owner decision remains `blocked_no_owner_approval_for_gpac_mp4box_package_source`; allowed future source `none_until_owner_approval`.
...
- core VapourSynth owner decision remains `blocked_no_owner_approval_for_core_vapoursynth_package_source`; allowed future source `none_until_owner_approval`.
...
Package-source resolution result: `TRACKA-NATIVE-CONTAINER-RENDER-TOOLS-INSTALL-PROOF-4 readiness: blocked_pending_owner_or_environment_package_source_review`.
...
Owner decision result: `TRACKA-NATIVE-CONTAINER-RENDER-TOOLS-INSTALL-PROOF-4 readiness: blocked_pending_owner_approved_package_source`.
