  ...
  return (
    ...
    >
      ...
      <div className="edit-level-estimate-grid">
        ...
        <span><strong>{summary.creditEstimateMultiplier}</strong><small>Credit multiplier draft</small></span>
        <span><strong>{summary.analysisPassBudget}</strong><small>Analysis budget</small></span>
        <span><strong>{summary.qwenReasoningPassBudget}</strong><small>AI planning policy</small></span>
