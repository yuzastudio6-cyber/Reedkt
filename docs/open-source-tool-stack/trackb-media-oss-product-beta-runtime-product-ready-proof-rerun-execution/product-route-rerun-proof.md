...
The route proof uses the committed local/staging product route harness evidence and receipt contracts; it does not enable or call live product routes.
...
```json
{
  ...
  "report": "product-route-rerun-proof",
  "routeHarnessSource": "src/backend/api/trackb-media-oss-product-route-enablement-harness.ts",
  "routeIds": [
    "trackbMediaOss.toolCall.validate",
    "trackbMediaOss.toolCall.queue",
    "trackbMediaOss.toolCall.status"
  ],
  "equivalentServerRouteHarness": true,
  "productFacingRouteBehaviorProven": true,
  "proofMode": "bounded_local_staging_harness_receipt_rerun_from_committed_source_truth",
  "receiptStatuses": [
    "validated",
    "queued_dry_run",
    "status_dry_run"
  ],
  "receiptsSanitized": true,
  "liveProductCallsRan": false,
  "realRouteDispatchRan": false,
