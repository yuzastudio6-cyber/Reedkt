# Canvas Scene Canonicalization Owner Approval
...
- `eliminatedToolsOwnerApproved`: `torch_torchvision`, `transformers`
- `missingProofRulesOwnerApproved`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApproved`: browser/canvas sandbox approval missing, tool execution not approved
- `nextProofMilestoneOwnerApproved`: browser/canvas sandbox proof lane
