# Subject Segmentation Canonicalization QA
...
- `conditionalPlanningToolsQaAccepted`: `kornia`
- `fallbackPlanningToolsQaAccepted`: `rembg`
- `eliminatedToolsQaAccepted`: `echarts`, `vega`
...
- `nextProofMilestoneQaAccepted`: segmentation model-boundary proof lane
