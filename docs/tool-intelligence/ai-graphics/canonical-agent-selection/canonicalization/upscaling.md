# Upscaling Canonicalization Review
...
- `preferredPlanningToolsCanonicalized`: `real_esrgan`
- `conditionalPlanningToolsCanonicalized`: none
- `fallbackPlanningToolsCanonicalized`: `kornia`
- `eliminatedToolsCanonicalized`: `d3`, `satori`
- `missingProofRulesCanonicalized`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsCanonicalized`: model/GPU/provenance proof missing; GPU runtime not approved
- `nextProofMilestoneCanonicalized`: upscaling model/GPU/provenance proof lane
