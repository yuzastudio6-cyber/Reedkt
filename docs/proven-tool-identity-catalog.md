...
Evidence revision `2026-07-12.26` records:
...
- 43 exact tool identities verified through the server-derived canonical job adapter.
...
The 43 server-derived job-adapter verified tool identities are:
...
ffprobe, opentimelineio, remotion, polars, opencv, signalsmith_stretch, vapoursynth
```
