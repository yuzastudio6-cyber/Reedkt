...
- `EditBriefSummaryCard` stays focused on the user’s optional brief fields. Selected-level policy and capability summaries belong in setup and planning-context cards, not inside the brief form.
