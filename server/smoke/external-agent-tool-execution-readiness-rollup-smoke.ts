...
for (const required of [
  ...
  '`broll_payload_install_proof_northamerica_northeast1_c_required_after_10m_strategy`',
...
assert.equal(rollup.recommendedNextPrompt, BROLL_10N_NORTHAMERICA_NORTHEAST1_C_PAYLOAD_INSTALL_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_10N_NORTHAMERICA_NORTHEAST1_C_PAYLOAD_INSTALL_PROMPT)
