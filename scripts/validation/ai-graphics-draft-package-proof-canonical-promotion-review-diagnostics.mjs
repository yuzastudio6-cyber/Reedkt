...
const baseRef = 'origin/codex/rp-ai-graphics-draft-package-proof-merge-execution-pr441'
const expectedDecision = 'ai_graphics_draft_package_proof_canonical_promotion_review_passed_with_warnings'
const allowedDecisions = new Set([
  expectedDecision,
  'ai_graphics_draft_package_proof_canonical_promotion_review_passed',
  'blocked_pending_ai_graphics_batch_1_merge_reconciliation',
  'blocked_pending_ai_graphics_batch_2_merge_reconciliation',
  'blocked_pending_ai_graphics_batch_3_merge_reconciliation',
  'blocked_pending_ai_graphics_runtime_boundary_review',
])

const requiredDocs = [
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-promotion-review.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-promotion-source-lockfile.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-promotion-matrix.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-batch-1-canonical-promotion.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-batch-2-canonical-promotion.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-batch-3-canonical-promotion.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-status-ledger.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-after-canonical-promotion.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-next-proof-milestones-after-canonical-promotion.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-promotion-decision.md',
  'docs/prompt-ai-graphics-draft-package-proof-canonical-promotion-review-results.md',
  'docs/implementation-prompts/prompt-ai-graphics-draft-package-proof-canonical-promotion-review.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-promotion-matrix.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-promotion-source-lockfile.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-status-ledger.json',
]

const expectedSources = ['PR #582', 'PR #425', 'PR #433', 'PR #441', 'PR #543', 'PR #536', 'PR #416', 'PR #542', 'PR #544']
...
const requiredTrueBooleans = [
  'canonicalPromotionReviewCompleted',
...
const forbiddenPatterns = [
  ...
  ['e2e_promotion', /\b(canonicalE2ePromotionApproved|E2E[- ]proof)\b\s*[:=|]\s*`?(true|approved|claimed|passed)`?/i],
...
let ledger = {}
try {
  sourceLockfile = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-promotion-source-lockfile.json')
  matrix = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-promotion-matrix.json')
  ledger = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-canonical-status-ledger.json')
} catch (error) {
...
if (ledger.runtimeReadyTools !== 0 || ledger.internalBetaReadyTools !== 0 || ledger.productionReadyTools !== 0) failures.push('ledger_ready_counts_not_zero')
...
try {
  ...
  const expectedScript = 'node scripts/validation/ai-graphics-draft-package-proof-canonical-promotion-review-diagnostics.mjs'
  if (packageAfter.scripts?.['ai-graphics:draft-package-proof-canonical-promotion-review:diagnostics'] !== expectedScript) {
...
if (failures.length > 0) {
  console.error('AI graphics canonical promotion review diagnostics failed:')
  for (const failure of failures) console.error(`- ${failure}`)
  process.exit(1)
}

console.log('AI graphics canonical promotion review diagnostics passed.')
