# Subject Segmentation Canonicalization Owner Approval QA
...
- `conditionalPlanningToolsOwnerApprovalQaAccepted`: `kornia`
- `fallbackPlanningToolsOwnerApprovalQaAccepted`: `rembg`
- `eliminatedToolsOwnerApprovalQaAccepted`: `echarts`, `vega`
...
- `nextProofMilestoneOwnerApprovalQaAccepted`: segmentation model-boundary proof lane
