...
- Preferred planning tools accepted: `lottie_web`, `animejs`
- Conditional planning tools accepted: none
- Fallback planning tools accepted: `satori for static fallback planning`
...
Next milestone: `Animation manifest/runtime approval before player or timeline execution.`.
