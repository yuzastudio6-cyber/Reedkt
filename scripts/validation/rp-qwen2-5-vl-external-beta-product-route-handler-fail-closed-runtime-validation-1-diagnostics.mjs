...
const requiredFiles = [
  ...
  'docs/external-beta/qwen2-5-vl-external-beta-product-route-provider-runtime-fixture-1/source-audit.md',
  'docs/external-beta/qwen2-5-vl-external-beta-product-route-provider-runtime-fixture-1/product-route-runtime-fixture-blocker.md',
  'docs/external-beta/qwen2-5-vl-external-beta-product-route-provider-runtime-fixture-1/safety-boundary.md',
  'docs/external-beta/qwen2-5-vl-external-beta-product-route-provider-runtime-fixture-1/validation-results.md',
  'docs/external-beta/qwen2-5-vl-external-beta-product-route-provider-runtime-fixture-1/qwen2-5-vl-product-route-provider-runtime-fixture-record.json',
