# Canonical Agent Selection Source Lockfile
...
Duplicate search result: no exact canonical agent-selection PR, remote branch, or worktree existed before implementation.
