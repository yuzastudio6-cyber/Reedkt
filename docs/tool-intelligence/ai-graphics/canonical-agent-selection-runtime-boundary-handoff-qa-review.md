...
PR #718 is OPEN/draft=true/mergeable=MERGEABLE at d291277d68a5bf5e3bc076acd99cd1a0b3bd64a3.

This QA accepts PR #718's handoff review with warnings. The handoff connects the canonical runtime-boundary source of truth to canonical agent selection for planning/study metadata only.

## QA Scope

- Handoff schema: accepted with warnings.
- Handoff contract: accepted with warnings.
- Tool map: all 21 tools QA-reviewed.
- Capability map: all 12 product-facing capabilities QA-reviewed.
- Runtime buckets: all nine buckets QA-reviewed.
- Proof status and missing-proof behavior: accepted with warnings.
- Tool Route placeholder: accepted as future-only.
- Worker placeholder: accepted as future-only.
