...
```json
{
  ...
  "allWorkerContractsExecutionDisabled": true,
  "allowlistPresent": true,
  "workerDispatchAttempted": false,
  "workerDispatchToRealToolsProven": false,
  "blockedReason": "worker contracts intentionally remain disabled until route enablement gate creates a bounded product dispatch path"
}
```
