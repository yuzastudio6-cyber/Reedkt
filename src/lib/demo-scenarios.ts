...
export const demoScenarios: DemoScenario[] = [
  ...
  },
  {
    ...
    referenceUrl: '',
    customInstructions:
      'Explain how money moves through a scam network. Use clean diagrams, arrows, account cards, simple labels, and step-by-step visuals. Keep it easy to understand. Do not use random animation.',
    clips: [
      {
    ...
    expectedAssetBehavior: ['Diagram/card frames', 'Arrows and account cards', 'Step-by-step labels', 'No unnecessary AI video'],
    expectedProviderPolicy: ['GPT-Image-2 for frames/cards', 'Remotion/editor motion for controlled movement', 'No Veo because Pro', 'Matching panel background'],
    expectedSafetyNotes: ['No random animation', 'Keep claims educational and clear', 'No sensational scam visuals'],
  },
  {
    ...
    expectedAssetBehavior: ['Evidence cards', 'Name cards', 'Timeline cards', 'Money trail graphic', 'Selected Stroke Motion reenactments'],
    expectedProviderPolicy: ['GPT-Image-2 for cards/keyframes', 'Wan primary for animation', 'Hailuo fallback', 'Veo only final fallback/rescue', 'Matching panel background'],
    expectedSafetyNotes: ['Fact safety active', 'Claims marked fictional', 'Character packs for Marcus, Lena, Omar', 'No guilt-implying real-person treatment'],
  },
  {
    ...
    referenceUrl: '',
    customInstructions:
      'Create a polished product feature explainer for a SaaS dashboard. Show the problem, the feature, the benefit, and a clean CTA. Use premium graphic design, product callouts, and subtle motion. Real Motion only if it helps. Do not make it chaotic.',
    clips: [
      {
    ...
    expectedAssetBehavior: ['Problem/feature/benefit/CTA structure', 'Product callout cards', 'Premium graphic frames', 'Subtle motion'],
    expectedProviderPolicy: ['GPT-Image-2 for product cards/frames', 'Wan primary if AI video is needed', 'Hailuo fallback', 'No Veo because Pro'],
