...
export async function observeCanonicalVertexA100RateFixture(input: {
  ...
  return observeCanonicalCurrentGoogleCloudVertexA100RateAuthority({
    rateAuthorityId: input.rateAuthorityId ?? 'current-vertex-a100-rate-v1',
...
function createCanonicalVertexA100RateRawObservation(input: {
  ...
  const components = [
    component('vertex_training_a100_80gb_hour', 'gpu_hour', 'h',
      4_517_292_000, 'a', observedAt),
    component('vertex_training_a2_core_hour', 'vcpu_hour', 'h',
      36_352_650, 'b', observedAt),
    component('vertex_training_a2_ram_gib_hour', 'gib_hour', 'GiBy.h',
      4_872_550, 'c', observedAt),
    component('vertex_training_pd_ssd_gib_month', 'gib_month', 'GiBy.mo',
      195_500_000, 'd', observedAt),
...
function component(
  ...
  const vertexComponent = componentClass.startsWith('vertex_training')
  return {
    componentClass,
