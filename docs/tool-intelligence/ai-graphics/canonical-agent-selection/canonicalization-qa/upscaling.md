...
- `preferredPlanningToolsQaAccepted`: `real_esrgan`
- `conditionalPlanningToolsQaAccepted`: none
- `fallbackPlanningToolsQaAccepted`: `kornia`
- `eliminatedToolsQaAccepted`: `d3`, `satori`
- `missingProofRulesQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsQaAccepted`: model/GPU/provenance proof missing,GPU runtime not approved
- `nextProofMilestoneQaAccepted`: upscaling model/GPU/provenance proof lane
