...
```json
{
  ...
  "report": "runtime-boundary-closeout",
  "readyForRankedToolCallLane": true,
  "readyForExternalBeta": false,
  "readyForProduction": false,
  "readyForUnboundedRuntime": false,
  "runtimeQaAccepted": true,
  "blockedScopes": {
    "dockerRanInCloseout": false,
    "installsRanInCloseout": false,
    "realToolsRanInCloseout": false,
    "mediaProcessingRanInCloseout": false,
    "liveProductCallsRanInCloseout": false,
    "routeRuntimeRanInCloseout": false,
    "workerDispatchRanInCloseout": false,
    "supabaseGcsWritesRanInCloseout": false,
