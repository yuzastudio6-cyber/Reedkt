...
export const betaReadinessChecklist: BetaReadinessChecklistItem[] = [
  ...
  { id: 'readiness_validation_complete', label: 'Readiness validation complete', status: 'warning', requiredForExternalBeta: true, notes: ['Static readiness exists for bounded external beta scorecard review, but production readiness remains blocked.'] },
  ...
  { id: 'model_weights_not_approved', label: 'Model weights not approved yet', status: 'warning', requiredForExternalBeta: false, notes: ['Model weights remain needs_review or missing until human review; model-backed real-user media beta and production stay blocked.'] },
  { id: 'gcp_deployment_not_done', label: 'GCP deployment not done yet', status: 'warning', requiredForExternalBeta: false, notes: ['No deploy/gcloud action is part of the bounded external beta scorecard change.'] },
