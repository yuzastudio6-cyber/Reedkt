...
} from '../tool-registry/ai-graphics-beta-execution-handoff-readiness'
import type {
...
const readiness = buildAiGraphicsBetaExecutionHandoffReadiness({
  evidenceBundleInput,
...
if (
  hasFlag('--require-owner-approved-handoff-ready') &&
  !readiness.ownerApprovedEvidenceReadyForRouteWorkerHandoff
) {
  process.exitCode = 2
}
