...
assert.ok(ready.recommendedCommands.includes('npm run beta:readiness:external-beta-sequence-preflight'), 'ready report should require the all-up sequence preflight before the evidence collector')
