# WORKER_RUNTIME_JOBS SOUND CPU Phase158 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase158-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase158-blocked-execution-register",
  "blockedToday": {
