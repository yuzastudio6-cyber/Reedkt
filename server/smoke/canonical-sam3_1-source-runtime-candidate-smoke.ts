...
for (const gpuMemoryPolicy of [
  ...
  'fixed_a100_gpu_memory_profile=a100_gpu_only_full_semantic_streamed_grounding_postprocess_trimmed_memory_v3',
  'fixed_a100_gpu_memory_profile_uses_upstream_trim_past_non_cond_mem_for_eval=true',
  'fixed_a100_gpu_memory_profile_preserves_complete_prompt_semantic_object_set=true',
  'fixed_a100_gpu_memory_profile_detector_object_removal_allowed=false',
  'fixed_a100_gpu_memory_profile_streams_upstream_postprocess_one_frame_at_a_time=true',
  'fixed_a100_gpu_memory_profile_streams_upstream_grounding_one_frame_at_a_time=true',
  'fixed_a100_gpu_memory_profile_num_maskmem=7',
  'fixed_a100_gpu_memory_profile_cpu_state_or_output_offload_allowed=false',
  'fixed_a100_gpu_memory_profile_materializes_temporarily_absent_prompt_identity_as_empty_mask=true',
  'fixed_l4_gpu_memory_profile=l4_gpu_only_full_semantic_streamed_grounding_postprocess_trimmed_memory_v7',
  ...
  'fixed_l4_gpu_memory_profile_materializes_temporarily_absent_prompt_identity_as_empty_mask=true',
...
for (const requiredRunnerFragment of [
  ...
  'validate_propagated_object_identities(',
  'for object_id in object_ids:',
  'set(prompt_object_ids).issubset(distinct_object_ids)',
