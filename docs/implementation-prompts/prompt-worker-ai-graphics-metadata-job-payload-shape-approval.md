# Implementation Prompt: WORKER_AI_GRAPHICS_METADATA_JOB_PAYLOAD_SHAPE_APPROVAL

## Prompt Summary

Create a docs/static-diagnostics-only Worker Runtime approval packet from `origin/codex/rp-worker-ai-graphics-metadata-handoff-qa-review`, branch `codex/rp-worker-ai-graphics-metadata-job-payload-shape-approval`, and draft PR `[worker] AI graphics metadata job payload shape approval`.
...
- Worktree: `/private/tmp/reeditpro-worker-ai-graphics-metadata-job-payload-shape-approval`.
