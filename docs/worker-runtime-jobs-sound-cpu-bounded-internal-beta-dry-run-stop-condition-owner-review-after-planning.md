# WORKER_RUNTIME_JOBS SOUND CPU Bounded Internal Beta Dry Run Stop Condition Owner Review After Planning

```json worker-runtime-jobs-sound-cpu-bounded-internal-beta-dry-run-stop-condition-owner-review-after-planning
{
  "label": "worker-runtime-jobs-sound-cpu-bounded-internal-beta-dry-run-stop-condition-owner-review-after-planning",
  ...
  "ownerReviewOutcome": {
    "stopConditionsAcceptedForNextControlledPrompt": true,
...
The next controlled prompt must stop on any listed condition. This owner review does not reinterpret blockers as readiness.
