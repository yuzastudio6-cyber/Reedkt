# Chart Overlay Canonicalization Owner Approval
...
- `preferredPlanningToolsOwnerApproved`: `vega_lite`, `d3`
- `conditionalPlanningToolsOwnerApproved`: `echarts`
- `fallbackPlanningToolsOwnerApproved`: `vega`
- `eliminatedToolsOwnerApproved`: `three_js`, `sam2`, `real_esrgan`
- `missingProofRulesOwnerApproved`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApproved`: browser chart runtime not approved, model/GPU proof not approved for eliminated ML tools, 3D chart request required before three_js planning
- `nextProofMilestoneOwnerApproved`: future chart/browser runtime or CPU/static chart metadata proof before execution
