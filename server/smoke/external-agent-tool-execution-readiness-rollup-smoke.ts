...
assert.equal(rollup.recommendedNextPrompt, BROLL_10S_NO_GPU_IAP_SSH_CANARY_BOUNDED_RUNNER_EXECUTE_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_10S_NO_GPU_IAP_SSH_CANARY_BOUNDED_RUNNER_EXECUTE_PROMPT)
