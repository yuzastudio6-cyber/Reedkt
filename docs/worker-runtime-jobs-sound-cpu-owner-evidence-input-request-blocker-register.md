# WORKER_RUNTIME_JOBS SOUND CPU Owner Evidence Input Request Blocker Register

```json worker-runtime-jobs-sound-cpu-owner-evidence-input-request-blocker-register
{
  "owner": "WORKER_RUNTIME_JOBS",
  "decision": "worker_runtime_jobs_sound_cpu_owner_evidence_input_request_created_blocked_until_owner_responses",
  "resolvedForPlanning": [
    {
      "blockerId": "owner_evidence_input_request_missing",
      "resolution": "This packet creates exact evidence requests for the seven required owner areas."
    }
  ],
  "remainingBlockers": [
  ...
  "blockerState": {
    "ownerResponsesRequired": true,
    "ownerResponseBlockerCount": 13,
