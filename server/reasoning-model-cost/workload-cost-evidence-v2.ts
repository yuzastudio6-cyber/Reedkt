...
export function createReasoningModelAttemptCostEvidenceV2(
  input: ReasoningModelAttemptCostEvidenceV2Input,
): ReasoningModelCostResult<ReasoningModelAttemptCostEvidenceV2> {
  const authority = validatePrePlanEditReferenceStudyChatReasoningAuthority(input.workloadAuthority)
...
export function aggregateReasoningModelAttemptCostsV2(
  attempts: readonly ReasoningModelAttemptCostEvidenceV2[],
): ReasoningModelCostResult<ReasoningModelAttemptCostAggregateV2> {
  ...
  const authority = validatePrePlanEditReferenceStudyChatReasoningAuthority(first.workloadAuthority)
  if (!authority.ok) return authority
