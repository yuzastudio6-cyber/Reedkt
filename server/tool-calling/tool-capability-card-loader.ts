...
export const OPERATION_TOOL_SEEDS: Record<ToolCallingOperationId, readonly ProductionToolId[]> = {
  ...
  'video.safe_zone.detect': ['opencv', 'sharp'],
  'audio.transcribe': [],
  'audio.word_align': [],
  'audio.loudness.normalize': ['ffmpeg', 'rnnoise', 'signalsmith_stretch'],
  'audio.cleanup': ['deepfilternet', 'rnnoise', 'ffmpeg'],
  'caption.generate': ['remotion', 'libass'],
  'caption.align': ['libass', 'remotion'],
  'caption.style': ['remotion', 'libass', 'sharp'],
  'caption.burn_in': ['libass', 'remotion', 'ffmpeg'],
  'timeline.smart_cut': ['pyscenedetect', 'opentimelineio', 'opencv'],
  'timeline.validate': ['opentimelineio', 'remotion', 'ffprobe'],
  'timeline.to_otio': ['opentimelineio', 'remotion'],
  'render.preview': ['remotion', 'ffmpeg', 'pixijs', 'three_js', 'lottie', 'animejs', 'satori', 'svg_js'],
  ...
  'mask.generate': ['rembg', 'opencv', 'kornia'],
  'mask.refine': ['kornia', 'opencv'],
  'background.remove': ['rembg', 'opencv', 'kornia'],
  'video.enhance': ['sharp', 'ffmpeg', 'vapoursynth'],
  'video.slow_motion': ['ffmpeg', 'vapoursynth'],
