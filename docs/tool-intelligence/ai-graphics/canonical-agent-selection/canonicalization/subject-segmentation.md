# Subject Segmentation Canonicalization Review
...
- `conditionalPlanningToolsCanonicalized`: `kornia`
- `fallbackPlanningToolsCanonicalized`: `rembg`
- `eliminatedToolsCanonicalized`: `echarts`, `vega`
...
- `nextProofMilestoneCanonicalized`: segmentation model-boundary proof lane
