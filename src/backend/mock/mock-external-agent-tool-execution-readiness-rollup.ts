...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_lifecycle_us_central1_a_stockout_cleanup_verified_ready_for_us_central1_c_retry',
      ...
      primaryBlocker: 'bounded_no_idle_l4_lifecycle_retry_us_central1_c_prompt_required_before_vm_or_inference',
      evidence: [
      ...
      nextAction: AI_VIDEO_BROLL_GEN_9N_NO_IDLE_L4_PROOF_EXECUTE_US_CENTRAL1_C_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
        ...
        cacheReadinessCommand: 'npm run ai-video-broll-wan-fast-cache-readiness:check',
        quotaVerificationCommand: 'npm run ai-video-broll-wan-gpu-global-quota:verify',
        nextActionAfterQuotaClears: AI_VIDEO_BROLL_GEN_9N_NO_IDLE_L4_PROOF_EXECUTE_US_CENTRAL1_C_PROMPT,
      },
    },
    {
  ...
  recommendedNextPrompt: AI_VIDEO_BROLL_GEN_9N_NO_IDLE_L4_PROOF_EXECUTE_US_CENTRAL1_C_PROMPT,
} as const
