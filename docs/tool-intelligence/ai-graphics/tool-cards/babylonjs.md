# Babylon.js Tool Capability Card
...
- `bestFor`: heavier 3D scene/game-style planning
- `notFor`: simple 3D where Three.js is enough; current WebGL runtime
- `inputTypes`: `babylon_scene_manifest_plan`
