...
assert.equal(brollGateRow?.noIdleLifecycleGate?.targetZone, 'us-west1-c')
...
assert.equal(
  ...
  'npm run smoke:ai-video-broll-gen-9u-no-idle-l4-iap-wheelhouse-transfer-proof-us-west1-c-result',
)
