...
const DECISION = "qwen2_5_vl_7b_l4_reservation_create_us_east1_c_blocked_by_gpu_availability_no_vm_no_inference";
const NEXT_PROMPT =
...
const REQUIRED_RESULT_PHRASES = [
  ...
  "suggested `us-east1-b` as an available alternate",
...
check(
  packageJson.scripts?.["qwen2-5-vl-7b-l4-reservation-create-us-east1-c:diagnostics"] ===
    "node scripts/validation/qwen2-5-vl-7b-l4-reservation-create-us-east1-c-diagnostics.mjs",
  "package.json must expose qwen2-5-vl-7b-l4-reservation-create-us-east1-c:diagnostics"
);

const result = read("docs/qwen2-5-vl-7b-l4-reservation-create-us-east1-c-result.md");
const prompt = read("docs/implementation-prompts/prompt-qwen2-5-vl-7b-l4-reservation-create-us-east1-b-retry.md");
const changeLog = parseBlock(
  "docs/qwen2-5-vl-7b-l4-reservation-create-us-east1-c-change-log.md",
  "qwen2-5-vl-7b-l4-reservation-create-us-east1-c-change-log"
);

includesAll(result, REQUIRED_RESULT_PHRASES, "reservation create us-east1-c result");
includesAll(prompt, [
  NEXT_PROMPT,
  "Zone: `us-east1-b`",
  "latest `us-east1-c` reservation-create response suggested `us-east1-b`",
  "Do not create or delete a VM.",
  "Do not run inference.",
  "Do not claim `generated_local_fixture_passed`."
], "reservation create us-east1-b retry prompt");
...
check(changeLog.preflight?.targetZone === "us-east1-c", "Target zone mismatch");
...
check(
  changeLog.reservationCreateAttempt?.zonesAvailableSuggestedByGcp?.includes("us-east1-b"),
  "GCP-suggested fallback zone must include us-east1-b"
);
...
check(changeLog.fallbackTarget?.selectedZone === "us-east1-b", "Fallback zone must be us-east1-b");
check(changeLog.fallbackTarget?.selectionReason === "latest_gcp_capacity_suggestion", "Fallback reason mismatch");
...
console.log(JSON.stringify({
  ...
  gcpSuggestedFallbackZone: "us-east1-b",
