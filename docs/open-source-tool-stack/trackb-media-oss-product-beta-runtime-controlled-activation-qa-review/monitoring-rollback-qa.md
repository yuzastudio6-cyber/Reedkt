...
```json
{
  ...
  "monitoringQa": {
    "sanitizedMonitoringShapeAccepted": true,
    "rawPayloadLoggingAllowed": false,
    "privatePayloadLoggingAllowed": false,
    "signedUrlIncluded": false,
    "secretMaterialIncluded": false,
    "liveTelemetryEnabled": false,
    "externalBetaTelemetryEnabled": false
  },
  "rollbackQa": {
    "rollbackDisableControlAccepted": true,
    "rollbackExecutedAgainstLiveRuntime": false,
    "liveRuntimeMutation": false,
    "rollbackScope": "metadata_only_disable_control_record"
  }
}
```
