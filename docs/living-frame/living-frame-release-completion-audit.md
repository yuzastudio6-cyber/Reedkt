...
11. Advanced rigging runtime qualification. The Head Intelligence Rigging
    ...
    timing, and memory/performance path. Private canonical use still requires a
    pinned/scanned offline non-root worker image, zero-network evidence,
    private persistence/reread, broader rig QA, resource/cost evidence,
    canonical work admission, and fallback/private-review evidence. OpenToonz
