...
```json qwen2-5-vl-7b-cloud-run-gpu-approved-snapshot-runtime-contract-change-log
{
  ...
  "nextPrompt": "QWEN2_5_VL_STACK_TOOL_31-CLOUD-RUN-GPU-APPROVED-SNAPSHOT-CONTRACT-SMOKE: run local contract handler smoke for valid/invalid request fixtures, no inference"
}
```
