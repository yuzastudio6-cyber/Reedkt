...
assert.equal(spec.readyForBroll10yRunnerRawJsonCleanupFixPrompt, false)
assert.equal(spec.readyForBroll10zNoIdleL4PayloadInstallRetryAfterRunnerFixPrompt, true)
...
assert.equal(summary.readyForBroll10yRunnerRawJsonCleanupFixPrompt, false)
assert.equal(summary.readyForBroll10zNoIdleL4PayloadInstallRetryAfterRunnerFixPrompt, true)
