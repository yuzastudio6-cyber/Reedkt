...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  decision:
    'external_agent_tool_execution_readiness_qwen_ready_for_explicit_gate_broll_9w_us_east4_a_stockout_strategy_required',
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_iap_wheelhouse_transfer_us_east4_a_stocked_out_before_vm_created',
      ...
      primaryBlocker:
        'bounded_no_idle_l4_iap_wheelhouse_transfer_us_east4_a_stocked_out_before_vm_created_capacity_strategy_required',
      evidence: [
      ...
      nextAction: AI_VIDEO_BROLL_GEN_9X_IAP_WHEELHOUSE_TRANSFER_STOCKOUT_FIX_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
  ...
  recommendedNextPrompt: AI_VIDEO_BROLL_GEN_9X_IAP_WHEELHOUSE_TRANSFER_STOCKOUT_FIX_PROMPT,
} as const
