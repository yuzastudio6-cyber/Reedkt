...
| Qwen VLM / provider-neutral VLM | structured final-frame observations | future/provider-gated concepts only | provider/model policy, schema validation, confidence/calibration, no executable output |
