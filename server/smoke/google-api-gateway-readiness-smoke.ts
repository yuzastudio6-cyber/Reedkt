          ...
          spec: {
            ...
            containers: [{
              env: [
                ...
                { name: 'REEDITPRO_LARGE_MEDIA_FINALIZATION_MODE', value: 'disabled' },
                { name: 'WORKER_RUNTIME_MODE', value: 'disabled' },
                { name: 'GOOGLE_CLOUD_PROJECT_ID', value: 'reeditpro' },
                { name: 'GOOGLE_CLOUD_REGION', value: 'us-east1' },
                { name: 'GCS_DEFAULT_REGION', value: 'us-east1' },
                { name: 'GCS_SOURCE_MEDIA_BUCKET', value: 'reeditpro-staging-reeditpro-us-east1-source-media' },
                { name: 'GCS_GENERATED_ASSETS_BUCKET', value: 'reeditpro-staging-reeditpro-us-east1-generated-assets' },
                { name: 'GCS_PROCESSED_MEDIA_BUCKET', value: 'reeditpro-staging-reeditpro-us-east1-processed-media' },
                { name: 'GCS_PREVIEWS_BUCKET', value: 'reeditpro-staging-reeditpro-us-east1-previews' },
                { name: 'GCS_EXPORTS_BUCKET', value: 'reeditpro-staging-reeditpro-us-east1-exports' },
                { name: 'GCS_THUMBNAILS_BUCKET', value: 'reeditpro-staging-reeditpro-us-east1-thumbnails' },
                { name: 'GCS_QA_ARTIFACTS_BUCKET', value: 'reeditpro-staging-reeditpro-us-east1-qa-artifacts' },
                { name: 'GCS_WORKER_TEMP_BUCKET', value: 'reeditpro-staging-reeditpro-us-east1-worker-temp' },
