...
const DECISION = "qwen2_5_vl_7b_l4_cuda_vllm_import_proof_us_east1_b_blocked_by_g2_l4_zonal_stockout";
const NEXT_PROMPT =
...
const REQUIRED_RESULT_PHRASES = [
  DECISION,
  "`us-central1-b`, `us-central1-a`, `us-central1-c`, `us-west1-a`, and `us-east1-b`",
...
check(
  packageJson.scripts?.["qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-east1-b:diagnostics"] ===
    "node scripts/validation/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-east1-b-diagnostics.mjs",
  "package.json must expose qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-east1-b:diagnostics"
);

const result = read("docs/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-east1-b-result.md");
const prompt = read("docs/implementation-prompts/prompt-qwen2-5-vl-7b-l4-capacity-assurance-plan.md");
const changeLog = parseBlock(
  "docs/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-east1-b-change-log.md",
  "qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-east1-b-change-log"
);

includesAll(result, REQUIRED_RESULT_PHRASES, "us-east1-b result");
includesAll(prompt, [
  NEXT_PROMPT,
