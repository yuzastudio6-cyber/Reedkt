...
const smokes = [
  ...
  'server/smoke/canonical-a100-vertex-professional-gpu-launch-adapter-smoke.ts',
  'server/smoke/canonical-a100-vertex-custom-job-terminal-port-smoke.ts',
  'server/smoke/canonical-a100-vertex-professional-gpu-terminal-adapter-smoke.ts',
  ...
  'server/smoke/canonical-source-transcript-vertex-a100-cutover-smoke.ts',
  ...
  'server/smoke/canonical-sam3_1-production-capsule-dual-build-launcher-smoke.ts',
  ...
  'server/smoke/canonical-sam3_1-vertex-scale-zero-deployment-admission-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-scale-zero-deployment-request-compiler-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-scale-zero-control-plane-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-scale-zero-control-plane-repository-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-serving-window-cost-authority-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-replica-telemetry-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-serving-billing-export-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-serving-reconciled-window-cost-smoke.ts',
  ...
  'server/smoke/canonical-sam3_1-vertex-model-version-rollout-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-serving-qualification-candidate-smoke.ts',
  'server/smoke/canonical-sam3_1-vertex-serving-qualification-preparation-smoke.ts',
  ...
  'server/smoke/canonical-sam3_1-private-internal-dispatch-readiness-owner-smoke.ts',
  ...
  'server/smoke/canonical-sam3_1-a100-result-finalization-smoke.ts',
  'server/smoke/canonical-sam3_1-l4-result-finalization-smoke.ts',
  ...
  'server/smoke/canonical-sam3_1-gpu-runtime-qualification-operator-entrypoints-smoke.ts',
  'server/smoke/canonical-sam3_1-gpu-runtime-release-readiness-observer-smoke.ts',
  'server/smoke/canonical-sam3_1-gpu-runtime-release-publication-coordinator-smoke.ts',
  'server/smoke/canonical-sam3_1-current-a100-customer-dispatch-readiness-owner-smoke.ts',
  'server/smoke/canonical-sam3_1-complete-source-capacity-owner-smoke.ts',
