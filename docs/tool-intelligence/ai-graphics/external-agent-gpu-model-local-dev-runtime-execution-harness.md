...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `torch_torchvision` | `model_runtime_foundation` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `none` | `pythonPackageRuntime` | `gpu_model_python_package_missing` | `outputDirectory, nativeCudaRuntime` | `none` | false | false | false |
| `transformers` | `model_runtime_foundation` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `none` | `pythonPackageRuntime` | `gpu_model_python_package_missing` | `outputDirectory, nativeCudaRuntime` | `none` | false | false | false |
| `sam2` | `subject_segmentation` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `native_linux_amd64_nvidia_l4_sam2_runtime` | `sam2CheckpointLocalPath` | `sam2_checkpoint_missing` | `outputDirectory, sourceImageLocalPath, modelWeightManifestEvidence, nativeCudaRuntime` | `none` | false | false | false |
| `birefnet` | `background_removal` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `native_linux_amd64_nvidia_l4_birefnet_runtime` | `birefnetModelLocalPath` | `birefnet_model_missing` | `outputDirectory, sourceImageLocalPath, modelWeightManifestEvidence, nativeCudaRuntime` | `none` | false | false | false |
| `real_esrgan` | `upscaling` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `none` | `realEsrganModelLocalPath` | `real_esrgan_model_missing` | `outputDirectory, sourceImageLocalPath, modelWeightManifestEvidence, nativeCudaRuntime` | `none` | false | false | false |
| `kornia` | `tensor_image_ops` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `none` | `sourceImageLocalPath` | `kornia_source_frame_missing` | `outputDirectory, nativeCudaRuntime` | `none` | false | false | false |
| `rembg` | `background_removal` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `none` | `rembgModelLocalPath` | `rembg_model_missing` | `outputDirectory, sourceImageLocalPath, modelWeightManifestEvidence, nativeCudaRuntime` | `none` | false | false | false |
| `transparent_background` | `background_removal` | `local_dev_prerequisite_check_only` | `controlled_gpu_model_adapter_invoked_runtime_skipped` | `none` | `transparentBackgroundCheckpointLocalPath` | `transparent_background_checkpoint_missing` | `outputDirectory, sourceImageLocalPath, modelWeightManifestEvidence, nativeCudaRuntime` | `none` | false | false | false |
