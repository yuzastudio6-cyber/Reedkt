  ...
  tools: [
    {
      ...
      currentStage:
        'controlled_persisted_worker_dispatch_runtime_real_dispatch_approved_fixture_private_inference_retry_gate',
      ...
      primaryBlocker: 'bounded_private_inference_retry_attempt_approval_required_after_gate',
      evidence: [
