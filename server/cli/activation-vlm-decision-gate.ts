import {
  ...
  buildVlmDecisionGateSummary,
  writeVlmDecisionGateArtifacts,
} from '../activation/vlm-decision-gate'

const writeArtifacts = process.argv.includes('--write-artifacts') || process.argv.includes('--execute')
...
if (writeArtifacts) {
  ...
  console.log(JSON.stringify(buildVlmDecisionGateSummary(), null, 2))
}
