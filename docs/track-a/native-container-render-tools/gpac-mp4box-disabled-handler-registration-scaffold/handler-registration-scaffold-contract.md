# Handler Registration Scaffold Contract

The disabled handler-registration scaffold is a TypeScript metadata contract only.

Contract id: `handlerRegistrationScaffold.gpacMp4box.disabled`.

Route id: `render.gpacMp4box.disabledHandlerRegistrationScaffold`.

Mode: `disabled_handler_registration_scaffold_only`.

Status: `disabled_handler_registration_scaffold_registered_no_executable_handler`.

Required references:
- `TRACKA-GPAC-MP4BOX-GUARDED-HANDLER-REGISTRATION-PLAN-1`
