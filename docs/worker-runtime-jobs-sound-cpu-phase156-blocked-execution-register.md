# WORKER_RUNTIME_JOBS SOUND CPU Phase156 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase156-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase156-blocked-execution-register",
  "blockedToday": {
