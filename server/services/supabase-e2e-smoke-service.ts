...
const KNOWN_COLUMN_HINTS: Record<string, string[]> = {
  ...
  approved_plan_snapshots: ['id', 'workspace_id', 'project_id', 'chat_session_id', 'edit_plan_id', 'edit_session_id', 'edit_plan_version_id', 'credit_estimate_id', 'credit_approval_id', 'credit_reservation_id', 'approved_by_user_id', 'approved_by', 'approved_at', 'snapshot_version', 'snapshot_status', 'status', 'snapshot_json', 'plan_hash', 'credit_hash', 'source_sequence_hash', 'timing_hash', 'immutable'],
