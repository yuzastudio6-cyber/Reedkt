# WORKER_RUNTIME_JOBS SOUND CPU Phase170 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase170-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase170-blocked-execution-register",
  "blockedToday": {
