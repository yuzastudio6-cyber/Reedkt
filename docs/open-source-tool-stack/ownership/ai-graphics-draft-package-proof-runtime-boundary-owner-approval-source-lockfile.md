# AI Graphics Runtime Boundary Owner Approval Source Lockfile
...
Track B owner rule: `TRACK_B_MEDIA_OSS_STEWARD`; Atlas may reference Track B evidence but cannot claim Track B tools. Track A render/export exclusion remains preserved by PR #544.
