# Tensor Image Ops Canonicalization Review
...
- `preferredPlanningToolsCanonicalized`: `kornia`
- `conditionalPlanningToolsCanonicalized`: `torch_torchvision`
- `fallbackPlanningToolsCanonicalized`: `transformers`
- `eliminatedToolsCanonicalized`: `echarts`, `viz_js`
- `missingProofRulesCanonicalized`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsCanonicalized`: CPU import proof not approved for execution; tensor/image ops execution not approved
- `nextProofMilestoneCanonicalized`: CPU import and tensor-operation boundary proof lane
