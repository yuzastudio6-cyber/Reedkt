...
Next safe action: collect the non-secret owner approval notes named by `docs/beta-readiness/owner-approval-packet-current-gates/2026-06-28-owner-approval-packet-current-gates.md`, then rerun `npm run beta:readiness:deployed-evidence-input-manifest`.
