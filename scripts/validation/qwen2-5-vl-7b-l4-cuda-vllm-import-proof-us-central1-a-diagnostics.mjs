...
const DECISION = "qwen2_5_vl_7b_l4_cuda_vllm_import_proof_us_central1_a_blocked_by_g2_l4_zonal_stockout";
const NEXT_PROMPT =
...
const REQUIRED_FILES = [
  ...
  "docs/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-a-change-log.md",
  "docs/implementation-prompts/prompt-qwen2-5-vl-7b-l4-cuda-vllm-import-proof-retry-us-central1-c.md",
  "docs/qwen2-5-vl-7b-l4-stockout-plan-result.md",
  "docs/qwen2-5-vl-7b-gpus-all-regions-quota-fix-result.md",
  "scripts/validation/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-a-diagnostics.mjs",
  "package.json"
];
...
check(
  packageJson.scripts?.["qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-a:diagnostics"] ===
    "node scripts/validation/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-a-diagnostics.mjs",
  "package.json must expose qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-a:diagnostics"
);

const result = read("docs/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-a-result.md");
const prompt = read("docs/implementation-prompts/prompt-qwen2-5-vl-7b-l4-cuda-vllm-import-proof-retry-us-central1-c.md");
const changeLog = parseBlock(
  "docs/qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-a-change-log.md",
  "qwen2-5-vl-7b-l4-cuda-vllm-import-proof-us-central1-a-change-log"
);

includesAll(result, REQUIRED_RESULT_PHRASES, "us-central1-a result");
includesAll(prompt, [
  NEXT_PROMPT,
  "Selected retry zone: `us-central1-c`",
  "Create one no-public-IP `g2-standard-8` VM in `us-central1-c`",
  "Do not run inference.",
  "Do not claim `generated_local_fixture_passed`."
], "us-central1-c retry prompt");
...
check(changeLog.preflight?.targetZone === "us-central1-a", "Target zone mismatch");
