...
Decision: `qwen2_5_vl_cloud_run_gpu_private_invoke_readiness_rollup_controlled_persisted_dispatch_runtime_real_dispatch_approved_fixture_private_invoke_attempt_result_review_required`.
...
| Controlled persisted worker dispatch runtime real-dispatch approved-fixture private invoke attempt result review | blocked controlled persisted worker dispatch runtime real-dispatch approved fixture private invoke attempt result review required | The 58DK result has not yet been reviewed for acceptance. | Review the fail-closed attempt result, including local CLI output redaction warning, before any later fixture inference planning. |
