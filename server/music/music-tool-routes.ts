...
function route(input: {
  ...
  return publishMusicToolRouteManifest({
    ...
    unknownOutcomeResubmissionAllowed: false,
    freshApprovalRequiredForCostIncrease: true,
    planningQa: ['music.qa.planning.authority.v2', 'music.qa.planning.rights.v2', 'music.qa.planning.route.v2'],
    outputQa: ['music.qa.output.technical.v2', 'music.qa.output.subjective_needs_review.v2'],
    integrationQa: ['music.qa.integration.authority.v2', 'music.qa.integration.sound_boundary.v2'],
...
function planningRoute(job: string, routeKey: string): Readonly<MusicToolRouteManifest> {
  ...
  return route({
    ...
    steps: [step({
      stepKey: 'plan', stepJobType: job, toolKey: 'music_supervision_engine', toolVersion: '2.0.0',
      operationKey: job, operationProfileKey: `music.profile.${job}.v2`, required: true,
      dependencyStepKeys: [], inputBindings: ['music_assignment_v2'], outputBindings: [output], failureBehavior: 'fail_route',
    })],
  })
}
...
const routes: Readonly<MusicToolRouteManifest>[] = [
  planningRoute('study_video_music_context', 'music.route.study.video_context.v2'),
  sourceStudyRoute({ key: 'music.route.study.existing_asset.v2', job: 'study_existing_music', assetOperation: 'preserve_source_music', output: 'music_existing_study_v2' }),
  ...
  planningRoute('decide_music_silence', 'music.route.decide.silence.v2'),
  planningRoute('plan_music_narrative_arc', 'music.route.plan.narrative_arc.v2'),
  planningRoute('plan_music_motif', 'music.route.plan.motif.v2'),
  ...
  route({
    ...
    steps: [
      step({
        stepKey: 'plan', stepJobType: 'create_music_cue_sheet',
        toolKey: 'music_supervision_engine', toolVersion: '2.0.0',
        operationKey: 'create_music_cue_sheet', operationProfileKey: 'music.profile.create_music_cue_sheet.v2',
        required: true, dependencyStepKeys: [], inputBindings: ['music_assignment_v2'],
        outputBindings: ['music_cue_sheet_v2'], failureBehavior: 'fail_route',
      }),
      step({
  ...
  sourceStudyRoute({ key: 'music.route.acquire.project_library.v2', job: 'search_project_music', assetOperation: 'match_project_music', output: 'approved_music_selection_v2' }),
  sourceStudyRoute({ key: 'music.route.acquire.workspace_library.v2', job: 'search_workspace_music', assetOperation: 'match_workspace_music', output: 'approved_music_selection_v2' }),
  ...
  route({
    key: 'music.route.select.candidate.v2', jobs: ['select_music_candidate'], role: 'primary', requiredInputs: ['music_candidate_analysis_v2'],
    outputs: ['music_candidate_selection_decision_v2'], steps: [step({
      stepKey: 'select', stepJobType: 'select_music_candidate', toolKey: 'music_private_audio_analysis', toolVersion: '2.0.0',
      operationKey: 'select_qualified_candidate', operationProfileKey: 'music.profile.candidate_selection.v2', required: true,
      dependencyStepKeys: [], inputBindings: ['music_candidate_analysis_v2'], outputBindings: ['music_candidate_selection_decision_v2'], failureBehavior: 'fail_route',
    })],
  }),
  route({
  ...
  route({
    key: 'music.route.qa.continuity.v2', jobs: ['qa_music'], role: 'qa',
    requiredInputs: ['music_candidate_analysis_v2', 'music_placement_manifest_v2', 'music_sound_support_receipt_v2'],
    outputs: ['music_qa_report_v2', 'music_continuity_report_v2'], steps: [step({
      stepKey: 'continuity_qa', stepJobType: 'qa_music', toolKey: 'music_qa_engine', toolVersion: '2.0.0',
      operationKey: 'run_music_continuity_qa', operationProfileKey: 'music.profile.continuity_qa.v2', required: true,
      dependencyStepKeys: [],
      inputBindings: ['music_candidate_analysis_v2', 'music_placement_manifest_v2', 'music_sound_support_receipt_v2'],
      outputBindings: ['music_qa_report_v2', 'music_continuity_report_v2'], failureBehavior: 'fail_route',
    })],
  }),
  planningRoute('revise_music', 'music.route.revise.localized.v2'),
  planningRoute('promote_music_library_candidate', 'music.route.promote.library_candidate.v2'),
  route({
    key: 'music.route.handoff.final_composition.v2', jobs: ['handoff_music_to_final_composition'], role: 'primary',
    requiredInputs: ['music_placement_manifest_v2', 'music_qa_report_v2'], outputs: ['music_final_composition_handoff_v2'], steps: [step({
      stepKey: 'handoff', stepJobType: 'handoff_music_to_final_composition', toolKey: 'music_handoff_service', toolVersion: '2.0.0',
      operationKey: 'create_final_music_handoff', operationProfileKey: 'music.profile.final_handoff.v2', required: true,
      dependencyStepKeys: [], inputBindings: ['music_placement_manifest_v2', 'music_qa_report_v2'],
      outputBindings: ['music_final_composition_handoff_v2'], failureBehavior: 'fail_route',
    })],
  }),
  route({
    key: 'music.route.no_music.v2', jobs: [
    ...
    ], role: 'no_music', requiredInputs: ['music_assignment_v2'], outputs: ['intentional_no_music_handoff_v2'], steps: [step({
      stepKey: 'no_music', stepJobType: 'decide_music_need', toolKey: 'music_handoff_service', toolVersion: '2.0.0',
      operationKey: 'create_no_music_handoff', operationProfileKey: 'music.profile.no_music.v2', required: true,
      dependencyStepKeys: [], inputBindings: ['music_assignment_v2'], outputBindings: ['intentional_no_music_handoff_v2'], failureBehavior: 'fail_route',
    })],
  }),
  route({
    key: 'music.route.ambience_only_handoff.v2', jobs: ['decide_music_need', 'decide_music_silence', 'plan_scene_music', 'plan_boundary_music', 'full_video_music_pass'],
    role: 'lower_cost', requiredInputs: ['music_assignment_v2'], outputs: ['music_ambience_only_handoff_v2'], steps: [step({
      stepKey: 'ambience_handoff', stepJobType: 'decide_music_need', toolKey: 'music_handoff_service', toolVersion: '2.0.0',
      operationKey: 'create_ambience_only_handoff', operationProfileKey: 'music.profile.ambience_only.v2', required: true,
      dependencyStepKeys: [], inputBindings: ['music_assignment_v2'], outputBindings: ['music_ambience_only_handoff_v2'], failureBehavior: 'fail_route',
