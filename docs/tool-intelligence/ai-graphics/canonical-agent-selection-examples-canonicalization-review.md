# Canonical Agent Selection Examples Canonicalization Review

Decision: `ai_graphics_canonical_agent_selection_canonicalization_review_passed_with_warnings`

Examples preserve preferred, conditional, fallback, and eliminated tool behavior for every capability.
