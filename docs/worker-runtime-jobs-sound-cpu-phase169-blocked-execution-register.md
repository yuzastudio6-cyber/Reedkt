# WORKER_RUNTIME_JOBS SOUND CPU Phase169 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase169-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase169-blocked-execution-register",
  "blockedToday": {
