...
const smokeCommands = [
  ...
  ['npm', ['run', 'smoke:internal-testing-tool-routing-readiness']],
  ['npm', ['run', 'smoke:internal-testing-approved-snapshot-route-review']],
  ['npm', ['run', 'smoke:internal-testing-worker-payload-dry-run']],
  ['npm', ['run', 'smoke:internal-testing-mock-worker-queue-review']],
