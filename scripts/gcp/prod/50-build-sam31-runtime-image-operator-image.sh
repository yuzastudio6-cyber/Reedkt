...
# Builds the source-bound, metadata-only SAM 3.1 production-image operator.
# It does not build the model image, read a checkpoint, or start a GPU job.
...
[[ "${WEEDITPRO_CONFIRM_SAM31_RUNTIME_IMAGE_OPERATOR_BUILD:-}" \
...
printf '{"operation":"weeditpro_sam31_runtime_image_operator_build_v1",'
