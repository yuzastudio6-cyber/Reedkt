...
- `npm run smoke:tracka-gpac-mp4box-private-artifact-manifest-mock-implementation`: passed
- `npm run --silent tracka:gpac-mp4box-private-artifact-policy-mock-implementation:diagnostics`: passed
- `npm run --silent tracka:gpac-mp4box-private-artifact-manifest-mock-implementation:diagnostics`: passed
