# WORKER_RUNTIME_JOBS SOUND CPU Phase167 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase167-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase167-blocked-execution-register",
  "blockedToday": {
    "registrySourceCreated": false,
