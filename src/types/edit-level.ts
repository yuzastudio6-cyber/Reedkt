...
export interface EditLevelProductionReadinessEvidence {
  profileContractApproved?: boolean
  repositoryPersistenceApproved?: boolean
  apiRouteApproved?: boolean
  clientRuntimeWiringApproved?: boolean
  plannerWiringApproved?: boolean
  providerRoutingApproved?: boolean
  mediaWorkerApproved?: boolean
  renderExportApproved?: boolean
  creditReservationApproved?: boolean
  supabasePersistenceApproved?: boolean
  deploymentApproved?: boolean
  qaApproved?: boolean
}

export type EditLevelProductionReadinessEvidenceSnapshot = Required<EditLevelProductionReadinessEvidence>

export interface EditLevelProductionReadiness {
  productionReady: boolean
  blockers: string[]
  warnings: string[]
  evidence: EditLevelProductionReadinessEvidenceSnapshot
}
