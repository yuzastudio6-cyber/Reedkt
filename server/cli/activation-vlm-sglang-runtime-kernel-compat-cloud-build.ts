...
if (!execute) {
  console.log([
    'Phase 39C-SG-KERNEL Cloud Build profile CLI',
    'No execution performed.',
    'Cloud Build profile execution is confirmation-gated and runs through the kernel compatibility runner.',
  ...
  if (json) console.log(JSON.stringify(result.buildAttempts, null, 2))
    ...
    console.log([
      'Phase 39C-SG-KERNEL Cloud Build profile matrix completed through the guarded compatibility runner.',
      `Run: ${result.runId}`,
