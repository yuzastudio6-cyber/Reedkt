...
assert.equal(summary.canonicalJobAdapterVerifiedCount, 33)
...
assert.deepEqual(summary.canonicalJobAdapterVerifiedToolIds, [
  ...
  'three_js', 'pixijs', 'konva', 'babylon_js', 'rembg', 'kornia', 'librosa', 'audioflux',
  'music21', 'pretty_midi', 'noisereduce', 'rnnoise', 'playwright', 'pyscenedetect',
  'opencolorio', 'openimageio', 'mkvtoolnix_container_validation',
  'gpac_mp4box_packaging_validation', 'ffprobe', 'opentimelineio', 'remotion', 'polars',
  'opencv', 'signalsmith_stretch', 'vapoursynth',
])
