...
for (const field of ['manifestVersion', 'toolId', 'owner', 'status', 'internalTestingReady', 'productionReady', 'readinessEvidence', 'lastValidatedPhase']) {
...
for (const gateId of ['agent_roles_defined', 'tool_ownership_defined', 'capability_manifest_schema', 'agent_finding_schema', 'edit_intent_schema', 'approved_plan_snapshot_schema', 'routing_policy', 'source_of_truth_policy', 'cross_track_handoff_template', 'blocked_features']) {
