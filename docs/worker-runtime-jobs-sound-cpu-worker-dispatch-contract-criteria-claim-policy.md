# WORKER_RUNTIME_JOBS SOUND CPU Worker Dispatch Contract Criteria Claim Policy

```json worker-runtime-jobs-sound-cpu-worker-dispatch-contract-criteria-claim-policy
{
