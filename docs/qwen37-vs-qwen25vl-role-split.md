# Qwen 3.7 Max Vs Qwen2.5-VL Role Split
...
Qwen 3.7 Max -> reasoning / plan / Marker Chat final decision.

Qwen2.5-VL -> visual/video context extraction.

This split keeps ReEditPro's existing reasoning architecture intact while adding a specialized visual/video understanding tool for source video context. Qwen2.5-VL visual observations should become compact context for Qwen 3.7 Max, not a direct execution path.

## Qwen 3.7 Max

Use Qwen 3.7 Max for:
...
Do not use Qwen 3.7 Max for raw video processing, frame extraction, transcription, sound analysis, rendering, worker execution, or credit actions.
