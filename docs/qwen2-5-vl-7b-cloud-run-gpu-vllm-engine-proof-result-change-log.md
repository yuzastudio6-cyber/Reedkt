...
```json qwen2-5-vl-7b-cloud-run-gpu-vllm-engine-proof-result-change-log
{
  ...
  "nextPrompt": "QWEN2_5_VL_STACK_TOOL_30-CLOUD-RUN-GPU-VLLM-APPROVED-SNAPSHOT-RUNTIME-CONTRACT: define the approved-snapshot request contract for the fail-closed Cloud Run service, no inference"
}
```
