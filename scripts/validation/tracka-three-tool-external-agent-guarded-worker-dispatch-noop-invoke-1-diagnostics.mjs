...
const supportChangedFiles = [
  'docs/activation-phase-tracka-three-tool-external-agent-persistent-job-queue-dry-run-1-results.md',
  'docs/external-beta/tracka-three-tool-external-agent-persistent-job-queue-dry-run-1/source-audit.md',
  'docs/external-beta/tracka-three-tool-external-agent-persistent-job-queue-dry-run-1/queue-dry-run-result.md',
  'docs/external-beta/tracka-three-tool-external-agent-persistent-job-queue-dry-run-1/queue-contract.md',
  'docs/external-beta/tracka-three-tool-external-agent-persistent-job-queue-dry-run-1/safety-boundary.md',
  'docs/external-beta/tracka-three-tool-external-agent-persistent-job-queue-dry-run-1/validation-results.md',
  ...
  'docs/implementation-prompts/prompt-tracka-three-tool-external-agent-worker-lease-dry-run-1.md',
...
const blockedChangedPatterns = [
  /^package-lock\.json$/,
  /^src\//,
  /^server\/(?!services\/tracka-three-tool-external-agent-guarded-worker-dispatch-noop-invoke-1\.ts$|cli\/tracka-three-tool-external-agent-guarded-worker-dispatch-noop-invoke-1\.ts$|services\/tracka-three-tool-external-agent-persistent-job-queue-dry-run-1\.ts$|cli\/tracka-three-tool-external-agent-persistent-job-queue-dry-run-1\.ts$)/,
  /^docker\//,
  /^\.dockerignore$/,
  /^supabase\//,
  /^database\//,
