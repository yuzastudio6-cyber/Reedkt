# Animation Overlay Canonicalization Owner Review
...
- `preferredPlanningToolsOwnerAccepted`: `lottie_web`, `animejs`
- `conditionalPlanningToolsOwnerAccepted`: none
- `fallbackPlanningToolsOwnerAccepted`: `satori`
- `eliminatedToolsOwnerAccepted`: `real_esrgan`, `sam2`
- `missingProofRulesOwnerAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerAccepted`: animation manifest/runtime approval missing,browser/runtime execution not approved
- `nextProofMilestoneOwnerAccepted`: animation manifest and runtime approval lane
