...
export function prepareCanonicalLivingFrameEstimateWorkAssetProjection(
  ...
  if (
    ...
    throw conflict(
      'Canonical Living Frame estimate/work/asset projection requires selected-scene, execution, and timing lineage together.',
    )
  }
...
export async function loadCanonicalLivingFrameEstimateWorkAssetProjection(
  ...
  if (
    ...
    throw conflict(
      'Canonical Living Frame estimate/work/asset projection and its source lineage must be present together.',
    )
  }
