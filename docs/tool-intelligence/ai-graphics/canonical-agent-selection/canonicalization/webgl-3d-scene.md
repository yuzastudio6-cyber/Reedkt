# Webgl 3d Scene Canonicalization Review
...
- `preferredPlanningToolsCanonicalized`: `three_js`, `babylonjs`
- `conditionalPlanningToolsCanonicalized`: none
- `fallbackPlanningToolsCanonicalized`: `pixi_js`
- `eliminatedToolsCanonicalized`: `vega_lite`, `d3`
- `missingProofRulesCanonicalized`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsCanonicalized`: browser/WebGL sandbox approval missing; GPU/browser runtime not approved
- `nextProofMilestoneCanonicalized`: browser/WebGL sandbox proof lane
