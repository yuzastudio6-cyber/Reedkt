...
const files = {
  decision: 'docs/worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-after-image-import-proof.md',
  evidence: 'docs/worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-evidence-register-after-image-import-proof.md',
  scope: 'docs/worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-scope-register-after-image-import-proof.md',
  blockers: 'docs/worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-blocker-register-after-image-import-proof.md',
  policy: 'docs/worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-claim-policy-after-image-import-proof.md',
  nextPrompt: 'docs/implementation-prompts/prompt-worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-execution-plan-after-image-import-proof.md',
  sourcePrompt: 'docs/implementation-prompts/prompt-worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-after-image-import-proof.md',
  sourceReview: 'docs/worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-review-after-image-import-proof.md',
  sourceAcceptance: 'docs/worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-acceptance-register-after-image-import-proof.md',
  sourceEvidence: 'docs/worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-evidence-review-register-after-image-import-proof.md',
  sourceBoundary: 'docs/worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-boundary-register-after-image-import-proof.md',
  sourcePolicy: 'docs/worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-claim-policy-after-image-import-proof.md',
  controlledProof: 'docs/worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-after-image-import-proof.md',
  controlledProofEvidence: 'docs/worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-evidence-register-after-image-import-proof.md'
}
...
const decisionDoc = parseBlock(files.decision, 'worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-after-image-import-proof')
const evidence = parseBlock(files.evidence, 'worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-evidence-register-after-image-import-proof')
const scope = parseBlock(files.scope, 'worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-scope-register-after-image-import-proof')
const blockers = parseBlock(files.blockers, 'worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-blocker-register-after-image-import-proof')
const policy = parseBlock(files.policy, 'worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-claim-policy-after-image-import-proof')
const sourceReview = parseBlock(files.sourceReview, 'worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-review-after-image-import-proof')
const sourceAcceptance = parseBlock(files.sourceAcceptance, 'worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-acceptance-register-after-image-import-proof')
const sourceEvidence = parseBlock(files.sourceEvidence, 'worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-evidence-review-register-after-image-import-proof')
const sourceBoundary = parseBlock(files.sourceBoundary, 'worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-boundary-register-after-image-import-proof')
const sourcePolicy = parseBlock(files.sourcePolicy, 'worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-owner-claim-policy-after-image-import-proof')
const controlledProof = parseBlock(files.controlledProof, 'worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-after-image-import-proof')
const controlledProofEvidence = parseBlock(files.controlledProofEvidence, 'worker-runtime-jobs-sound-cpu-controlled-limited-internal-runner-boundary-preflight-proof-evidence-register-after-image-import-proof')
...
assert(decisionDoc.sourcePr === 1216, 'source PR mismatch')
assert(decisionDoc.sourceMergeCommit === 'b7c2da1f3994990425451380229f019356af123e', 'source merge mismatch')
assert(decisionDoc.acceptedDecision.limitedInternalRunnerBoundaryExecutionPlanningMayProceed === true, 'execution planning not accepted')
...
assert(decisionDoc.acceptedForToday.limitedInternalRunnerBoundaryExecutionPlanning === 'yes', 'next planning not accepted')

for (const key of [
  'limitedInternalRunnerBoundaryExecution',
...
assert(evidence.sourceEvidence.proofOwnerReviewPr === 1216, 'evidence owner review PR mismatch')
assert(evidence.sourceEvidence.proofOwnerReviewMergeCommit === 'b7c2da1f3994990425451380229f019356af123e', 'evidence owner review merge mismatch')
assert(evidence.sourceEvidence.controlledProofPr === 1213, 'evidence controlled proof PR mismatch')
...
assert(evidence.evidenceStatus === 'accepted_for_limited_internal_runner_boundary_execution_planning_only', 'evidence status widened')
...
assert(sourceReview.sourcePr === 1213, 'source review upstream PR mismatch')
...
assert(sourceReview.acceptedEvidence.internalBetaUnlockCount === 0, 'source internal beta widened')
...
assert(sourceAcceptance.counts.acceptedForInternalBetaTodayCount === 0, 'source internal beta count widened')
...
assert(sourceBoundary.boundary.internalBetaUnlockedToday === false, 'source internal beta readiness widened')
...
assert(
  packageJson.scripts?.[
    'worker-runtime-jobs:sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-after-image-import-proof:diagnostics'
  ] ===
    'node scripts/validation/worker-runtime-jobs-sound-cpu-limited-internal-runner-boundary-preflight-completion-decision-after-image-import-proof-diagnostics.mjs',
...
console.log(
  JSON.stringify(
    {
      status: 'worker_runtime_jobs_sound_cpu_limited_internal_runner_boundary_preflight_completion_decision_after_image_import_proof_diagnostics_passed',
      decision,
