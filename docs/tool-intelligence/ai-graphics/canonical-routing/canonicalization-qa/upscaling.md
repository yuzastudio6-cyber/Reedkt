...
- Preferred planning tools QA accepted: `real_esrgan`
- Conditional planning tools QA accepted: none
- Fallback planning tools QA accepted: `source replacement or lower-resolution layout plan`
- Eliminated tools QA accepted: `vega_lite`, `d3`, `sam2 unless segmentation is also requested`
...
- Next proof milestone QA accepted: Model/GPU/provenance proof before upscaling execution.
