...
RP06 remains safe: no provider/model calls, no media extraction, no Whisper, no Visual Intelligence execution, no workers, no render/export, no Supabase migration, and no credit spend.
