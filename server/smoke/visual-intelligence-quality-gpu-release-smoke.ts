...
const requiredCoreQualificationSmokes = [
  ...
  'visual-intelligence-model-billing-sku-qualification-repository-smoke.ts',
  'visual-intelligence-provider-traffic-guard-smoke.ts',
  'visual-intelligence-provider-audit-window-read-port-smoke.ts',
  ...
  'canonical-sam3_1-qualification-package-publisher-configuration-audit-smoke.ts',
  'canonical-sam3_1-source-checkpoint-qualification-vertex-launch-preflight-smoke.ts',
