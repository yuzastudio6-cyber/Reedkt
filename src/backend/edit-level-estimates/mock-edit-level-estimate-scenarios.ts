...
const baseScenarios: MockEditLevelEstimateScenario[] = [
  ...
  scenario({ id: 'normal-visual-targeted', title: 'Normal Visual Intelligence visual budget is targeted_only.', level: 'normal', estimateId: 'visual_intelligence_pass_budget' }),
  scenario({ id: 'premium-visual-key-moments', title: 'Premium Visual Intelligence visual budget is key_moments.', level: 'premium', estimateId: 'visual_intelligence_pass_budget' }),
  scenario({ id: 'ultra-visual-scene-level', title: 'Ultra Visual Intelligence visual budget is scene_level.', level: 'ultra_premium', estimateId: 'visual_intelligence_pass_budget' }),
  ...
  scenario({ id: 'visual-item-exists', title: 'Visual Intelligence pass item exists.', level: 'premium', estimateId: 'visual_intelligence_pass_budget' }),
