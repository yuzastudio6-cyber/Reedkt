# Upscaling Canonicalization Owner Approval QA
...
- Preferred planning tools accepted: `real_esrgan`
- Conditional planning tools accepted: none
- Fallback planning tools accepted: `source replacement or lower-resolution layout plan`
...
Next milestone: `Model/GPU/provenance proof before upscaling execution.`.
