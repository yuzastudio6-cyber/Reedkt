  ...
  toolRows: [
    ...
    },
    {
      ...
      requiredBeforeExecution: [
        ...
        'controlled GPU proof must use a future approved us-central1-c retry prompt before another lifecycle execution attempt',
        'controlled L4 proof must be no-idle: no public IP, prompt-scoped VM only, delete VM and verify cleanup before completion',
      ],
      currentBlocker: 'bounded_no_idle_l4_lifecycle_retry_us_central1_c_prompt_required_before_vm_or_inference',
      safeNextCommand: 'npm run smoke:ai-video-broll-gen-9m-no-idle-l4-lifecycle-proof-result',
