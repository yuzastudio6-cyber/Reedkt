# Canonical Agent Selection Fallback Rules Canonicalization Review

Decision: `ai_graphics_canonical_agent_selection_canonicalization_review_passed_with_warnings`

Fallback tools are canonicalized as planning candidates only and never become execution approval.
