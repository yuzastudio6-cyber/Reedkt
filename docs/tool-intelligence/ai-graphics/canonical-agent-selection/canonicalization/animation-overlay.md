# Animation Overlay Canonicalization Review
...
- `preferredPlanningToolsCanonicalized`: `lottie_web`, `animejs`
- `conditionalPlanningToolsCanonicalized`: none
- `fallbackPlanningToolsCanonicalized`: `satori`
- `eliminatedToolsCanonicalized`: `real_esrgan`, `sam2`
- `missingProofRulesCanonicalized`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsCanonicalized`: animation manifest/runtime approval missing; browser/runtime execution not approved
- `nextProofMilestoneCanonicalized`: animation manifest and runtime approval lane
