# Controlled Activation Artifact Qa
...
```json
{
  ...
  "artifactQa": {
    ...
    "metadataOnlyControlsAccepted": true,
    "coveredToolCount": 16,
    "allToolsCovered": true,
    "rankingAccepted": true,
    "useCaseMatrixAccepted": true,
    "noLiveRuntimeMutation": true
  },
  "dryRunRankingOrder": [
    "ffprobe",
    "mediainfo",
  ...
  "limitations": {
    "noRealToolExecutionEvidence": true,
    "noMediaProcessingEvidence": true,
    "noRouteDispatchEvidence": true,
    "noWorkerDispatchEvidence": true,
    "noProductReadyEvidence": true
  }
}
```
