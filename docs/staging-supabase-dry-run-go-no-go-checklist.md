...
| `blocked_missing_approval` | Human approval completion is missing. This is a current Prompt 25 state. |
...
- Decision: no-go.
- Reason: `blocked_missing_evidence` and `blocked_missing_approval`.
