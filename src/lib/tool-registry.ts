...
export const openSourceToolProfiles: ToolProfile[] = [
  ...
  profile({
    ...
    adoptionStage: 'needs_license_review',
    executionMode: 'future_worker',
    description: 'Segmentation/tracking planning candidate for temporal masks and text-behind-subject support.',
    bestFor: ['Object masks', 'Temporal tracking', 'Mask propagation', 'Subject coverage QA'],
    avoidFor: ['Unreviewed checkpoints', 'Private/user media without explicit gates'],
    inputTypes: ['image', 'source_video'],
    outputTypes: ['qa_report', 'json_spec'],
    settingDefinitions: openCVSettings,
    defaultPresets: ['foreground_safe_zone_qa'],
    tierAvailability: premiumOnly(),
    remotionIntegration: 'Future tracked masks can feed approved text-behind-subject and mask-composition plans.',
    qaChecks: ['Checkpoint approval and temporal mask QA are required before execution.'],
  }),
  profile({
