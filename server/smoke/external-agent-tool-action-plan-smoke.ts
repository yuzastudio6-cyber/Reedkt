...
assert.equal(broll.externalManualBlocker.includes('10K selected northamerica-northeast1-b'), true)
assert.equal(broll.externalManualBlocker.includes('10L bounded proof prompt'), true)
