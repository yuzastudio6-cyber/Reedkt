...
Phase 45A adds controlled Track A evidence that FFmpeg/libass can create a bounded private caption burn-in preview from the approved Phase 32 export and Phase 28 ASS sidecar. Phase 45B adds controlled Track A evidence that Remotion can render a bounded private preview from approved private artifacts. Final delivery and public delivery remain blocked; Phase 45C may use this evidence only for OpenTimelineIO timeline validation planning/execution.
