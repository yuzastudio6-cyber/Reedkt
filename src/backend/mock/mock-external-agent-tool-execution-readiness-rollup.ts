...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  decision:
    'external_agent_tool_execution_readiness_qwen_ready_for_explicit_gate_broll_10f_us_west4_a_selected_future_prompt_required',
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_iap_wheelhouse_transfer_us_west4_a_selected_no_vm_no_inference',
      ...
      primaryBlocker:
        'bounded_no_idle_l4_iap_wheelhouse_transfer_us_west4_a_selected_future_transfer_proof_required',
      evidence: [
      ...
      nextAction: AI_VIDEO_BROLL_GEN_10G_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_WEST4_A_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
