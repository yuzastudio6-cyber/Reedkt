...
- Current classification is `ci_linux_viability_unknown` until focused GD-8A CI import evidence is reviewed.
...
- Linux import viability is not proven by GD-8 CI because GD-8 did not run a resvg import probe.
