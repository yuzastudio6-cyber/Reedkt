# WORKER_RUNTIME_JOBS SOUND CPU Phase193 Runtime Claim Policy

```json worker-runtime-jobs-sound-cpu-phase193-runtime-claim-policy
{
  "label": "worker-runtime-jobs-sound-cpu-phase193-runtime-claim-policy",
  "allowedClaims": {
