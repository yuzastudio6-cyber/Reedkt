...
| GD-7 - Creative Graphics Controlled Local Fixture Execution | implemented_pending_validation | `codex/rp-gd-7-ai-tools-creative-graphics-controlled-local-fixture-execution` | pending | `none; controlled local creative graphics fixture execution only` |
