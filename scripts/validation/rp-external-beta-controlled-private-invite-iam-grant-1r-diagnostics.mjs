...
if (rollup.decision !== 'completed_controlled_private_invite_iam_grant_for_owner_managed_group') fail('rollup decision mismatch')
if (rollup.integrationHead !== '4ff3b917b9544ba04af0a73dfec3ec0c961b0b98') fail('rollup integration head mismatch')
if (rollup.statuses?.externalProductBeta !== 'ready_for_owner_managed_external_beta_tester_membership_addition') fail('rollup external beta status mismatch')
