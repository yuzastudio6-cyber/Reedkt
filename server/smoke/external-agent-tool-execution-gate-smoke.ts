...
assert.equal(brollGateRow?.noIdleLifecycleGate?.targetZone, 'us-east4-a')
...
assert.equal(
  ...
  'npm run smoke:ai-video-broll-gen-9w-no-idle-l4-iap-wheelhouse-transfer-proof-us-east4-a-result',
)
