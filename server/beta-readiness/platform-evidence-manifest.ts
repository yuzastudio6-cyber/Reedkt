  ...
  return [
    {
      ...
      nextSafeAction: 'Run the Supabase deployed probe transport against staging with backend service-role runtime, approved fixture event, RLS readback evidence, monitoring evidence, billing QA, and owner approvals.',
      clearsPlatformGate: false,
    ...
    },
    {
      ...
      label: 'deployment, security, storage, legal, and support owners approve the gate',
      status: 'owner_approval_required',
      localProofCommands: ['smoke:beta-readiness', 'smoke:tool-beta-execution-readiness'],
      sourceFiles: [
      ...
      nextSafeAction: 'Collect named owner approvals through the beta readiness evidence route after staging evidence is complete.',
      clearsPlatformGate: false,
      requiresDeployedEvidence: false,
      requiresOwnerApproval: true,
    },
