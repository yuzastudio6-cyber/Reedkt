  ...
  return observationSchema.parse({
    ...
    qualificationRuntime: {
      ...
      torchcodecCudaWheelVersion:
        result.runtime.torchcodecCudaWheelVersion,
      einopsVersion: result.runtime.einopsVersion,
      pycocotoolsVersion: result.runtime.pycocotoolsVersion,
      ffmpegVersion: result.runtime.ffmpegVersion,
      ffmpegNvdecAndCuvidAvailable:
        result.runtime.ffmpegNvdecAndCuvidAvailable,
      gpuVideoDecodeBackendStatusVerified:
        result.runtime.gpuVideoDecodeBackendStatusVerified,
      cpuVideoDecodeFallbackObserved:
        result.runtime.cpuVideoDecodeFallbackObserved,
