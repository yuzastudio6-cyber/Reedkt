...
import type { MockToolCostEvent, ToolCostFailureCategory, ToolCreditPrerequisiteStatus } from '../../tool-cost-metering'
...
export interface ProductionWorkerToolCostMetadata {
  ...
  billableToUserByToolId: Record<string, boolean>
  failureCategoryByToolId: Record<string, ToolCostFailureCategory>
  warnings: string[]
}
