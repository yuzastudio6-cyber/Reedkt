...
export interface AiGraphicsGpuRuntimeProofActivationPolicy {
  onDemandOnly: true
...
export interface AiGraphicsGpuRuntimeProofProfilePlan {
  ...
  runtimeActivationPolicy: AiGraphicsGpuRuntimeProofActivationPolicy
...
const gpuRuntimeActivationPolicy = {
  onDemandOnly: true,
  noIdleGpuRuntimeApproved: true,
  startsOnlyForApprovedWorkerOrToolCall: true,
  proofContainerIsEphemeral: true,
  cpuFallbackAllowedForHeavyTools: false,
} as const satisfies AiGraphicsGpuRuntimeProofActivationPolicy
...
function buildProfilePlan(
  ...
  return {
    ...
    runtimeActivationPolicy: gpuRuntimeActivationPolicy,
...
export function buildAiGraphicsGpuRuntimeProofNativeRunnerScript(
  ...
  const lines = [
    ...
    '# GPU containers are on-demand proof containers: docker run --rm starts them for this command and removes them after exit.',
...
export function buildAiGraphicsGpuRuntimeProofCommandPlan(
  ...
  return {
    ...
    gpuRuntimePolicy: gpuRuntimeActivationPolicy,
