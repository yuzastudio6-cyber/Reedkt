...
try {
  ...
  assert.equal(coverage.registeredProviderOperationCount, 1)
  assert.equal(coverage.totalOperationContractCount, 73)
  assert.equal(coverage.toolOperationContractsWithRequiredCpuMemoryMeasurements, 72)
  assert.equal(coverage.providerOperationContractsWithRequiredCpuMemoryMeasurements, 1)
  assert.equal(coverage.totalOperationContractsWithRequiredCpuMemoryMeasurements, 73)
