...
const DECISION = "qwen2_5_vl_7b_l4_reservation_create_blocked_by_us_east1_b_gpu_availability_no_vm_no_inference";
const NEXT_PROMPT =
...
check(
  packageJson.scripts?.["qwen2-5-vl-7b-l4-reservation-create:diagnostics"] ===
    "node scripts/validation/qwen2-5-vl-7b-l4-reservation-create-diagnostics.mjs",
  "package.json must expose qwen2-5-vl-7b-l4-reservation-create:diagnostics"
);

const result = read("docs/qwen2-5-vl-7b-l4-reservation-create-result.md");
const prompt = read("docs/implementation-prompts/prompt-qwen2-5-vl-7b-l4-reservation-capacity-followup.md");
const changeLog = parseBlock(
  "docs/qwen2-5-vl-7b-l4-reservation-create-change-log.md",
  "qwen2-5-vl-7b-l4-reservation-create-change-log"
);

includesAll(result, REQUIRED_RESULT_PHRASES, "reservation create result");
includesAll(prompt, [
  NEXT_PROMPT,
...
], "reservation capacity followup prompt");
