...
- `bestFor`: future subject/background extraction planning
- `notFor`: charts; 3D scenes; current execution
- `inputTypes`: `image_subject_extraction_plan`
...
- `safetyLimitations`: model download blocked; inference blocked
- `fallbacks`: `sam2`, `rembg`
- `tier`: `Blocked`
- `totalScore`: `49`
- `nextProofMilestone`: `model_weight_and_background_extraction_review`
