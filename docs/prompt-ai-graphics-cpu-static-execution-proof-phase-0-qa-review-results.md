...
- npm ci status accepted from PR #728: `passed_from_existing_package_lock_before_phase0_runner`
- Tool-by-tool QA status: d3=proof_passed, vega_lite=proof_passed, vega=proof_passed, satori=proof_blocked_missing_runtime, svgdotjs_svg_js=proof_passed, viz_js=proof_passed
