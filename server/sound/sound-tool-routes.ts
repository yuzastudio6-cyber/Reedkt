...
function route(seed: RouteSeed): Readonly<SoundToolRouteManifest> {
  const unpublished: UnpublishedSoundToolRouteManifest = {
    ...
    fallbackPolicy: {
      fallbackRouteKeys: seed.fallbacks ?? [],
...
const fixture = 'fixture_qualified' as const
const privateInternal = 'private_internal_qualified' as const
...
export const SOUND_TOOL_ROUTE_MANIFESTS = [
  ...
  route({
    ...
    steps: [
      ...
      { key: 'validate_extracted_audio', tool: 'ffprobe', toolVersion: ffmpegVersion, operation: 'inspect_validate_audio', profile: 'sound.inspect.audio.v1', depends: ['extract_project_audio'], inputs: ['edited_audio_asset_version'], outputs: ['validated_audio_metadata'], qualification: privateInternal },
  ...
  route({
    ...
    fallbacks: ['sound.route.generate.video_sfx.mmaudio.v1', 'sound.route.no_sound.v1'],
    steps: [
      { key: 'prepare_visual_proxy', tool: 'sound_private_artifact_store', toolVersion: privateStoreVersion, operation: 'prepare_bounded_private_visual_proxy', profile: 'sound.proxy.visual_bounded.v1', inputs: ['approved_visual_artifact'], outputs: ['bounded_private_visual_proxy'], qualification: fixture },
      ...
      { key: 'match_room_and_tone', tool: 'pedalboard', toolVersion: 'registry-current', operation: 'apply_approved_effect_chain', profile: 'sound.tone-room-match.v1', depends: ['trim_sync_candidate'], inputs: ['trimmed_sound_candidate'], outputs: ['tone_matched_sound_candidate'], qualification: privateInternal },
      { key: 'align_visual_event', tool: 'sound_sync_service', toolVersion: '1.0.0', operation: 'align_sound_to_visual_event', profile: 'sound.sync.visual_event.v1', depends: ['match_room_and_tone'], inputs: ['tone_matched_sound_candidate', 'visual_event_manifest'], outputs: ['sound_cue_manifest'], qualification: privateInternal },
      ...
      { key: 'mix_match_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'mix_scene_stem', profile: 'sound.mix-stem.v1', depends: ['match_room_and_tone', 'create_mix_automation'], inputs: ['tone_matched_sound_candidate', 'dialogue_context', 'mix_automation_manifest'], outputs: ['validated_sound_candidate'], qualification: privateInternal },
      { key: 'qa_candidate', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.final.v1', depends: ['mix_match_candidate'], inputs: ['validated_sound_candidate', 'sound_cue_manifest'], outputs: ['sound_qa_report'], qualification: privateInternal },
  ...
  route({
    ...
    outputs: ['candidate_sfx_asset', 'sound_cue_manifest', 'mix_automation_manifest', 'provenance_report', 'cost_evidence', 'caller_receipt'],
    fallbacks: ['sound.route.acquire.internal_library.v1', 'sound.route.no_sound.v1'],
    steps: [
      ...
      { key: 'match_room_and_tone', tool: 'pedalboard', toolVersion: 'registry-current', operation: 'apply_approved_effect_chain', profile: 'sound.tone-room-match.v1', depends: ['trim_candidate'], inputs: ['validated_sound_candidate'], outputs: ['tone_matched_sound_candidate'], qualification: privateInternal },
      { key: 'align_event', tool: 'sound_sync_service', toolVersion: '1.0.0', operation: 'align_sound_to_visual_event', profile: 'sound.sync.visual_event.v1', depends: ['match_room_and_tone'], inputs: ['tone_matched_sound_candidate', 'visual_event_manifest'], outputs: ['sound_cue_manifest'], qualification: privateInternal },
      ...
      { key: 'mix_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'mix_scene_stem', profile: 'sound.mix-stem.v1', depends: ['match_room_and_tone', 'create_mix_automation'], inputs: ['tone_matched_sound_candidate', 'dialogue_context', 'mix_automation_manifest'], outputs: ['validated_sound_candidate'], qualification: privateInternal },
      { key: 'qa_candidate', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.final.v1', depends: ['mix_candidate'], inputs: ['validated_sound_candidate', 'sound_cue_manifest'], outputs: ['sound_qa_report'], qualification: privateInternal },
  ...
  route({
    ...
    steps: [
      ...
      { key: 'qa_dialogue', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.dialogue.v1', depends: ['gentle_cleanup'], inputs: ['cleaned_dialogue_asset'], outputs: ['sound_qa_report'], qualification: privateInternal },
  ...
  route({
    ...
    steps: [
      ...
      { key: 'validate_output', tool: 'ffprobe', toolVersion: ffmpegVersion, operation: 'inspect_validate_audio', profile: 'sound.inspect.audio.v1', depends: ['trim_fade_gain', 'normalize', 'resample_channels', 'loop_audio'], inputs: ['edited_audio_asset_version'], outputs: ['validated_audio_metadata'], qualification: privateInternal },
  ...
  route({
    ...
    steps: [
      ...
      { key: 'qa_retime', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.retime.v1', depends: ['retime_sound'], inputs: ['edited_audio_asset_version'], outputs: ['sound_qa_report'], qualification: privateInternal },
    ],
  ...
  route({
    ...
    steps: [
      ...
      { key: 'qa_mix', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.mix.v1', depends: ['mix_stem'], inputs: ['private_sound_stem', 'mix_automation_manifest'], outputs: ['sound_qa_report'], qualification: privateInternal },
  ...
  route({
    ...
    requiredInputs: ['sound_design_context'], outputs: ['no_sound_decision', 'caller_receipt'],
    steps: [{
