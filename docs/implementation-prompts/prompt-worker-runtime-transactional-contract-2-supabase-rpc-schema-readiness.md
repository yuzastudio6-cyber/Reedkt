...
Create a readiness packet for the future RPC/schema implementation path. Preserve the operation family `tracka_private_e2e_revalidation`, the planned operation names, the service-role boundary, the no broad service-role handler rule, and the public/signed/final/internal-beta blockers.
