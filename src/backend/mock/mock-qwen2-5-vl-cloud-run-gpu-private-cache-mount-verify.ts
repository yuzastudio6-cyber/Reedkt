export const QWEN2_5_VL_CLOUD_RUN_GPU_PRIVATE_CACHE_MOUNT_VERIFY = {
  workstream: "AI_VIDEO_BROLL_GENERATION",
  toolId: "qwen2_5_vl_7b_instruct",
  mode: "cloud_run_gpu_private_cache_mount_verify_no_deploy",
  decision:
  ...
  verifiedPrivateCache: {
    ...
    configJson: {
      generation: "1782514722459524",
      size: 1374,
      metadataReadByActiveOperator: true
    }
  },
  ...
  readPathProbe: {
    ...
    deployTimeRuntimeReadProofStillRequired: true
  },
  cloudRunState: {
...
export type Qwen25VlCloudRunGpuPrivateCacheMountVerify =
  typeof QWEN2_5_VL_CLOUD_RUN_GPU_PRIVATE_CACHE_MOUNT_VERIFY;
