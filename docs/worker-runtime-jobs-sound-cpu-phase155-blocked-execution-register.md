# WORKER_RUNTIME_JOBS SOUND CPU Phase155 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase155-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase155-blocked-execution-register",
  "blockedToday": {
