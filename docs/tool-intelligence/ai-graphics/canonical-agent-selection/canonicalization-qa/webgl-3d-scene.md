# Webgl 3d Scene Canonicalization QA
...
- `preferredPlanningToolsQaAccepted`: `three_js`, `babylonjs`
- `conditionalPlanningToolsQaAccepted`: none
- `fallbackPlanningToolsQaAccepted`: `pixi_js`
- `eliminatedToolsQaAccepted`: `vega_lite`, `d3`
- `missingProofRulesQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsQaAccepted`: browser/WebGL sandbox approval missing,GPU/browser runtime not approved
- `nextProofMilestoneQaAccepted`: browser/WebGL sandbox proof lane
