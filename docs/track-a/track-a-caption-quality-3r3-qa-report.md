...
| --- | --- | --- |
| `confirmation_envs_present` | `passed` | REEDITPRO_CONFIRM_TRACKA_CAPTION_BURNIN_REVALIDATION=true and REEDITPRO_CONFIRM_TRACKA_CAPTION_APPROVED_SOURCE_GCS_READ=true are required. |
