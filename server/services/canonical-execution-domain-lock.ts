...
/**
 * Serializes lease claim, dispatch authorization/consumption, worker execution
 * fence transitions, and cancellation for one private single-host edit.
 * Production remains blocked until the same fence is enforced by durable
