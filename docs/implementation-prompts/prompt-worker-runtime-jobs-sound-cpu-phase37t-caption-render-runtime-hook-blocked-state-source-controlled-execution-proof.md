...
```json worker-runtime-jobs-sound-cpu-phase37t-caption-render-runtime-hook-blocked-state-source-controlled-execution-proof
{
  ...
  "requiredSourceDecision": "worker_runtime_jobs_sound_cpu_phase37s_caption_render_runtime_hook_blocked_state_source_controlled_execution_plan_owner_review_passed_with_warnings_ready_for_controlled_execution_proof_no_media_no_artifacts",
  "goal": "Run one bounded fail-closed blocked-state integration proof using synthetic no-media input, then remove the temporary proof file before staging evidence.",
  "sourceHeadAtPromptCreation": "d07ec899bf97ca03ecad92fea12e609affeafcb0",
...
Use this prompt only after the Phase 37S owner-review packet merges and duplicate checks confirm no same-purpose Phase 37T proof PR already exists.
