...
- Validation status after Prompt 11: lint, server typecheck, static schema audit, existing diagnostics, QA/revision diagnostics, and foundation validation should pass locally or in GitHub Foundation Validation; SQL/RLS remains draft-only unless local Supabase is repaired.
...
- Next prompt recommendation: Prompt 12 - Tool-Call Foundation if Prompt 11 validation and CI pass; otherwise Prompt 11A - QA Revision Fallback Validation Hardening.
