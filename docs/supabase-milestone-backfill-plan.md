...
- staging approval packet, human review packet, and Prompt 23 guarded decision record
...
- Prompt 23: `ready_for_staging_dry_run`; staging sync not applied; production sync blocked.
