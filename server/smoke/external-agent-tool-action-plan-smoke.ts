...
assert.equal(broll.externalManualBlocker.includes('10M selected northamerica-northeast1-c'), true)
assert.equal(broll.externalManualBlocker.includes('10N bounded no-idle proof'), true)
assert.equal(broll.externalManualBlocker.includes('configuration'), true)
