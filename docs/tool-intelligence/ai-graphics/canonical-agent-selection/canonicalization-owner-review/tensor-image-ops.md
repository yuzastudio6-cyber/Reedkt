# Tensor Image Ops Canonicalization Owner Review
...
- `preferredPlanningToolsOwnerAccepted`: `kornia`
- `conditionalPlanningToolsOwnerAccepted`: `torch_torchvision`
- `fallbackPlanningToolsOwnerAccepted`: `transformers`
- `eliminatedToolsOwnerAccepted`: `echarts`, `viz_js`
- `missingProofRulesOwnerAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerAccepted`: CPU import proof not approved for execution,tensor/image ops execution not approved
- `nextProofMilestoneOwnerAccepted`: CPU import and tensor-operation boundary proof lane
