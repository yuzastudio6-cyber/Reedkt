...
assert.equal(broll.externalManualBlocker.includes('10O selected northamerica-northeast2-a'), true)
assert.equal(broll.externalManualBlocker.includes('10P no-idle proof prompt'), true)
