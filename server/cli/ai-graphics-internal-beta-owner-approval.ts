...
} from '../tool-registry/ai-graphics-internal-beta-owner-approval'
import type {
...
const approval = buildAiGraphicsInternalBetaOwnerApproval({
  evidenceBundleInput,
...
if (
  hasFlag('--require-owner-approved-evidence') &&
  !approval.all21BetaEvidenceReadyAfterOwnerApproval
) {
  process.exitCode = 2
}
