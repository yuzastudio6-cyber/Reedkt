...
export const GCP_PRODUCTION_CLOUD_RUN_JOBS: GcpCloudRunTemplate[] = [
  ...
  },
  {
    ...
    includesRevideo: false,
    notes: [
      'No GPU. SOUND CPU 15-tool image target using server/workers/sound-cpu/Dockerfile.',
      'Runtime, media processing, worker execution, Supabase, and artifact writes remain disabled by default.',
    ],
  },
  {
    ...
    includesRevideo: false,
    notes: [
      'No GPU. SOUND CPU metadata worker target for package import, numeric array, symbolic MIDI, and loudness planning jobs.',
      'Runtime, media processing, worker execution, Supabase, and artifact writes remain disabled by default.',
    ],
  },
  {
