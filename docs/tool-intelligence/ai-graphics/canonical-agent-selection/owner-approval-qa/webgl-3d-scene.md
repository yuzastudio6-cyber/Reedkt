...
- `fallbackPlanningToolsOwnerApprovalQaAccepted`: `pixi_js`
- `eliminatedToolsOwnerApprovalQaAccepted`: `vega_lite`, `d3`
- `missingProofRulesOwnerApprovalQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApprovalQaAccepted`: browser/WebGL sandbox approval missing; GPU/browser runtime not approved
- `nextProofMilestoneOwnerApprovalQaAccepted`: browser/WebGL sandbox proof lane
