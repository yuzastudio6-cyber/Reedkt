...
Missing product-ready proof categories: live product call safety, route dispatch safety, worker dispatch safety, real tool execution, approved snapshot/edit-plan/credit runtime enforcement, rollback, monitoring, privacy, and Supabase/GCS boundaries.
...
```json
{
  ...
  "failClosedControlsAcceptedAsMetadata": true,
  "evidenceSufficientForProductReady": false,
  "productReadyBlockedReasons": {
  ...
  "productReadyLocalOssCountMustRemain": 0
}
```
