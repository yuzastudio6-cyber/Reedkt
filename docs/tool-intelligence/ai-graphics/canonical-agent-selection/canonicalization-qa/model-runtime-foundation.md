# Model Runtime Foundation Canonicalization QA
...
- `preferredPlanningToolsQaAccepted`: `torch_torchvision`, `transformers`
- `conditionalPlanningToolsQaAccepted`: none
- `fallbackPlanningToolsQaAccepted`: `kornia`
- `eliminatedToolsQaAccepted`: `vega_lite`, `lottie_web`
- `missingProofRulesQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsQaAccepted`: CPU/GPU/model-boundary proof missing,model downloads and provider/model runtime are not approved
- `nextProofMilestoneQaAccepted`: model runtime foundation proof lane
