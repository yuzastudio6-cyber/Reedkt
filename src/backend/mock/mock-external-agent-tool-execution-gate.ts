  ...
  toolRows: [
    ...
    },
    {
      ...
      requiredBeforeExecution: [
        ...
        'controlled GPU proof must use a future approved stockout-fix prompt before another transfer proof VM attempt, dependency install, or inference',
        'controlled L4 proof must be no-idle: no public IP, prompt-scoped VM only, delete VM and verify cleanup before completion',
      ],
      currentBlocker: 'bounded_no_idle_l4_iap_wheelhouse_transfer_stockout_fix_required_before_dependency_or_inference',
      safeNextCommand: 'npm run smoke:ai-video-broll-gen-9o-retry-no-idle-l4-iap-wheelhouse-transfer-proof-result',
