...
export const MOCK_EDIT_LEVEL_TOOL_ROUTER_SCENARIOS: MockEditLevelToolRouterScenario[] = [
  ...
  scenario({ id: 'registry-visual-intelligence', title: 'Capability registry includes provider-neutral Visual Intelligence.', expectedOk: true, capabilityId: 'visual_intelligence' }),
  ...
  scenario({ id: 'normal-visual-intelligence-targeted', title: 'Normal Visual Intelligence is targeted/optional.', expectedOk: true, level: 'normal', capabilityId: 'visual_intelligence', expectedRequiredness: 'optional', expectedStatus: 'provider_required' }),
  scenario({ id: 'premium-visual-intelligence-key-moments', title: 'Premium Visual Intelligence covers key moments and marker windows.', expectedOk: true, level: 'premium', capabilityId: 'visual_intelligence', expectedRequiredness: 'recommended', expectedStatus: 'provider_required' }),
  scenario({ id: 'ultra-visual-intelligence-whole-media', title: 'Ultra Visual Intelligence is deep whole-media.', expectedOk: true, level: 'ultra_premium', capabilityId: 'visual_intelligence', expectedRequiredness: 'required', expectedStatus: 'provider_required' }),
