...
assert.match(probe, /QWEN_REASONING_API_KEY/)
...
assert.match(workflow, /secrets\.QWEN_REASONING_API_KEY/)
...
assert.match(probeWorkflow, /secrets\.QWEN_REASONING_API_KEY/)
