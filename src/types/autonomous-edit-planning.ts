...
import type {
  ...
  PreferenceApplicationLegacyAdaptationDecision,
...
export interface AutonomousEditPreferenceApplicationSelection {
  applicationId: string
  expectedApplicationContentDigest: string
  expectedContextHash: string
}

export interface AutonomousEditPreferenceApplicationDecisionSnapshot {
  decisionId: string
  sourceRuleId: string
...
export interface AutonomousEditPreferenceApplicationSnapshot {
  ...
  decisions: AutonomousEditPreferenceApplicationDecisionSnapshot[]
...
export interface CreateAutonomousEditPlanRequest {
  ...
  preferenceApplication?: AutonomousEditPreferenceApplicationSelection
...
export interface AutonomousEditPlanOperation {
  ...
  /**
   * Exact target-adapted Preference Application decisions that authorize or
   * shape this operation. This must never reference ignored, blocked, or
   * clarification decisions.
   */
  preferenceDecisionRefs?: string[]
...
export interface AutonomousEditPlanDraft {
  ...
  preferenceApplication?: AutonomousEditPreferenceApplicationSnapshot
  runtime: {
