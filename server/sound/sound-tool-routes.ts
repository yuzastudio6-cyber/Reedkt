...
function route(seed: RouteSeed): Readonly<SoundToolRouteManifest> {
  const produced = new Set(seed.steps.flatMap((item) => item.outputs ?? []))
  const initialInputs = seed.steps.flatMap((item) => item.inputs ?? []).filter((input) => !produced.has(input))
  const unpublished: UnpublishedSoundToolRouteManifest = {
    ...
    requiredInputs: [...new Set([...seed.requiredInputs, ...initialInputs])],
...
export const SOUND_TOOL_ROUTE_MANIFESTS = [
  ...
  route({
    ...
    steps: [
      { key: 'extract_project_audio', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'extract_audio_pcm', profile: 'sound.extract.project_source.v1', inputs: ['approved_source_audio'], outputs: ['edited_audio_asset_version'], qualification: privateInternal },
      ...
      { key: 'commit_extracted_audio', tool: 'sound_private_artifact_store', toolVersion: privateStoreVersion, operation: 'commit_selected_sound_artifact', profile: 'sound.artifact.commit.project_source.v1', depends: ['validate_extracted_audio'], inputs: ['validated_audio_metadata'], outputs: ['private_selected_sound_artifact', 'provenance_report'], qualification: privateInternal },
    ],
  }),
  route({
    ...
    steps: [
      ...
      { key: 'extract_carrier_audio', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'extract_audio_pcm', profile: 'sound.extract.provider_carrier.v1', depends: ['validate_carrier'], inputs: ['validated_provider_carrier'], outputs: ['extracted_provider_audio'], condition: 'provider_output_is_video_carrier', qualification: privateInternal, optional: true },
      ...
      { key: 'trim_sync_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'trim_fade_gain_audio', profile: 'sound.trim-fade-gain.video_candidate.v1', depends: ['analyze_event_region'], inputs: ['candidate_transient_report'], outputs: ['trimmed_sound_candidate'], qualification: privateInternal },
      { key: 'analyze_trimmed_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'analyze_audio_pcm', profile: 'sound.analyze.output.v1', depends: ['trim_sync_candidate'], inputs: ['trimmed_sound_candidate'], outputs: ['final_audio_metrics'], qualification: privateInternal },
      ...
      { key: 'mix_match_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'mix_scene_stem', profile: 'sound.mix-stem.provider_candidate.v1', depends: ['trim_sync_candidate', 'create_mix_automation'], inputs: ['trimmed_sound_candidate', 'dialogue_context', 'mix_automation_manifest'], outputs: ['validated_sound_candidate'], qualification: privateInternal, optional: true },
      { key: 'qa_candidate', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.provider_candidate.v1', depends: ['analyze_trimmed_candidate', 'create_mix_automation'], inputs: ['trimmed_sound_candidate', 'sound_cue_manifest', 'final_audio_metrics'], outputs: ['sound_qa_report'], qualification: privateInternal },
      { key: 'commit_selected_candidate', tool: 'sound_private_artifact_store', toolVersion: privateStoreVersion, operation: 'commit_selected_sound_artifact', profile: 'sound.artifact.commit.provider_candidate.v1', depends: ['qa_candidate'], inputs: ['trimmed_sound_candidate', 'sound_qa_report'], outputs: ['private_selected_sound_artifact', 'candidate_sfx_asset', 'provenance_report'], qualification: privateInternal },
  ...
  route({
    ...
    { key: 'trim_model_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'trim_fade_gain_audio', profile: 'sound.trim-fade-gain.model_candidate.v1', depends: ['analyze_model_candidate'], inputs: ['candidate_transient_report'], outputs: ['trimmed_sound_candidate'], qualification: privateInternal },
    ...
    { key: 'mix_model_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'mix_scene_stem', profile: 'sound.mix-stem.provider_candidate.v1', depends: ['match_model_room_and_tone', 'create_model_mix_automation'], inputs: ['tone_matched_sound_candidate', 'dialogue_context'], outputs: ['validated_sound_candidate'], qualification: privateInternal },
    { key: 'qa_model_candidate', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.provider_candidate.v1', depends: ['mix_model_candidate'], inputs: ['validated_sound_candidate', 'sound_cue_manifest'], outputs: ['sound_qa_report'], qualification: privateInternal },
    { key: 'commit_model_candidate', tool: 'sound_private_artifact_store', toolVersion: privateStoreVersion, operation: 'commit_selected_sound_artifact', profile: 'sound.artifact.commit.provider_candidate.v1', depends: ['qa_model_candidate'], inputs: ['validated_sound_candidate', 'sound_qa_report'], outputs: ['private_selected_sound_artifact', 'candidate_sfx_asset', 'provenance_report'], qualification: privateInternal },
    ],
  ...
  route({
    ...
    steps: [
      ...
      { key: 'trim_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'trim_fade_gain_audio', profile: 'sound.trim-fade-gain.text_candidate.v1', depends: ['ingest_provider_output'], inputs: ['private_untrusted_sound_candidate'], outputs: ['validated_sound_candidate'], qualification: privateInternal },
      ...
      { key: 'mix_candidate', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'mix_scene_stem', profile: 'sound.mix-stem.provider_candidate.v1', depends: ['trim_candidate', 'create_mix_automation'], inputs: ['validated_sound_candidate', 'dialogue_context', 'mix_automation_manifest'], outputs: ['validated_sound_candidate'], qualification: privateInternal, optional: true },
      { key: 'qa_candidate', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.provider_candidate.v1', depends: ['trim_candidate', 'create_mix_automation'], inputs: ['validated_sound_candidate', 'sound_cue_manifest'], outputs: ['sound_qa_report'], qualification: privateInternal },
      { key: 'commit_candidate', tool: 'sound_private_artifact_store', toolVersion: privateStoreVersion, operation: 'commit_selected_sound_artifact', profile: 'sound.artifact.commit.provider_candidate.v1', depends: ['qa_candidate'], inputs: ['validated_sound_candidate', 'sound_qa_report'], outputs: ['private_selected_sound_artifact', 'candidate_sfx_asset', 'provenance_report'], qualification: privateInternal },
  ...
  route({
    ...
    capabilities: ['sound.generate_ambience'],
    jobs: ['generate_ambience'], role: 'primary',
    ...
    steps: [
      ...
      { key: 'extend_loop', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'loop_audio_crossfade', profile: 'sound.loop.ambience.v1', depends: ['ingest_if_generated'], inputs: ['private_untrusted_sound_candidate'], outputs: ['ambience_asset'], qualification: privateInternal },
      { key: 'analyze_ambience', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'analyze_audio_pcm', profile: 'sound.analyze.output.v1', depends: ['extend_loop'], inputs: ['ambience_asset'], outputs: ['final_audio_metrics'], qualification: privateInternal },
      { key: 'create_ambience_cue', tool: 'sound_sync_service', toolVersion: '1.0.0', operation: 'create_timed_sound_cue', profile: 'sound.cue.ambience.v1', depends: ['analyze_ambience'], inputs: ['ambience_asset', 'timing_manifest'], outputs: ['sound_cue_manifest'], qualification: privateInternal },
  ...
  route({
    key: 'sound.route.ambience.extend_local.v1',
    capabilities: ['sound.extend_ambience'], jobs: ['extend_ambience'], role: 'primary',
    requiredInputs: ['approved_ambience_source_or_brief', 'approved_source_audio'],
    outputs: ['ambience_asset', 'sound_cue_manifest', 'sound_qa_report', 'provenance_report'],
    fallbacks: ['sound.route.no_sound.v1'],
    steps: [
      { key: 'extend_loop', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'loop_audio_crossfade', profile: 'sound.loop.ambience.v1', inputs: ['approved_source_audio'], outputs: ['ambience_asset'], qualification: privateInternal },
      { key: 'analyze_ambience', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'analyze_audio_pcm', profile: 'sound.analyze.output.v1', depends: ['extend_loop'], inputs: ['ambience_asset'], outputs: ['final_audio_metrics'], qualification: privateInternal },
      { key: 'create_ambience_cue', tool: 'sound_sync_service', toolVersion: '1.0.0', operation: 'create_timed_sound_cue', profile: 'sound.cue.ambience.v1', depends: ['analyze_ambience'], inputs: ['ambience_asset', 'timing_manifest'], outputs: ['sound_cue_manifest'], qualification: privateInternal },
      { key: 'qa_ambience', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.ambience.v1', depends: ['create_ambience_cue'], inputs: ['ambience_asset', 'sound_cue_manifest'], outputs: ['sound_qa_report'], qualification: privateInternal },
      { key: 'commit_ambience', tool: 'sound_private_artifact_store', toolVersion: privateStoreVersion, operation: 'commit_selected_sound_artifact', profile: 'sound.artifact.commit.project_source.v1', depends: ['qa_ambience'], inputs: ['ambience_asset', 'sound_qa_report'], outputs: ['private_selected_sound_artifact', 'provenance_report'], qualification: privateInternal },
    ],
    limitations: ['Deterministic extension of an approved ambience source; generation remains a separate Mirelo fixture route.'],
  }),
  route({
  ...
  route({
    ...
    outputs: ['edited_audio_asset_version', 'provenance_report'],
    steps: [
      { key: 'trim_fade_gain', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'trim_fade_gain_audio', profile: 'sound.trim-fade-gain.edit.v1', inputs: ['approved_source_audio'], outputs: ['edited_audio_asset_version'], condition: 'job_requires_trim_fade_or_gain', qualification: privateInternal },
      ...
      { key: 'loop_audio', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'loop_audio_crossfade', profile: 'sound.loop.edit.v1', inputs: ['approved_source_audio'], outputs: ['edited_audio_asset_version'], condition: 'job_requires_loop', qualification: privateInternal },
  ...
  route({
    key: 'sound.route.edit.music_technical_automation.v2',
    version: '2.0.0',
    ...
    steps: [
      ...
      { key: 'mix_stem', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'mix_scene_stem', profile: 'sound.mix-stem.music_technical.v2', profileVersion: '2.0.0', depends: ['sync_qa'], inputs: ['edited_audio_asset_version', 'dialogue_context', 'mix_automation_manifest'], outputs: ['private_sound_stem'], qualification: privateInternal },
      ...
      { key: 'qa_music_technical', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.music_technical.v2', profileVersion: '2.0.0', depends: ['analyze_mix'], inputs: ['private_sound_stem', 'final_audio_metrics'], outputs: ['sound_qa_report'], qualification: privateInternal },
      { key: 'commit_music_stem', tool: 'sound_private_artifact_store', toolVersion: privateStoreVersion, operation: 'commit_selected_sound_artifact', profile: 'sound.artifact.commit.music_technical.v2', profileVersion: '2.0.0', depends: ['qa_music_technical'], inputs: ['private_sound_stem', 'sound_qa_report'], outputs: ['private_selected_sound_artifact', 'provenance_report'], qualification: privateInternal },
    ],
  ...
  route({
    key: 'sound.route.edit.music_two_source_crossfade.v2',
    version: '2.0.0',
    ...
    steps: [{
      ...
      operation: 'crossfade_music_two_source', profile: 'sound.crossfade.music_two_source.v2', profileVersion: '2.0.0',
  ...
  route({
    ...
    steps: [
      ...
      { key: 'mix_stem', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'mix_scene_stem', profile: 'sound.mix-stem.scene.v1', depends: ['create_mix_automation'], inputs: ['approved_sound_layers', 'dialogue_context', 'mix_automation_manifest'], outputs: ['private_sound_stem'], qualification: privateInternal },
      { key: 'analyze_mix', tool: 'ffmpeg', toolVersion: ffmpegVersion, operation: 'analyze_audio_pcm', profile: 'sound.analyze.output.v1', depends: ['mix_stem'], inputs: ['private_sound_stem'], outputs: ['final_audio_metrics'], qualification: privateInternal },
      ...
      { key: 'commit_mix', tool: 'sound_private_artifact_store', toolVersion: privateStoreVersion, operation: 'commit_selected_sound_artifact', profile: 'sound.artifact.commit.mix_stem.v1', depends: ['qa_mix'], inputs: ['private_sound_stem'], outputs: ['private_selected_sound_artifact'], qualification: privateInternal },
    ],
  }),
  route({
    ...
    steps: [
      ...
      { key: 'evaluate_final_sound', tool: 'sound_qa_service', toolVersion: '1.0.0', operation: 'evaluate_final_sound', profile: 'sound.qa.final_handoff.v1', depends: ['analyze_final_audio'], inputs: ['final_audio_metrics', 'sound_cue_manifest'], outputs: ['sound_qa_report', 'final_composition_sound_handoff', 'caller_receipt'], qualification: privateInternal },
    ],
  }),
  route({
    ...
    steps: [{
      ...
      inputs: [], outputs: ['no_sound_decision', 'caller_receipt'], qualification: privateInternal,
    }],
