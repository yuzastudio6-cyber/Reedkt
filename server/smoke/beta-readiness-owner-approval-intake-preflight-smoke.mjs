...
assert.equal(empty.sourceTruth.sourceSha, '8f5946c12d983abb6fb6e9eca020b9b260848706')
assert.equal(empty.sourceTruth.deployedEvidenceSourceSha, 'aa49cef9ed6dad971f0163ea80ebb34de0e65d67')
assert.equal(empty.sourceTruth.manifestOwnerGapPacket, 'docs/beta-readiness/deployed-evidence-input-manifest/2026-06-29-aa49-deployed-evidence-input-manifest.json')
assert.equal(empty.sourceTruth.deployedEvidenceInputManifest, 'docs/beta-readiness/deployed-evidence-input-manifest/2026-06-29-aa49-deployed-evidence-input-manifest.json')
...
assert.equal(empty.sourceTruth.normalApiRevision, 'reeditpro-api-staging-00013-jv9')
...
assert.equal(staticIntakePacket.ownerApprovalCollectionHandoff, 'docs/beta-readiness/owner-approval-collection-handoff/2026-06-29-aa49-owner-approval-collection-handoff.json')
...
assert.ok(staticIntakeMarkdown.includes('8f5946c12d983abb6fb6e9eca020b9b260848706'))
