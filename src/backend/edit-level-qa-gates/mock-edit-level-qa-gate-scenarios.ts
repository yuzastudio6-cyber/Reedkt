...
const baseScenarios: MockEditLevelQAGateScenario[] = [
  ...
  scenario({ id: 'premium-visual-intelligence-warning', title: 'Premium Visual Intelligence confidence is warning-only.', level: 'premium', gateId: 'visual_intelligence_confidence' }),
  ...
  scenario({ id: 'ultra-visual-confidence', title: 'Ultra Premium requires visual confidence.', level: 'ultra_premium', gateId: 'visual_intelligence_confidence' }),
