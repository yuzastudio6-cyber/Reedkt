# Approval Credit Idempotency QA
...
QA accepts the approval, credit, idempotency, artifact metadata, QA, and fallback gates as product-ready closeout candidates.
...
```json
{
  ...
  "report": "approval-credit-idempotency-qa",
  "approvedSnapshotGateAccepted": true,
  "editPlanGateAccepted": true,
  "creditReservationGateAccepted": true,
  "idempotencyGateAccepted": true,
  "privateArtifactMetadataGateAccepted": true,
  "qaGateAccepted": true,
  "fallbackPolicyGateAccepted": true,
  "noToolCallBeforeApprovalAccepted": true,
  "noCreditBypassAccepted": true
}
```
