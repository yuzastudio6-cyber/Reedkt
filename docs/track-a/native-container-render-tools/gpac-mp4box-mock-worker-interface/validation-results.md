# GPAC/MP4Box Mock Worker Interface Validation Results
...
- `npm run smoke:tracka-gpac-mp4box-mock-worker-interface`: passed
- `npm run --silent tracka:gpac-mp4box-worker-route-contract:diagnostics`: passed
