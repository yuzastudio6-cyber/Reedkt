...
This hardening phase changed only the local confirmed runner, docs, diagnostics, and package script metadata. It did not run remote Supabase validation because the approved credential context remains missing.
