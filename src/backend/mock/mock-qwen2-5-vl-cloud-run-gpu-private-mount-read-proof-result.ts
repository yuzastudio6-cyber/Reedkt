export const QWEN2_5_VL_CLOUD_RUN_GPU_PRIVATE_MOUNT_READ_PROOF_RESULT = {
  workstream: "AI_VIDEO_BROLL_GENERATION",
  toolId: "qwen2_5_vl_7b_instruct",
  mode: "cloud_run_gpu_private_mount_read_proof_result",
  decision:
  ...
  proofJson: {
    ...
    smallReads: {
      ...
      "model.safetensors.index.json": {
        readBytes: 4096,
        sha256First4KiB:
          "f7363efc3114426dba3c041b9fd40d70899506a0dd4915e9762f2126867db0b1"
      },
      ...
      "tokenizer_config.json": {
        readBytes: 4096,
        sha256First4KiB:
          "7171f6df1e25a8efeeddb13da93dcaf3c1904a5e9895b7d1addae49a5be32a09"
      }
    }
  },
  serviceUpdate: {
...
export type Qwen25VlCloudRunGpuPrivateMountReadProofResult =
  typeof QWEN2_5_VL_CLOUD_RUN_GPU_PRIVATE_MOUNT_READ_PROOF_RESULT;
