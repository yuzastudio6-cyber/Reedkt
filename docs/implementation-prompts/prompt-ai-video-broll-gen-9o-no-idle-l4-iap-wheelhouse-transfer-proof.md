# AI-VIDEO-BROLL-GEN-9O-NO-IDLE-L4-IAP-WHEELHOUSE-TRANSFER-PROOF

Run one bounded no-idle L4 VM lifecycle with private wheelhouse IAP transfer validation in `us-central1-c`, mandatory cleanup, and no model inference.

Exact next prompt: `AI-VIDEO-BROLL-GEN-9O-NO-IDLE-L4-IAP-WHEELHOUSE-TRANSFER-PROOF: run bounded no-idle L4 VM lifecycle with private wheelhouse IAP transfer validation and mandatory cleanup, no model inference`.
