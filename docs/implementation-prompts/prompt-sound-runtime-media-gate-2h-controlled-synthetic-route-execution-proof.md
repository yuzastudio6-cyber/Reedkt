...
Gate 2H must stop and report a blocker if source drift, unsafe payload acceptance, worker dispatch, media processing, Supabase/SQL, Docker/GCP, artifact creation, or readiness-claim widening appears during preflight.
