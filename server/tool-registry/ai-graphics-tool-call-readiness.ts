...
export const aiGraphicsToolCallReadinessRecords = [
  ...
  record({
    ...
    runtimeStatus: 'satori_text_svg_layout_proof_passed_but_no_production_tool_profile_yet',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: true,
    blockersBeforeExecution: ['Add an explicit production registry profile before Tool Route or Worker execution.'],
    nextProofMilestone: 'production_registry_profile_for_satori_text_svg_layout',
  }),
  record({
  ...
  record({
    ...
    runtimeStatus: 'browser_animation_runtime_proof_passed_but_no_production_tool_profile_yet',
    gpuRequiredForRuntime: false,
    cpuRuntimeAllowed: false,
