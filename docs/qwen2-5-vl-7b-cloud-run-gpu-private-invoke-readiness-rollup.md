...
Decision: `qwen2_5_vl_cloud_run_gpu_private_invoke_readiness_rollup_controlled_persisted_dispatch_runtime_real_dispatch_approved_fixture_private_invoke_attempt_approval_required`.
...
| Controlled persisted worker dispatch runtime real-dispatch approved-fixture private invoke attempt approval | blocked controlled persisted worker dispatch runtime real-dispatch approved fixture private invoke attempt approval required | The approved-fixture private invoke attempt approval has not been recorded. | Record explicit approval for one bounded approved-fixture private invoke attempt while preserving no inference, no generated assets, no beta, and no production unlock. |
