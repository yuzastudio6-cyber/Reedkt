...
Decision: `qwen2_5_vl_cloud_run_gpu_private_invoke_readiness_rollup_active_migration_history_adopted_local_validation_required`.
...
- backend runtime persistence active migration deploy execution: blocked, adopted active-migration local validation required
