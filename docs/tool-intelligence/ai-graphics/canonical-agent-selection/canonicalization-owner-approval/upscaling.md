# Upscaling Canonicalization Owner Approval
...
- `eliminatedToolsOwnerApproved`: `d3`, `satori`
- `missingProofRulesOwnerApproved`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApproved`: model/GPU/provenance proof missing, GPU runtime not approved
- `nextProofMilestoneOwnerApproved`: upscaling model/GPU/provenance proof lane
