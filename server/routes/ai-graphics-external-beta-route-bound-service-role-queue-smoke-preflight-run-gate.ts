...
function buildCandidate(
  ...
  return {
    ...
    executeCommandTemplate:
      'future-only: npm run --silent ai-graphics:external-beta-service-role-queue-smoke -- --execute-external-beta-service-role-queue-smoke --workspace-id <non-production-workspace-id> --project-id <non-production-project-id> --approved-plan-snapshot-id <approved-plan-snapshot-id> --credit-reservation-id <credit-reservation-id> --idempotency-prefix <unique-route-bound-smoke-prefix> --service-role-queue-smoke-readiness-ref <readiness-ref> --runtime-queue-service-proof-bridge-ref <bridge-ref> --source-runtime-queue-service-proof-bridge-accepted',
