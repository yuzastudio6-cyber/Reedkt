...
```json
{
  ...
  "report": "harness-qa-acceptance",
  "harnessSource": "src/backend/api/trackb-media-oss-product-route-enablement-harness.ts",
  "harnessMode": "local_staging_dry_run",
  "acceptedRouteIds": [
  ...
  "acceptedReceiptTypes": [
    ...
    "queue_sanitized_receipt",
    "status_sanitized_receipt"
  ],
  "acceptedGateCoverage": [
    "approved_snapshot",
    "approved_edit_plan",
    "credit_reservation",
    "idempotency_key",
    ...
    "fallback_policy",
    "rollback_state",
    "sanitized_monitoring"
  ],
  "sanitizedDryRunReceiptsAccepted": true,
  "liveProductCallsAccepted": false,
  "workerDispatchAccepted": false,
  "realToolExecutionAccepted": false,
  "productReadyAccepted": false
}
```
