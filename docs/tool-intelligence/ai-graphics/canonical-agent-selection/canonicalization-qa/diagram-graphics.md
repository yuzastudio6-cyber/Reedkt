# Diagram Graphics Canonicalization QA
...
- `preferredPlanningToolsQaAccepted`: `viz_js`
- `conditionalPlanningToolsQaAccepted`: `svgdotjs_svg_js`
- `fallbackPlanningToolsQaAccepted`: `d3`
- `eliminatedToolsQaAccepted`: `vega_lite`
- `missingProofRulesQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsQaAccepted`: diagram execution and public artifact output not approved,vega_lite only applies when request is chart-like
- `nextProofMilestoneQaAccepted`: future DOT/SVG diagram execution boundary proof
