...
- Marker Chat uses deterministic local rules by default. Backend-only Qwen 3.7 beta can be verified through the live server route with owner config, but it is not production rollout and never exposes secrets to browser code.
