# WORKER_RUNTIME_JOBS SOUND CPU Owner Evidence Submission Blocker Register

```json worker-runtime-jobs-sound-cpu-owner-evidence-submission-blocker-register
{
  ...
  "resolvedForPlanning": [
    {
      ...
      "resolution": "This packet creates the actual owner evidence submission plan for owner review."
    }
  ],
  "carriedForwardBlockers": [
    "owner_evidence_submission_owner_review_pending",
