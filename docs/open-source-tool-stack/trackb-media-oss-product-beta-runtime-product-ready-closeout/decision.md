...
```json
{
  ...
  "report": "decision",
  "productReadyCloseoutPassed": true,
  "all16ToolsReadyForRankedToolCallLane": true,
  ...
  "blockedScopeConfirmations": [
    "dockerRanInCloseout",
    "installsRanInCloseout",
    "realToolsRanInCloseout",
    "mediaProcessingRanInCloseout",
    "liveProductCallsRanInCloseout",
    "routeRuntimeRanInCloseout",
    "workerDispatchRanInCloseout",
    "supabaseGcsWritesRanInCloseout",
