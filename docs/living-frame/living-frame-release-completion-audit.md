...
- real 120-frame animation-aware illustration composition in a confirmed
  ...
  white, mid-gray, saturated red, and the actual destination raster; three
  differentiated 2.5D depth planes; restrained character drift and push;
  foreground slash reveal/settle; Focus Handoff and restoration; Sharp-rendered
  caption overlay above the Living Frame layers; narration-protected sword
  cue; create-only private Remotion persistence; independent FFprobe/frame/audio
  measurement; and three retained content-addressed private review frames.
  This closes scene-layer 2.5D execution for the real illustration fixture, not
  articulated hair, robe, arm, or sword rigging;
