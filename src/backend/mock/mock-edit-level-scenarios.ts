...
function scenario(
  ...
  return {
    ...
    expectedProductionReady: defaultEditLevelProductionReadiness.productionReady,
  }
}
...
export const MOCK_EDIT_LEVEL_SCENARIOS: MockEditLevelScenario[] = [
  ...
  scenario('normal-visual-intelligence-targeted', 'Normal Visual Intelligence depth is targeted.', 'normal'),
  scenario('premium-visual-intelligence-key-moments', 'Premium Visual Intelligence depth is key moments.', 'premium'),
  scenario('ultra-visual-intelligence-scene-level', 'Ultra Premium Visual Intelligence depth is scene level.', 'ultra_premium'),
  ...
  scenario('all-profiles-production-evidence-gated', 'All profiles compute production readiness from evidence gates.'),
