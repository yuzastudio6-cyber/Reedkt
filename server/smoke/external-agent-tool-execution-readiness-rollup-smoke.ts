...
assert.equal(rollup.recommendedNextPrompt, BROLL_10G_US_WEST4_A_TRANSFER_PROMPT)
...
assert.equal(broll?.nextAction, BROLL_10G_US_WEST4_A_TRANSFER_PROMPT)
...
assert.equal(broll?.noIdleLifecycleGate?.targetZone, 'us-west4-a')
