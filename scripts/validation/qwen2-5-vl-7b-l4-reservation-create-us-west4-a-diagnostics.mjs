...
const DECISION = "qwen2_5_vl_7b_l4_reservation_create_us_west4_a_blocked_by_gpu_availability_no_vm_no_inference";
const NEXT_PROMPT =
...
check(
  packageJson.scripts?.["qwen2-5-vl-7b-l4-reservation-create-us-west4-a:diagnostics"] ===
    "node scripts/validation/qwen2-5-vl-7b-l4-reservation-create-us-west4-a-diagnostics.mjs",
  "package.json must expose qwen2-5-vl-7b-l4-reservation-create-us-west4-a:diagnostics"
);

const result = read("docs/qwen2-5-vl-7b-l4-reservation-create-us-west4-a-result.md");
const prompt = read("docs/implementation-prompts/prompt-qwen2-5-vl-7b-l4-reservation-create-us-west4-c.md");
const changeLog = parseBlock(
  "docs/qwen2-5-vl-7b-l4-reservation-create-us-west4-a-change-log.md",
  "qwen2-5-vl-7b-l4-reservation-create-us-west4-a-change-log"
);

includesAll(result, REQUIRED_RESULT_PHRASES, "reservation create us-west4-a result");
includesAll(prompt, [
  NEXT_PROMPT,
  "Zone: `us-west4-c`",
...
], "reservation create us-west4-c prompt");
...
check(changeLog.preflight?.targetZone === "us-west4-a", "Target zone mismatch");
...
check(changeLog.fallbackTarget?.selectedZone === "us-west4-c", "Fallback zone must be us-west4-c");
