...
```json
{
  ...
  "report": "fail-closed-qa-acceptance",
  "acceptedNegativePaths": [
    {
  ...
  "failClosedBeforeDispatchAccepted": true,
  "failClosedBeforeToolExecutionAccepted": true,
  "failClosedBeforeSupabaseOrGcsWriteAccepted": true,
  "routeEnablementQaBlockedIfAnyNegativePathMissing": true
}
```
