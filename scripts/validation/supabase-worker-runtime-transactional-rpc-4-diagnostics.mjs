...
const requiredFiles = [
  migrationFile,
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-source-audit.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-target-confirmation.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-secret-manager-execution-plan.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-guarded-sql-execution-plan.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-migration-execution-result.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-readback-verification.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-rollback-readiness.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-security-review.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-worker-handoff.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-blocked-scope-register.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-validation-report.md',
  'docs/supabase-worker-runtime/supabase-worker-runtime-transactional-rpc-4-next-phase-plan.md',
  'docs/activation-phase-supabase-worker-runtime-transactional-rpc-4-results.md',
  'docs/implementation-prompts/prompt-supabase-worker-runtime-transactional-rpc-4-guarded-staging-sql-execution.md',
  'docs/implementation-prompts/prompt-supabase-worker-runtime-transactional-rpc-4r-if-needed.md',
...
const requiredText = [
  ...
  '2944cf6fabd790cbab332a48921d25c6db6e4b9c',
  '#520',
  '#525',
  '#530',
  '#535',
...
const forbidden = [
  ...
  /SUPABASE-WORKER-RUNTIME-TRANSACTIONAL-RPC-4 decision:\s*completed/i,
...
if (
  packageJson.scripts?.['supabase-worker-runtime:transactional-rpc-4:diagnostics'] !==
  'node scripts/validation/supabase-worker-runtime-transactional-rpc-4-diagnostics.mjs'
) {
  fail('missing package script: supabase-worker-runtime:transactional-rpc-4:diagnostics')
}
...
const allowedFiles = new Set([
  ...
  'scripts/validation/supabase-worker-runtime-transactional-rpc-4-diagnostics.mjs',
  'package.json',
])
...
if (migrationChanges.length !== 0) {
  fail(`RPC-4 must not change migration files, got: ${migrationChanges.join(', ')}`)
}
...
console.log('SUPABASE-WORKER-RUNTIME-TRANSACTIONAL-RPC-4 diagnostics passed')
