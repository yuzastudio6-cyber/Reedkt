...
assert.equal(broll.externalManualBlocker.includes('10L attempted northamerica-northeast1-b'), true)
assert.equal(broll.externalManualBlocker.includes('10M no-VM strategy prompt'), true)
