# WORKER_RUNTIME_JOBS SOUND CPU Dispatch Signoff Collection Closure Claim Policy

```json worker-runtime-jobs-sound-cpu-dispatch-signoff-collection-closure-claim-policy
{
  ...
  "allowedClaims": {
    ...
    "futureCollectionClosureOwnerReviewMayProceed": true,
    "requiredOwnerSignoffCount": 7,
    "remainingOwnerFollowUpCount": 7,
