...
const jsonPath = 'docs/beta-readiness/owner-approval-collection-handoff/2026-06-30-ee177-owner-approval-collection-handoff.json'
const markdownPath = 'docs/beta-readiness/owner-approval-collection-handoff/2026-06-30-ee177-owner-approval-collection-handoff.md'
...
assert.equal(handoff.sourceTruth.sourceSha, 'ee177046bfb07868c4eb0ebd04f4eaff42c811ce')
assert.equal(handoff.sourceTruth.deployedEvidenceSourceSha, 'ee177046bfb07868c4eb0ebd04f4eaff42c811ce')
assert.equal(handoff.sourceTruth.apiRevision, 'reeditpro-api-staging-00015-skq')
...
assert.ok(handoff.commands.includes('npm run beta:readiness:external-beta-operator-local-env-bootstrap'))
assert.ok(handoff.commands.includes('REEDITPRO_BETA_OPERATOR_ENV_FILE=.env.reeditpro-beta-operator.local npm run beta:readiness:external-beta-operator-value-progress -- --markdown'))
assert.ok(handoff.commands.includes('npm run beta:readiness:external-beta-operator-autofill-env'))
assert.ok(handoff.commands.includes('npm run beta:readiness:external-beta-operator-autofill-local-env'))
assert.ok(handoff.commands.includes('npm run beta:readiness:external-beta-operator-human-input-checklist'))
assert.ok(handoff.commands.includes('REEDITPRO_BETA_OPERATOR_ENV_FILE=.env.reeditpro-beta-operator.local npm run beta:readiness:external-beta-operator-local-env-preflight'))
...
assert.ok(handoff.commands.includes('npm run beta:readiness:external-beta-sequence-preflight'))
...
assert.ok(staticMarkdown.includes('ee177046bfb07868c4eb0ebd04f4eaff42c811ce'))
...
assert.ok(staticMarkdown.includes('npm run beta:readiness:external-beta-operator-autofill-local-env'))
assert.ok(staticMarkdown.includes('npm run beta:readiness:external-beta-operator-local-env-bootstrap'))
assert.ok(staticMarkdown.includes('REEDITPRO_BETA_OPERATOR_ENV_FILE=.env.reeditpro-beta-operator.local npm run beta:readiness:external-beta-operator-value-progress -- --markdown'))
assert.ok(staticMarkdown.includes('npm run beta:readiness:external-beta-operator-human-input-checklist'))
assert.ok(staticMarkdown.includes('REEDITPRO_BETA_OPERATOR_ENV_FILE=.env.reeditpro-beta-operator.local npm run beta:readiness:external-beta-operator-local-env-preflight'))
...
assert.ok(markdown.includes('Beta Readiness Owner Approval Collection Handoff - ee177'))
