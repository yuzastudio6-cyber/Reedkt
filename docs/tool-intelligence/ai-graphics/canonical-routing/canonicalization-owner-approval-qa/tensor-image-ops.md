...
- Preferred planning tools accepted: `kornia`
- Conditional planning tools accepted: `torch_torchvision`
- Fallback planning tools accepted: `blocked manual planning until import proof`
...
Next milestone: `CPU import and tensor/image operation contract proof before execution.`.
