...
const allowedChangedPrefixes = [
  ...
  'server/production-hardening/production-hardening-summary.ts',
  'server/production-hardening/production-hardening-types.ts',
  'server/production-hardening/production-launch-blocker-policy.ts',
  'server/production-hardening/production-readiness-scorecard.ts',
...
for (const file of changedFiles) {
  if (!allowedChangedPrefixes.some((prefix) => file === prefix || file.startsWith(prefix)) && !file.startsWith('scripts/validation/trackb-media-oss-')) {
