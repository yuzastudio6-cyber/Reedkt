# Diagram Graphics Canonicalization Owner Review
...
- `eliminatedToolsOwnerAccepted`: `vega_lite`
- `missingProofRulesOwnerAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerAccepted`: diagram execution and public artifact output not approved,vega_lite only applies when request is chart-like
- `nextProofMilestoneOwnerAccepted`: future DOT/SVG diagram execution boundary proof
