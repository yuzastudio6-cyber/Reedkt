...
The schema owner review accepts capability extraction, candidate mapping, ranking, elimination, fallback, missing-proof requirements, planning-only recommendation, and safety boundary.

## Evidence
PR #686, PR #685, PR #683, PR #681, PR #677, PR #674, PR #671, PR #668, PR #623, PR #376, PR #361, PR #542, and PR #544 are cited. Track B remains under `TRACK_B_MEDIA_OSS_STEWARD`; Track A render/export exclusion via PR #544 remains evidence-only context.
