...
export const EDIT_LEVEL_QWEN_PLANNING_DIMENSION_DEFINITIONS: EditLevelQwenPlanningDimensionDefinition[] = [
  ...
  dimension('qwen25vl_visual_summary_usage', 'Visual summary usage', 'How future planning consumes visual summaries produced elsewhere.', 'provider_required'),
...
function createPremiumQwenPlanningDimensionRoutes(): EditLevelQwenPlanningDimensionRoute[] {
  ...
  return [
    ...
    route(level, 'qwen25vl_visual_summary_usage', 'recommended', 'provider_required', 'key visual moments and marker windows', 'Premium consumes key visual summaries when available.', 'Use key-moment fallback and ask clarification if needed.', 'Visual summaries recommended.'),
...
function createUltraQwenPlanningDimensionRoutes(): EditLevelQwenPlanningDimensionRoute[] {
  ...
  return [
    ...
    route(level, 'qwen25vl_visual_summary_usage', 'recommended', 'provider_required', 'scene-level visual summaries', 'Ultra Premium consumes scene-level visual summaries when available.', 'Degrade to Premium visual context and show notice.', 'Scene-level visual summary usage.'),
