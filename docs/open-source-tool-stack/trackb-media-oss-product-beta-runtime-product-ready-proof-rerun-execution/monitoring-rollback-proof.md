...
Monitoring evidence remains sanitized and rollback controls remain armed but disabled/no-op for this source-of-truth proof gate.
...
```json
{
  ...
  "report": "monitoring-rollback-proof",
  "monitoringReceipts": [
    "validate_sanitized_receipt",
    "queue_sanitized_receipt",
    "status_sanitized_receipt"
  ],
  "sanitizedMonitoringReceiptReady": true,
  "rollbackState": "armed_disabled_noop",
  "globalTrackBDisableControlObserved": true,
  "perToolDisableControlsObserved": true,
