# Prompt AI Graphics External Agent CPU Static Controlled Adapter Results
...
- Controlled adapter executed tools: `5`
- External route executable tools now: `0`
- Worker execution approved tools now: `0`
- GPU runtime starts now: `0`
- Public artifacts created: `0`
