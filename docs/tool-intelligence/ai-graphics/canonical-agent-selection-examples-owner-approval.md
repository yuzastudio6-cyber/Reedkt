# Canonical Agent Selection Examples Owner Approval

Owner approved PR #677's owner review of the canonical selection examples. Each example may recommend planning/study metadata candidates only and must keep execution false.
