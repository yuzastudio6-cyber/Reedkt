...
export const BROLL_CAPABILITY_MANIFEST = createSkillCapabilityManifest({
  ...
  toolRoutes: [
    routeCapability({ routeKey: 'inspect_candidate', routeKind: 'tool', supportedJobTypes: ['inspect_b_roll_candidate_with_ffprobe'], operationIds: ['tool.ffprobe.inspect_approved_media.v1'], requiredArtifactTypes: ['provider_b_roll_candidate_video_mp4', 'b_roll_candidate_version_v1'], priority: 10, requiresApproval: true, description: 'Inspect the exact private candidate.' }),
    routeCapability({ routeKey: 'normalize_candidate', routeKind: 'tool', supportedJobTypes: ['normalize_b_roll_candidate_with_ffmpeg'], operationIds: ['tool.ffmpeg.execute_approved_media_recipe.v1'], requiredArtifactTypes: ['provider_b_roll_candidate_video_mp4', 'b_roll_candidate_manifest_v1'], priority: 20, requiresApproval: true, description: 'Normalize an approved bounded candidate.' }),
    ...
    routeCapability({ routeKey: 'gemini_omni_image_to_video', routeKind: 'provider', supportedJobTypes: ['generate_b_roll_candidate'], operationIds: ['provider.google.generate_b_roll_candidate.v1'], requiredArtifactTypes: ['b_roll_plan_v1', 'b_roll_provider_request_specification_v1', 'approved_user_asset_v1'], priority: 5, requiresApproval: true, description: 'Create an illustrative candidate from approved images.' }),
    routeCapability({ routeKey: 'gemini_omni_text_to_video', routeKind: 'provider', supportedJobTypes: ['generate_b_roll_candidate'], operationIds: ['provider.google.generate_b_roll_candidate.v1'], requiredArtifactTypes: ['b_roll_plan_v1', 'b_roll_provider_request_specification_v1'], priority: 6, requiresApproval: true, description: 'Create an illustrative candidate from the approved shot specification.' }),
  ],
  fallbackRoutes: [
  ...
  knownLimitations: [
    ...
    { limitationKey: 'video_reference_not_active', affectedJobTypes: ['generate_b_roll_candidate'], reason: 'Video-reference input is not an active dependable route.', behavior: 'fail_closed' },
    { limitationKey: 'unsupported_provider_inputs', affectedJobTypes: ['generate_b_roll_candidate'], reason: 'Multiple video inputs, extension, interpolation, voice editing, YouTube sources, and uploaded audio references are unsupported.', behavior: 'fail_closed' },
