...
export function validatePrivateSearxngEndpoint(input: {
  ...
  if (input.serviceValidation.cloudRunIngress === 'unknown') warnings.push('Cloud Run ingress could not be parsed; IAM policy still blocks public unauthenticated access.')
