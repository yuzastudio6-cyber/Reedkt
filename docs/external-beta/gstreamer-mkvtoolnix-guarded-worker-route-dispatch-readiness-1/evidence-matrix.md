...
| --- | --- | --- |
| Runtime QA rollup | `passed` | PR #1921 / merge SHA `61619709d92f035b82ca9ef3d8013d9300bf3043` |
...
| Route idempotency key | `preserved_for_next_dry_run` | `gstreamer-mkvtoolnix:agent-controlled-dispatch-1:approved-snapshot:job:template` |
...
Accepted artifact checksums from PR #1918:
