# Animation Overlay Canonicalization Owner Approval
...
- `preferredPlanningToolsOwnerApproved`: `lottie_web`, `animejs`
- `conditionalPlanningToolsOwnerApproved`: none
- `fallbackPlanningToolsOwnerApproved`: `satori`
- `eliminatedToolsOwnerApproved`: `real_esrgan`, `sam2`
- `missingProofRulesOwnerApproved`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApproved`: animation manifest/runtime approval missing, browser/runtime execution not approved
- `nextProofMilestoneOwnerApproved`: animation manifest and runtime approval lane
