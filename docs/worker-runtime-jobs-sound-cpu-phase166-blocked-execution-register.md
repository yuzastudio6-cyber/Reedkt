# WORKER_RUNTIME_JOBS SOUND CPU Phase166 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase166-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase166-blocked-execution-register",
  "blockedToday": {
    "routeRegistrationSourceChangeMade": false,
