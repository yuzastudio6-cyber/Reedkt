...
export const openSourceToolProfiles: ToolProfile[] = [
  ...
  profile({
    ...
    settingDefinitions: ffmpegSettings,
  ...
  profile({
    ...
    description: 'Image preparation planning for resize, crop, format conversion, and simple composites.',
    bestFor: ['Generated image preparation', 'Thumbnails', 'Resize/crop', 'Format conversion'],
    ...
    qaChecks: ['Prepared assets preserve safe margins.', 'Panel background color stays consistent.'],
  }),
  profile({
    id: 'maplibre',
    label: 'MapLibre',
  ...
  profile({
    ...
    adoptionStage: 'launch_core',
    executionMode: 'qa_only',
    description: 'Audio feature analysis planning for beat, BPM, onsets, mood, energy, and SoundSync.',
    bestFor: ['Beat/BPM analysis', 'Onset analysis', 'Audio mood/energy features', 'SoundSync planning'],
    avoidFor: ['Frontend real audio analysis', 'Music generation'],
    inputTypes: ['audio'],
  ...
  profile({
    ...
    adoptionStage: 'future',
    executionMode: 'future_worker',
    description: 'Advanced scripted video processing planning for future worker evaluation.',
    bestFor: ['Advanced scripted processing', 'Research-grade video processing'],
    avoidFor: ['Frontend work', 'Launch-core processing'],
    ...
    qaChecks: ['Keep future-only unless a milestone explicitly activates it.'],
  }),
  profile({
    id: 'rubber_band',
    label: 'Rubber Band',
    ...
    executionMode: 'future_worker',
    description: 'Tempo and pitch adjustment planning for future audio worker evaluation.',
    bestFor: ['Tempo adjustment', 'Pitch adjustment', 'Future audio worker evaluation'],
    avoidFor: ['Production use before commercial license review', 'Frontend processing'],
    inputTypes: ['audio'],
    ...
    qaChecks: ['License review is required before commercial production use.'],
    licenseNotes: ['License review required before commercial production usage.'],
    productionNotes: [planningOnlyNote, approvalNote, 'Future worker only; do not bundle into frontend.'],
  }),
]
...
export function getToolStrategyDetailsForHint(
  ...
  switch (hint) {
    ...
    case 'audio_pipeline':
      return [
        ...detail('ffmpeg', 'Voice cleanup and loudness planning should use deterministic audio processing later.', ['voice_cleanup_basic'], ['essentia']),
        ...(params.editLevel === 'premium'
          ? detail('essentia', 'Premium SoundSync can plan beat/onset/energy cues for future workers.', ['soundsync_subtle_premium'], ['ffmpeg'])
          : []),
      ]
    case 'qa_vision_tool':
