# Canonical Agent Selection Schema Owner Approval QA

Decision: `ai_graphics_canonical_agent_selection_owner_approval_qa_passed_with_warnings`

Schema sections accepted: capabilityExtraction, candidateMapping, ranking, elimination, fallback, missingProofRequirements, planningOnlyRecommendation, and safetyBoundary.
