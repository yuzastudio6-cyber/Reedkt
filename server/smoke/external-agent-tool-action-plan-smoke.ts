...
assert.equal(broll.externalManualBlocker.includes('10J attempted'), true)
assert.equal(broll.externalManualBlocker.includes('10K no-VM capacity strategy prompt'), true)
