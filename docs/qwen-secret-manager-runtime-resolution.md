...
Qwen 3.7 Max beta uses symbolic Secret Manager reference names. The runtime config service recognizes `QWEN_REASONING_API_KEY_SECRET`, `QWEN_REASONING_BASE_URL_SECRET`, `QWEN_REASONING_MODEL_ID_SECRET`, and optional legacy `QWEN_RUNTIME_CONFIG_SECRET`.
