...
export const TRACK_ALL_CAPABILITY_MANIFEST = createSkillCapabilityManifest({
  ...
  toolRoutes: [
    ...
    route({ routeKey: 'opencv_privacy_qa', operationIds: ['tool.opencv.inspect_track_all_privacy_preview.v1'], supportedJobTypes: ['track_all.apply_privacy_redaction'], requiredArtifactTypes: ['tracked_redaction_plan_v1'], priority: 4, description: 'Inspect exact decoded private redaction pixels and fail closed on exposure.' }),
