# WORKER_RUNTIME_JOBS SOUND CPU Phase178 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase178-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase178-blocked-execution-register",
  "blockedToday": {
