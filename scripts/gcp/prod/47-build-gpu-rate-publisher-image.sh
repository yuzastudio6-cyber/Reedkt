...
# Builds the source-bound, control-only all-route GPU rate publisher. It does
# not read prices, start a GPU/model job, or mutate customer credits.

readonly PROJECT_ID='reeditpro'
readonly REGION='us-central1'
readonly REPOSITORY='reeditpro-workers'
readonly IMAGE_NAME='weeditpro-gpu-rate-publisher'
readonly CONFIG='scripts/gcp/prod/cloudbuild-gpu-rate-publisher.yaml'
readonly CONFIRMATION='build-weeditpro-gpu-rate-publisher-v1'
...
[[ "${WEEDITPRO_CONFIRM_GPU_RATE_PUBLISHER_IMAGE_BUILD:-}" \
...
printf '{"operation":"weeditpro_gpu_rate_publisher_image_build_v1",'
