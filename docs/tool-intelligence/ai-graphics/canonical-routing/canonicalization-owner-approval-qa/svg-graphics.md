# Svg Graphics Canonicalization Owner Approval QA
...
- Preferred planning tools accepted: `svgdotjs_svg_js`, `satori`
- Conditional planning tools accepted: `d3`
- Fallback planning tools accepted: `viz_js for graph-shaped SVG`
...
Next milestone: `Future SVG contract execution approval with private artifact policy.`.
