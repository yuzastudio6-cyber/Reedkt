...
CanonicalSam31SourceCheckpointQualificationObservation {
  return {
    ...
    compatibilityProbe: {
      ...
      sourceCheckpointKeyCount: 0,
      sourceCheckpointKeySetSha256: '0'.repeat(64),
      deterministicRuntimeBufferDerivationPolicy: 'not_executed',
      sourceComplexRopeBufferCount: 0,
      derivedRuntimeBufferKeyCount: 0,
      derivedRuntimeBufferKeySetSha256: '0'.repeat(64),
      derivedRuntimeBufferValuesMatchedSourceComplexBuffers: false,
