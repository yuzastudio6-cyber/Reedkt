...
console.log([
  ...
  '- private internal review is verified separately by npm run smoke:edit-architecture-internal-review',
  '- upload, approved snapshot, execution package, private MP4 review, manifest verification, revision, and recovery are internal-only gates',
  '- external beta, public delivery, signed URLs, billing, and paid production require approved release evidence gates outside this workflow matrix',
  '',
  'Safety:',
  '- no providers',
  '- no gcloud',
