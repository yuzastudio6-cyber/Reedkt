...
try {
  ...
  assert.equal(result.plannedUploads[0]?.uploadPlan.storageObjectRecordId, 'storage-object-upload-smoke')
  ...
  assert.equal(executionSourceAssets[0]?.storageObjectRecordId, 'storage-object-upload-smoke')
