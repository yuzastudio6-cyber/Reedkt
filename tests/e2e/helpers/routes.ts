...
export const checkedRoutes = [
  ...
  { path: '/projects/mock-project-edit-chat-foundation', label: 'project-home' },
  { path: '/projects/mock-project-edit-chat-foundation/edits/edit-session-vertical-dna', label: 'project-edit-session-chat' },
...
export async function completeEditorSetup(page: Page, path = '/editor') {
  ...
  await clickWhenReady(page.getByRole('button', { name: /Continue to edit plan/i }).first())
