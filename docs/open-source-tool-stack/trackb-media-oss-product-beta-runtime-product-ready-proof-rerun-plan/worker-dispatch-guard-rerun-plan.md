# Worker Dispatch Guard Rerun Plan
...
```json
{
  ...
  "report": "worker-dispatch-guard-rerun-plan",
  "workerDispatchRequiredForProductReadyProof": true,
  "realToolExecutionStillSeparatelyGuarded": true,
  "dispatchAllowlistRequired": true,
  "perToolDisableRequired": true,
  "unsupportedToolDispatchMustFailClosed": true,
  "receiptMustNotContainPrivatePayloads": true,
  "routeHarnessCannotDirectlyCallToolBinaries": true,
  "nextGateMayProveDispatchIntentOnlyUnlessExplicitlyAuthorized": true
}
```
