...
The credit audit timeline reports max-hold reservation records and line-item evidence as read-only support context. It does not create, update, spend, release, refund, or persist reservations.
