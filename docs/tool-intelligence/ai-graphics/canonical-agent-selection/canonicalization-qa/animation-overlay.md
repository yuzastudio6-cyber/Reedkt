# Animation Overlay Canonicalization QA
...
- `preferredPlanningToolsQaAccepted`: `lottie_web`, `animejs`
- `conditionalPlanningToolsQaAccepted`: none
- `fallbackPlanningToolsQaAccepted`: `satori`
- `eliminatedToolsQaAccepted`: `real_esrgan`, `sam2`
- `missingProofRulesQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsQaAccepted`: animation manifest/runtime approval missing,browser/runtime execution not approved
- `nextProofMilestoneQaAccepted`: animation manifest and runtime approval lane
