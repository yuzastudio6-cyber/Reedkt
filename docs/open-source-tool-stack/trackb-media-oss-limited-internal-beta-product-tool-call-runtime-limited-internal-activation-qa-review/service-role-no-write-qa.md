...
- Service-role boundary metadata is accepted; no service-role call ran.
- Supabase/GCS classification remains no write / environment none / SQL none / migration no.
