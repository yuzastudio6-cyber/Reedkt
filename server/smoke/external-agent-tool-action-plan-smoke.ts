...
assert.equal(broll.externalManualBlocker.includes('10N attempted northamerica-northeast1-c'), true)
assert.equal(broll.externalManualBlocker.includes('10O no-VM resource-availability strategy prompt'), true)
assert.equal(broll.externalManualBlocker.includes('resource pool'), true)
assert.equal(broll.externalManualBlocker.includes('before another VM attempt'), true)
...
assert.equal(broll.noIdleLifecycleGate.targetZone, 'northamerica-northeast1-c')
