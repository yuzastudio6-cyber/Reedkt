...
check(
  ...
  'Private invoke client status must record 58DX result-review acceptance for the explicit external-agent gate.',
)
check(
...
check(
  docText.includes('approved_worker_integration_review_required') ||
    ...
    docText.includes('The active migration plan is recorded') ||
