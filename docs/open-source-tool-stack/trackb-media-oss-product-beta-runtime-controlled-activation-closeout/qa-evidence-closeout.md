...
```json
{
  ...
  "acceptedControls": {
    ...
    "deterministicUseCaseRanking": true
  },
  "notAcceptedAsProductProof": {
    "liveProductCalls": true,
    "routeDispatch": true,
    "workerDispatch": true,
    "realToolExecution": true,
    "userMediaProcessing": true,
    "externalBeta": true,
    "production": true,
    "productReadyTools": true
  }
}
```
