...
export function isCanonicalPrivateMeteredSourceSliceChunkProfileId(
  value: unknown,
): value is
  ...
  return (
    value === CANONICAL_PRIVATE_SOURCE_SLICE_LONG_FORM_CAPACITY_PROFILE_ID ||
    value === CANONICAL_PRIVATE_SOURCE_SLICE_MEZZANINE_CAPACITY_PROFILE_ID
  )
}
