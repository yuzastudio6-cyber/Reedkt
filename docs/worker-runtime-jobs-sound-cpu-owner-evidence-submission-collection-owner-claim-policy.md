# WORKER_RUNTIME_JOBS SOUND CPU Owner Evidence Submission Collection Owner Claim Policy

```json worker-runtime-jobs-sound-cpu-owner-evidence-submission-collection-owner-claim-policy
{
  ...
  "allowedClaims": {
    ...
    "ownerAreaRowsAcceptedForSubmissionPlanning": true,
    "collectionMethodsAcceptedForSubmissionPlanning": true,
    "collectionValidationPolicyAcceptedForSubmissionPlanning": true,
