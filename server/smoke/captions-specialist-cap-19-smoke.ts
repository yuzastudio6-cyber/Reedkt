...
check(QWEN_VISUAL_UNDERSTANDING_RETIREMENT.status
  === 'retired_historical_read_only'
  && !QWEN_VISUAL_UNDERSTANDING_RETIREMENT.freshExecutionAllowed
  && !QWEN_VISUAL_UNDERSTANDING_RETIREMENT.networkOrProviderCallAllowed,
'The historical Qwen provider must remain a non-executable tombstone.')
