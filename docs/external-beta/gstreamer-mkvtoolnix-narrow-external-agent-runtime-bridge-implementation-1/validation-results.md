# Narrow External-Agent Runtime Bridge Validation Results
...
- `npm run --silent smoke:rp-external-beta-gstreamer-mkvtoolnix-narrow-external-agent-runtime-bridge-implementation-1`
