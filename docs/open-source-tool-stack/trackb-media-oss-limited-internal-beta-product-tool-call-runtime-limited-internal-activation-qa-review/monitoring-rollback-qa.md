...
- Sanitized monitoring evidence excludes raw prompts, provider prompts, signed URLs, public URLs, secrets, and private payloads.
- Rollback proof is accepted as disable-control evidence only; no live rollback ran.
