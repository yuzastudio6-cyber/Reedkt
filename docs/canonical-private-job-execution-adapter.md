...
The machine-readable proven-tool catalog records job-adapter proof separately from coordinator-only canonical E2E proof. At evidence revision `2026-07-12.22`, 15 exact tool identities have job-adapter proof: the eight structured Node identities, five browser-graphics identities, Remotion final composition, and FFprobe final-artifact QA. The remaining canonical identities keep their complete coordinator lifecycle evidence but are not represented as job-adapter verified.
