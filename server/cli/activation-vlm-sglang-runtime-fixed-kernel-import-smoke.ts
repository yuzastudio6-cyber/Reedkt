...
if (!execute) {
  console.log([
    'Phase 39C-SG-FIXED import-smoke CLI',
    'No execution performed.',
    'The import-smoke phase is executed by the fixed-kernel CLI after Cloud Build profile images are ready.',
  ...
  if (json) console.log(JSON.stringify(result.importSmokeAttempts, null, 2))
    ...
    console.log([
      'Phase 39C-SG-FIXED import-smoke matrix completed through the guarded compatibility runner.',
      `Run: ${result.runId}`,
