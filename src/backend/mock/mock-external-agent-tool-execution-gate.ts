  ...
  toolRows: [
    ...
    },
    {
      ...
      requiredBeforeExecution: [
        ...
        'controlled GPU proof must use a future bounded lifecycle execution gate',
        'controlled L4 proof must be no-idle: no public IP, prompt-scoped VM only, delete VM and verify cleanup before completion',
      ],
      currentBlocker: 'bounded_no_idle_l4_lifecycle_execute_prompt_required_before_vm_or_inference',
      safeNextCommand: 'npm run smoke:ai-video-broll-gen-9k-no-idle-l4-proof-prompt',
