# WORKER_RUNTIME_JOBS SOUND CPU Owner Evidence Submission Packet Authoring Blocker Register

```json worker-runtime-jobs-sound-cpu-owner-evidence-submission-packet-authoring-blocker-register
{
  ...
  "resolvedForPlanning": [
    {
      "blockerId": "owner_evidence_submission_packet_authoring_plan_pending",
      "resolution": "This packet creates the owner evidence packet authoring plan for owner review."
    }
  ],
  "carriedForwardBlockers": [
    "owner_evidence_submission_packet_authoring_owner_review_pending",
    "owner_evidence_packets_not_authored",
