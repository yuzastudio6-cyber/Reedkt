...
assert.equal(report.sourceTruth.sourceSha, 'ba5bc11778db7c3e2efd6b56941949f64b2c9684')
assert.equal(report.sourceTruth.deployedEvidenceSourceSha, '769fc2d922b37a9eebb8b0ca29fa2447a6f8f127')
...
assert.equal(report.sourceTruth.currentSourceApiDeployPacket, 'docs/beta-readiness/api-staging-deploy-current-source/2026-06-29-769f-api-staging-deploy.json')
assert.equal(report.sourceTruth.deployedEvidenceInputManifest, 'docs/beta-readiness/deployed-evidence-input-manifest/2026-06-29-769f-deployed-evidence-input-manifest.json')
assert.equal(report.sourceTruth.normalApiRevision, 'reeditpro-api-staging-00012-ncd')
...
assert.equal(report.sourceTruth.normalApiDeployRunId, '28343028750')
...
assert.ok(markdownDoc.includes('reeditpro-api-staging-00012-ncd'))
assert.ok(markdownDoc.includes('api-staging-769fc2d922b3-20260629T0129Z-retry1'))
