# SOUND Runtime Media Gate 2AH Runtime Claim Policy

```json sound-runtime-media-gate-2ah-runtime-claim-policy
{
  ...
  "allowedClaims": {
    "controlledNoExecutionImportProofPassedToday": true,
    "runtimeModuleLoadPassedToday": true,
