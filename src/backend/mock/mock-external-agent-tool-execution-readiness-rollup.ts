...
export type ExternalAgentToolNoIdleLifecycleGate = {
  ...
  targetRegion: 'us-central1' | 'us-west1' | 'us-east4' | 'us-east1'
  targetZone:
    | 'us-central1-a'
    | 'us-central1-b'
    | 'us-central1-c'
...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  decision:
    'external_agent_tool_execution_readiness_qwen_ready_for_explicit_gate_broll_10b_us_east1_c_prompt_selected_future_prompt_required',
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_iap_wheelhouse_transfer_us_east1_c_selected_after_10a_stockout',
      ...
      primaryBlocker:
        'bounded_no_idle_l4_iap_wheelhouse_transfer_us_east1_c_future_prompt_required_before_vm_created',
      evidence: [
      ...
      nextAction: AI_VIDEO_BROLL_GEN_10C_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_EAST1_C_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
  ...
  recommendedNextPrompt: AI_VIDEO_BROLL_GEN_10C_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_EAST1_C_PROMPT,
} as const
