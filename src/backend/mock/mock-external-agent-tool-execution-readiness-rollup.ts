...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  decision:
    'external_agent_tool_execution_readiness_qwen_ready_for_explicit_gate_broll_9o_retry_iap_wheelhouse_transfer_blocked_resource_pool_exhausted_cleanup_verified_ready_for_stockout_fix',
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_iap_wheelhouse_transfer_us_central1_c_retry_blocked_resource_pool_exhausted_cleanup_verified_ready_for_stockout_fix',
      ...
      primaryBlocker: 'bounded_no_idle_l4_iap_wheelhouse_transfer_stockout_fix_required_before_dependency_or_inference',
      evidence: [
      ...
      nextAction: AI_VIDEO_BROLL_GEN_9P_IAP_WHEELHOUSE_TRANSFER_STOCKOUT_FIX_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
        ...
        cacheReadinessCommand: 'npm run ai-video-broll-wan-fast-cache-readiness:check',
        quotaVerificationCommand: 'npm run ai-video-broll-wan-gpu-global-quota:verify',
        nextActionAfterQuotaClears: AI_VIDEO_BROLL_GEN_9P_IAP_WHEELHOUSE_TRANSFER_STOCKOUT_FIX_PROMPT,
      },
    },
    {
  ...
  recommendedNextPrompt: AI_VIDEO_BROLL_GEN_9P_IAP_WHEELHOUSE_TRANSFER_STOCKOUT_FIX_PROMPT,
} as const
