...
assert.equal(report.sourceTruth.sourceSha, '17a9a2d2b015ab325cf13ce5135d083af070ab00')
assert.equal(report.sourceTruth.currentSourceApiDeployPacket, 'docs/beta-readiness/api-staging-deploy-current-source/2026-06-29-17a9-api-staging-deploy.json')
assert.equal(report.sourceTruth.normalApiRevision, 'reeditpro-api-staging-00011-cts')
...
assert.equal(report.sourceTruth.normalApiDeployRunId, '28341446109')
...
assert.ok(markdownDoc.includes('reeditpro-api-staging-00011-cts'))
assert.ok(markdownDoc.includes('api-staging-17a9a2d2b015-20260629T0034Z'))
