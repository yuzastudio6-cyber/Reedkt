...
const packetDir = 'docs/track-a/native-container-render-tools/package-source-owner-decision-1'
const requiredFiles = [
  `${packetDir}/package-source-owner-decision-1.md`,
  `${packetDir}/package-source-owner-decision-1.json`,
  `${packetDir}/source-of-truth-audit.md`,
  `${packetDir}/source-of-truth-audit.json`,
  `${packetDir}/gpac-mp4box-owner-decision.md`,
  `${packetDir}/gpac-mp4box-owner-decision.json`,
  `${packetDir}/vapoursynth-owner-decision.md`,
  `${packetDir}/vapoursynth-owner-decision.json`,
...
const requiredText = [
  ...
  'completed_docs_only_owner_package_source_decision_no_install_changes',
  ...
  '#701 remains historical/context-only',
  ...
  'blocked_no_owner_approval_for_gpac_mp4box_package_source',
  'blocked_no_owner_approval_for_core_vapoursynth_package_source',
  'blocked_pending_owner_approved_package_source',
  'none_until_owner_approval',
  ...
  'TRACKA-NATIVE-CONTAINER-RENDER-TOOLS-INSTALL-PROOF-4 readiness: blocked_pending_owner_approved_package_source',
  'TRACKA-GPAC-MP4BOX-PACKAGE-SOURCE-OWNER-DECISION-1 readiness: blocked_pending_owner_approved_package_source',
  'TRACKA-VAPOURSYNTH-PACKAGE-SOURCE-OWNER-DECISION-1 readiness: blocked_pending_owner_approved_package_source',
...
const forbiddenPatterns = [
  ...
  /partial_owner_package_source_approval_with_blockers_recorded/i,
...
function fail(message) {
  console.error(`TRACKA-NATIVE-CONTAINER-PACKAGE-SOURCE-OWNER-DECISION-1 diagnostics failed: ${message}`)
  process.exit(1)
}
...
const script = packageJson.scripts?.['tracka:native-container-package-source-owner-decision-1:diagnostics']
if (script !== 'node scripts/validation/tracka-native-container-package-source-owner-decision-1-diagnostics.mjs') {
...
console.log('TRACKA-NATIVE-CONTAINER-PACKAGE-SOURCE-OWNER-DECISION-1 diagnostics passed')
