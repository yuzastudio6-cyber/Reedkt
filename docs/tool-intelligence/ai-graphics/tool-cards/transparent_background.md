# transparent-background Tool Capability Card
...
- `bestFor`: backlog transparent background planning
- `notFor`: default extraction until redundancy review; current execution
