...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  ...
  tools: [
    {
      ...
      primaryBlocker: 'structured_metadata_schema_invalid_after_bounded_58dw_retry',
      evidence: [
      ...
      nextAction: QWEN2_5_VL_58DW_FIX_STRUCTURED_OUTPUT_PROMPT,
  ...
  recommendedNextPrompt: QWEN2_5_VL_58DW_FIX_STRUCTURED_OUTPUT_PROMPT,
} as const
