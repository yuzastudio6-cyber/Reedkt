# WORKER_RUNTIME_JOBS SOUND CPU Phase 96 Private Manifest Persistence Source Static Validation Claim Policy

```json worker-runtime-jobs-sound-cpu-phase96-caption-render-runtime-hook-private-manifest-persistence-source-static-validation-claim-policy
{
  "label": "worker-runtime-jobs-sound-cpu-phase96-caption-render-runtime-hook-private-manifest-persistence-source-static-validation-claim-policy",
  ...
  "allowedClaims": {
    "privateManifestPersistenceSourceStaticValidationPassed": true,
...
Only static validation and next owner-review claims are allowed. Runtime and persistence claims remain blocked.
