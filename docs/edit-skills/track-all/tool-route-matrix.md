...
|---|---|---|---|---|
| source truth | `tool.ffprobe.inspect_approved_media.v1` | internal execution | source facts | fail closed |
| bounded media | `tool.ffmpeg.execute_approved_media_recipe.v1` | internal execution | private proxy/frames/redaction preview | fail closed |
| shot discovery | `tool.pyscenedetect.detect_scene_boundaries.v1` | internal execution | shot candidates | deterministic explicit boundaries or review |
| visual geometry | `tool.opencv.analyze_approved_visual_artifacts.v1` | internal execution | camera/planar/flow/QA evidence | no model fallback |
