# Chart Overlay Canonicalization Owner Approval QA
...
- `eliminatedToolsOwnerApprovalQaAccepted`: `three_js`, `sam2`, `real_esrgan`
- `missingProofRulesOwnerApprovalQaAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerApprovalQaAccepted`: browser chart runtime not approved, model/GPU proof not approved for eliminated ML tools, 3D chart request required before three_js planning
- `nextProofMilestoneOwnerApprovalQaAccepted`: future chart/browser runtime or CPU/static chart metadata proof before execution
