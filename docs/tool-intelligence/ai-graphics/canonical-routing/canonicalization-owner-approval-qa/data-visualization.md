# Data Visualization Canonicalization Owner Approval QA
...
- Preferred planning tools accepted: `vega_lite`, `vega`, `d3`
- Conditional planning tools accepted: `echarts`
- Fallback planning tools accepted: `svgdotjs_svg_js`
...
Next milestone: `Future structured data visualization execution approval after source data and runtime review.`.
