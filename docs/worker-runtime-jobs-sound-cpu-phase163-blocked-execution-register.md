# WORKER_RUNTIME_JOBS SOUND CPU Phase163 Blocked Execution Register

```json worker-runtime-jobs-sound-cpu-phase163-blocked-execution-register
{
  "label": "worker-runtime-jobs-sound-cpu-phase163-blocked-execution-register",
  "blockedToday": {
