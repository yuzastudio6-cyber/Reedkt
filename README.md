...
RP-BETA-INTEGRATION-37 adds a remote Supabase and staging deployment owner approval packet. It does not run Supabase CLI, apply migrations, deploy staging, expose secrets, call providers, execute workers, or mutate local Supabase side artifacts. See `docs/beta-integration-37-remote-supabase-staging-approval.md`.
