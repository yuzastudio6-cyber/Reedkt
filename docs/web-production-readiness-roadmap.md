...
| 44B web app structure migration | Move the visible web shell toward the target `apps/web` structure. | Web app layout is prepared without desktop runtime or launch claims. |
