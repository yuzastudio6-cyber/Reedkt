...
const expectedRepositoryFiles = [
  ...
  'server/motion-studio/commands/index.ts',
  'server/motion-studio/commands/private-local-repository.ts',
  'server/motion-studio/commands/repository.ts',
  ...
  'server/security/canonical-service-identity-verifier.ts',
  'server/services/canonical-planning-handoff-service.ts',
  'server/services/canonical-professional-gpu-cloud-task-consumer-service.ts',
  ...
  'server/services/canonical-professional-gpu-cloud-task-outbox-server-http-client.ts',
  'server/services/canonical-professional-gpu-cloud-task-scheduler-service.ts',
  ...
  'server/services/canonical-professional-gpu-funded-start-authority-store.ts',
  'server/services/canonical-professional-gpu-queue-runtime-read-port.ts',
  'server/services/canonical-professional-gpu-queue-runtime-read-server-http-client.ts',
  'server/services/canonical-sam3_1-complete-source-capacity-owner.ts',
  'server/services/canonical-sam3_1-vertex-serving-capacity-mutation.ts',
  ...
  'server/smoke/canonical-professional-gpu-cloud-task-consumer-smoke.ts',
  ...
  'server/smoke/canonical-professional-gpu-queue-runtime-read-smoke.ts',
  ...
  'server/smoke/local-resumable-source-upload-smoke.ts',
  'server/smoke/motion-studio-private-local-command-repository-smoke.ts',
  'server/smoke/planning-exact-edit-preference-authority-port-smoke.ts',
  'server/smoke/upload-boundary-security-smoke.ts',
  'server/storage/local-resumable-upload-ledger.ts',
  'server/storage/local-storage-adapter.ts',
  'server/storage/storage-types.ts',
  'server/types.ts',
  'server/upload-target-authority/canonical-durable-upload-target-authority.ts',
  ...
  'src/lib/resumable-file-upload.ts',
  'src/lib/source-upload-planning.ts',
  'src/lib/temporary-object-upload-client.ts',
  'src/types/canonical-exact-edit-planning-authority.ts',
  'src/types/e2e-runtime.ts',
...
const expectedMigrations = [
  ...
  '202607210028_professional_gpu_delivery_consumption.sql',
]
...
for (const requiredToken of [
  ...
  '018_canonical_local_resumable_upload_protocol.sql',
  '127.0.0.1:57431',
