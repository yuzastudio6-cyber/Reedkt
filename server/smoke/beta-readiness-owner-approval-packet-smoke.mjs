...
assert.equal(report.sourceTruth.sourceSha, 'd997d567d40853f59741763c8e9ca8b2c361148a')
assert.equal(report.sourceTruth.currentSourceApiDeployPacket, 'docs/beta-readiness/api-staging-deploy-current-source/2026-06-28-d997-api-staging-deploy.json')
assert.equal(report.sourceTruth.normalApiRevision, 'reeditpro-api-staging-00010-c6h')
...
assert.equal(report.sourceTruth.normalApiDeployRunId, '28335776268')
assert.equal(report.sourceTruth.productReadyLocalOssCount, 14)
...
assert.ok(markdownDoc.includes('reeditpro-api-staging-00010-c6h'))
assert.ok(markdownDoc.includes('api-staging-d997d567d408-20260628T2058Z'))
