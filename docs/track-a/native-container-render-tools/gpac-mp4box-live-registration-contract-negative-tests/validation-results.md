...
Lane: `TRACKA-GPAC-MP4BOX-LIVE-REGISTRATION-CONTRACT-NEGATIVE-TESTS-1`.
...
- `npm run smoke:tracka-gpac-mp4box-live-registration-contract-negative-tests`
- `npm run --silent tracka:gpac-mp4box-disabled-live-registration-contract:diagnostics`
- `npm run --silent tracka:gpac-mp4box-live-registration-contract-negative-tests:diagnostics`
