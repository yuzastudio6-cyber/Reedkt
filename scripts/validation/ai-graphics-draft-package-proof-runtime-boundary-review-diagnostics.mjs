...
const baseRef = 'origin/codex/rp-ai-graphics-draft-package-proof-canonical-promotion-qa-review'
const expectedDecision = 'ai_graphics_draft_package_proof_runtime_boundary_review_passed_with_warnings'
const allowedDecisions = new Set([
  expectedDecision,
  'ai_graphics_draft_package_proof_runtime_boundary_review_passed',
  'blocked_pending_ai_graphics_runtime_boundary_matrix',
  'blocked_pending_ai_graphics_browser_webgl_boundary',
  'blocked_pending_ai_graphics_tool_route_boundary',
  'blocked_pending_ai_graphics_worker_boundary',
])

const requiredDocs = [
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-review.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-source-lockfile.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-matrix.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-cpu-static.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-browser-chart.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-animation.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-webgl-canvas.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-tool-route.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-worker.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-status.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-blocked-use-register.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-decision.md',
  'docs/prompt-ai-graphics-draft-package-proof-runtime-boundary-review-results.md',
  'docs/implementation-prompts/prompt-ai-graphics-draft-package-proof-runtime-boundary-review.md',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-matrix.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-source-lockfile.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-status.json',
  'docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones.json',
]

const expectedSources = ['PR #589', 'PR #585', 'PR #582', 'PR #425', 'PR #433', 'PR #441', 'PR #543', 'PR #536', 'PR #416', 'PR #542', 'PR #544']
...
const requiredTrueBooleans = [
  'runtimeBoundaryReviewCompleted',
  'all13PackageProofToolsReviewed',
  'canonicalPackageProofAccepted',
  'agentSelectionMetadataAllowed',
]
...
const perToolFalseFields = [
  'agentCanExecuteNow',
  'cpuStaticAllowedNow',
  'browserRuntimeAllowedNow',
  'webglCanvasRuntimeAllowedNow',
  'toolRouteExecutionAllowedNow',
...
const forbiddenPatterns = [
  ...
  ['execution', /\b(agentExecutionAllowedNow|toolExecutionPerformed|workerExecutionPerformed|routeExecutionPerformed|providerRuntimePerformed)\b\s*[:=|]\s*`?true`?/i],
...
let nextMilestones = {}
try {
  sourceLockfile = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-source-lockfile.json')
  matrix = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-matrix.json')
  agentSelection = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-agent-selection-status.json')
  nextMilestones = readJson('docs/open-source-tool-stack/ownership/ai-graphics-draft-package-proof-runtime-boundary-next-proof-milestones.json')
} catch (error) {
...
for (const expectedTool of expectedTools) {
  ...
  if (row.agentCanSelectNow !== true) failures.push(`agent_select_not_true:${expectedTool}`)
  ...
  for (const [lane, laneTools] of Object.entries(expectedLanes)) {
    if (laneTools.includes(expectedTool) && !row.futureRuntimeLane?.includes(lane)) failures.push(`tool_missing_lane:${expectedTool}:${lane}`)
  }
}

for (const [lane, laneTools] of Object.entries(expectedLanes)) {
  const actualTools = tools.filter((row) => row.futureRuntimeLane?.includes(lane)).map((row) => row.toolId)
...
for (const source of ['pr589', 'pr585', 'pr582', 'pr543', 'pr536']) {
...
if (agentSelection.agentSelectionMetadataAllowed !== true) failures.push('agent_selection_metadata_not_true')
...
for (const field of ['runtimeReadyNow', 'internalBetaReadyNow', 'externalBetaReadyNow', 'productionReadyNow']) {
...
try {
  ...
  const expectedScript = 'node scripts/validation/ai-graphics-draft-package-proof-runtime-boundary-review-diagnostics.mjs'
  if (packageAfter.scripts?.['ai-graphics:draft-package-proof-runtime-boundary-review:diagnostics'] !== expectedScript) {
...
if (failures.length > 0) {
  console.error('AI graphics runtime boundary review diagnostics failed:')
  for (const failure of failures) console.error(`- ${failure}`)
  process.exit(1)
}

console.log('AI graphics runtime boundary review diagnostics passed.')
