...
- Result: default evidence keeps 0 tools beta-ready. When all currently modeled shared/runtime evidence flags are supplied, the gate reports 14 beta-eligible tools (`kornia`, `d3`, `echarts`, `vega_lite`, `vega`, `satori`, `svgdotjs_svg_js`, `viz_js`, `lottie_web`, `animejs`, `three_js`, `pixi_js`, `konva`, `babylonjs`) and keeps 7 GPU/model/license tools blocked (`torch_torchvision`, `transformers`, `sam2`, `birefnet`, `real_esrgan`, `rembg`, `transparent_background`).
