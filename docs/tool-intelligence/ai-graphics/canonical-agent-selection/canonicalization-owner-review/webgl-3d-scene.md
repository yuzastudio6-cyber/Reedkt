# Webgl 3d Scene Canonicalization Owner Review
...
- `preferredPlanningToolsOwnerAccepted`: `three_js`, `babylonjs`
- `conditionalPlanningToolsOwnerAccepted`: none
- `fallbackPlanningToolsOwnerAccepted`: `pixi_js`
- `eliminatedToolsOwnerAccepted`: `vega_lite`, `d3`
- `missingProofRulesOwnerAccepted`: true
- `currentExecutionAllowed`: false
- `blockedRuntimeReasonsOwnerAccepted`: browser/WebGL sandbox approval missing,GPU/browser runtime not approved
- `nextProofMilestoneOwnerAccepted`: browser/WebGL sandbox proof lane
