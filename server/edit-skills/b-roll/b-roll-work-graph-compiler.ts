...
const generatedDefinitions: readonly WorkDefinition[] = [
  ...
  { jobType: 'generate_b_roll_candidate', operationId: 'provider.google.generate_b_roll_candidate.v1', workerClass: 'provider_worker', output: 'b_roll_candidate_version_v1', toolOrProviderCredits: 20, qa: ['b_roll.output.semantic_alignment'], provider: true },
