...
export type ExternalAgentToolNoIdleLifecycleGate = {
  ...
  targetZone: 'us-central1-a' | 'us-central1-b' | 'us-central1-c' | 'us-west1-a' | 'us-west1-b' | 'us-west1-c'
...
export const EXTERNAL_AGENT_TOOL_EXECUTION_READINESS_ROLLUP = {
  decision:
    'external_agent_tool_execution_readiness_qwen_ready_for_explicit_gate_broll_9t_stockout_fix_ready_for_us_west1_c_iap_wheelhouse_transfer_proof',
  ...
  tools: [
    ...
    },
    {
      ...
      currentStage:
        'controlled_l4_no_idle_iap_wheelhouse_transfer_us_west1_c_prompt_required',
      ...
      nextAction: AI_VIDEO_BROLL_GEN_9U_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_WEST1_C_PROMPT,
      manualBlockerActions: [],
      noIdleLifecycleGate: {
  ...
  recommendedNextPrompt: AI_VIDEO_BROLL_GEN_9U_NO_IDLE_L4_IAP_WHEELHOUSE_TRANSFER_PROOF_US_WEST1_C_PROMPT,
} as const
