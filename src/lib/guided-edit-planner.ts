...
export function createGuidedEditPlan(input: PlannerInput): EditPlan {
...
/**
 * Compatibility export for the existing browser-local guided planning surface.
 * Server-owned planning imports createGuidedEditPlan directly and supplies only
 * authority-reconstructed inputs.
 */
export const createGuidedMockEditPlan = createGuidedEditPlan
