...
} from '../services/tracka-three-tool-external-agent-guarded-worker-dispatch-noop-invoke-1'

const reportRoot = '/tmp/reeditpro-tracka-three-tool-external-agent-guarded-worker-dispatch-noop-invoke-1'
const reportFileName = 'three-tool-external-agent-guarded-worker-dispatch-noop-invoke-report.json'
const manifestFileName = 'three-tool-external-agent-guarded-worker-dispatch-noop-invoke-manifest.json'
...
async function main(): Promise<void> {
  ...
  const result = invokeThreeToolExternalAgentGuardedWorkerDispatchNoop()
