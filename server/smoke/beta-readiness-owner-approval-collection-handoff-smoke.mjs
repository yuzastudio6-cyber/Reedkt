...
assert.ok(handoff.commands.includes('npm run beta:readiness:external-beta-operator-value-progress'))
...
assert.ok(staticMarkdown.includes('npm run beta:readiness:external-beta-operator-value-progress'))
assert.ok(staticMarkdown.includes('npm run beta:readiness:external-beta-operator-human-input-checklist'))
assert.ok(staticMarkdown.includes('npm run beta:readiness:external-beta-operator-local-env-preflight'))
