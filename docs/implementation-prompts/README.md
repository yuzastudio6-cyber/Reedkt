...
| 01 | Production Architecture Freeze | `codex/rp-foundation-01-production-architecture-freeze` | Pending PR creation | Pending validation | No | Docs-only architecture boundary freeze. No backend execution, provider calls, rendering, Stripe, migrations, deployment, workers, service-role handlers, or tool execution. |
