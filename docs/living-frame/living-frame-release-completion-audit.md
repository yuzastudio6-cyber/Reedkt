...
rebuilds, the remaining internal
runtime blockers are real L4 model load/inference, private output persistence,
resource evidence, and output QA for the two GPU runtime paths. The
aggregate
