...
import { executeMotionStudioSpeechAccountSubscriptionLiveOperator } from './account-subscription-live-operator'

try {
  const result = await executeMotionStudioSpeechAccountSubscriptionLiveOperator({
