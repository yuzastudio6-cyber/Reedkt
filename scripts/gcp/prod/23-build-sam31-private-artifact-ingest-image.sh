...
# Builds only the source-bound reviewed-ingest control-plane image. It reads no
# model bytes or secret, starts no job/GPU, and mutates no customer credits.

readonly PROJECT_ID='reeditpro'
readonly REGION='us-central1'
readonly REPOSITORY='reeditpro-workers'
readonly IMAGE_NAME='weeditpro-sam31-private-artifact-ingest'
readonly CONFIG='scripts/gcp/prod/cloudbuild-sam31-private-artifact-ingest.yaml'
readonly CONFIRMATION='build-weeditpro-sam31-private-artifact-ingest-v1'
...
[[ "${WEEDITPRO_CONFIRM_SAM31_PRIVATE_ARTIFACT_INGEST_IMAGE_BUILD:-}" \
...
image_tag="sam31-private-ingest-${source_commit:0:16}"
...
printf '{"operation":"weeditpro_sam31_private_artifact_ingest_image_build_v1",'
