# WORKER_RUNTIME_JOBS SOUND CPU Owner Evidence Response Collection Claim Policy

```json worker-runtime-jobs-sound-cpu-owner-evidence-response-collection-claim-policy
{
