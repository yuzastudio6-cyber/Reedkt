...
assert.equal(empty.sourceTruth.sourceSha, '17a9a2d2b015ab325cf13ce5135d083af070ab00')
...
assert.equal(empty.sourceTruth.normalApiRevision, 'reeditpro-api-staging-00011-cts')
